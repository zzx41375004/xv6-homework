 ...
 4b9:	85 d2                	test   %edx,%edx
{
 ...
 4e7:	f7 f1                	div    %ecx
 4e9:	0f b6 92 fc 0a 00 00 	movzbl 0xafc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 704:	e9 8f fe ff ff       	jmp    598 <printf+0x48>
          s = "(null)";
 709:	bb f3 0a 00 00       	mov    $0xaf3,%ebx
        while(*s != 0){
 ...
 721:	a1 e0 0e 00 00       	mov    0xee0,%eax
{
 ...
 75d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 75f:	a3 e0 0e 00 00       	mov    %eax,0xee0
}
 764:	5b                   	pop    %ebx
 765:	5e                   	pop    %esi
 766:	5f                   	pop    %edi
 ...
 776:	72 ce                	jb     746 <free+0x26>
{
 ...
 797:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 79a:	a3 e0 0e 00 00       	mov    %eax,0xee0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 15 e0 0e 00 00    	mov    0xee0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ff:	73 47                	jae    848 <malloc+0x98>
    ...
    if(p == freep)
 801:	39 05 e0 0e 00 00    	cmp    %eax,0xee0
 ...
 826:	e8 f5 fe ff ff       	call   720 <free>
  return freep;
 82b:	8b 15 e0 0e 00 00    	mov    0xee0,%edx
 ...
 854:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 857:	89 15 e0 0e 00 00    	mov    %edx,0xee0
}
 ...
 877:	0e 00 00 
 87a:	c7 05 e4 0e 00 00 e4 	movl   $0xee4,0xee4
 881:	0e 00 00 
    base.s.size = 0;
 884:	b8 e4 0e 00 00       	mov    $0xee4,%eax
...
void add_thread(int *pid,void *ustack){
 8b0:	ba 00 11 00 00       	mov    $0x1100,%edx
	int i;
	for(i=0;i<NTHREAD;i++){
...
void add_thread(int *pid,void *ustack){
 ...
 8de:	8d 90 00 11 00 00    	lea    0x1100(%eax),%edx
			threads[i].ustack=ustack;
			threads[i].used=1;
 8e4:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
			threads[i].pid=*pid;
 8eb:	89 88 00 11 00 00    	mov    %ecx,0x1100(%eax)
			threads[i].ustack=ustack;
...
{
 900:	55                   	push   %ebp
 901:	b8 00 11 00 00       	mov    $0x1100,%eax
    int i;
	for(i=0;i<NTHREAD;i++){
 906:	31 d2                	xor    %edx,%edx
{
 ...
 939:	ff b3 04 11 00 00    	pushl  0x1104(%ebx)
 93f:	e8 dc fd ff ff       	call   720 <free>
    		threads[i].pid=0;
 944:	c7 83 00 11 00 00 00 	movl   $0x0,0x1100(%ebx)
 94b:	00 00 00 
    		threads[i].ustack=0;
 94e:	c7 83 04 11 00 00 00 	movl   $0x0,0x1104(%ebx)
 955:	00 00 00 
    		break;
 958:	83 c4 10             	add    $0x10,%esp
    		threads[i].used=0;
 95b:	c7 83 08 11 00 00 00 	movl   $0x0,0x1108(%ebx)
 962:	00 00 00 
}
...
int thread_create(void(*start_routine)(void*),void* arg){
 ...
 974:	83 ec 04             	sub    $0x4,%esp
	...
	static int first=1;
	if(first){
 977:	a1 d4 0e 00 00       	mov    0xed4,%eax
 97c:	85 c0                	test   %eax,%eax
 97e:	74 2d                	je     9ad <thread_create+0x3d>
		first=0;
 980:	c7 05 d4 0e 00 00 00 	movl   $0x0,0xed4
 987:	00 00 00 
 98a:	b8 00 11 00 00       	mov    $0x1100,%eax
		int i;
		for(i=0;i<NTHREAD;i++){
			threads[i].pid=0;
 ...
 99f:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
		for(i=0;i<NTHREAD;i++){
 9a6:	3d 30 11 00 00       	cmp    $0x1130,%eax
 ...
 9cb:	b9 00 11 00 00       	mov    $0x1100,%ecx
 ...
 9f3:	c1 e2 02             	shl    $0x2,%edx
			threads[i].ustack=ustack;
 9f6:	89 9a 04 11 00 00    	mov    %ebx,0x1104(%edx)
			threads[i].pid=*pid;
 9fc:	89 82 00 11 00 00    	mov    %eax,0x1100(%edx)
			threads[i].used=1;
 a02:	c7 82 08 11 00 00 01 	movl   $0x1,0x1108(%edx)
 a09:	00 00 00 
}
...
int thread_join(void){
 ...
 a23:	53                   	push   %ebx
 a24:	bb 00 11 00 00       	mov    $0x1100,%ebx
 ...
 a32:	83 c3 0c             	add    $0xc,%ebx
	for(i=0;i<NTHREAD;i++){
 a35:	81 fb 30 11 00 00    	cmp    $0x1130,%ebx
...
void printTCB(void){
 ...
 a8c:	ff 34 85 08 11 00 00 	pushl  0x1108(,%eax,4)
 a93:	53                   	push   %ebx
	for(i=0;i<NTHREAD;i++)
 a94:	83 c3 01             	add    $0x1,%ebx
		printf(1,"TCB %d: %d\n",i,threads[i].used);
 a97:	68 0d 0b 00 00       	push   $0xb0d
 a9c:	6a 01                	push   $0x1
