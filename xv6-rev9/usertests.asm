...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
      11:	68 d7 4e 00 00       	push   $0x4ed7
      16:	6a 01                	push   $0x1
      18:	e8 83 39 00 00       	call   39a0 <printf>

  if(open("usertests.ran", 0) >= 0){
      1d:	59                   	pop    %ecx
      1e:	58                   	pop    %eax
      1f:	6a 00                	push   $0x0
      21:	68 eb 4e 00 00       	push   $0x4eeb
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      32:	52                   	push   %edx
      33:	52                   	push   %edx
      34:	68 54 56 00 00       	push   $0x5654
      39:	6a 01                	push   $0x1
      3b:	e8 60 39 00 00       	call   39a0 <printf>
    exit();
...
00000110 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     116:	68 a0 3f 00 00       	push   $0x3fa0
     11b:	ff 35 68 60 00 00    	pushl  0x6068
     121:	e8 7a 38 00 00       	call   39a0 <printf>
  if(mkdir("iputdir") < 0){
     126:	c7 04 24 33 3f 00 00 	movl   $0x3f33,(%esp)
  ...
  if(chdir("iputdir") < 0){
     ...
     13c:	68 33 3f 00 00       	push   $0x3f33
  ...
  if(unlink("../iputdir") < 0){
     ...
     154:	68 30 3f 00 00       	push   $0x3f30
  ...
  if(chdir("/") < 0){
     ...
     168:	68 55 3f 00 00       	push   $0x3f55
  ...
  printf(stdout, "iput test ok\n");
     ...
     17c:	68 d8 3f 00 00       	push   $0x3fd8
     181:	ff 35 68 60 00 00    	pushl  0x6068
     187:	e8 14 38 00 00       	call   39a0 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     191:	50                   	push   %eax
     192:	50                   	push   %eax
     193:	68 0c 3f 00 00       	push   $0x3f0c
     198:	ff 35 68 60 00 00    	pushl  0x6068
     19e:	e8 fd 37 00 00       	call   39a0 <printf>
    exit();
     1a3:	e8 7a 36 00 00       	call   3822 <exit>
    printf(stdout, "chdir / failed\n");
     1a8:	50                   	push   %eax
     1a9:	50                   	push   %eax
     1aa:	68 57 3f 00 00       	push   $0x3f57
     1af:	ff 35 68 60 00 00    	pushl  0x6068
     1b5:	e8 e6 37 00 00       	call   39a0 <printf>
    exit();
     1ba:	e8 63 36 00 00       	call   3822 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1bf:	52                   	push   %edx
     1c0:	52                   	push   %edx
     1c1:	68 3b 3f 00 00       	push   $0x3f3b
     1c6:	ff 35 68 60 00 00    	pushl  0x6068
     1cc:	e8 cf 37 00 00       	call   39a0 <printf>
    exit();
     1d1:	e8 4c 36 00 00       	call   3822 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1d6:	51                   	push   %ecx
     1d7:	51                   	push   %ecx
     1d8:	68 1a 3f 00 00       	push   $0x3f1a
     1dd:	ff 35 68 60 00 00    	pushl  0x6068
     1e3:	e8 b8 37 00 00       	call   39a0 <printf>
    exit();
...
000001f0 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     1f6:	68 67 3f 00 00       	push   $0x3f67
     1fb:	ff 35 68 60 00 00    	pushl  0x6068
     201:	e8 9a 37 00 00       	call   39a0 <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     21b:	68 33 3f 00 00       	push   $0x3f33
    ...
    if(chdir("iputdir") < 0){
     ...
     233:	68 33 3f 00 00       	push   $0x3f33
    ...
    if(unlink("../iputdir") < 0){
     ...
     247:	68 30 3f 00 00       	push   $0x3f30
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     268:	68 8a 3f 00 00       	push   $0x3f8a
     26d:	ff 35 68 60 00 00    	pushl  0x6068
     273:	e8 28 37 00 00       	call   39a0 <printf>
}
     ...
     283:	68 3b 3f 00 00       	push   $0x3f3b
     288:	ff 35 68 60 00 00    	pushl  0x6068
    ...
    printf(stdout, "fork failed\n");
     298:	51                   	push   %ecx
     299:	51                   	push   %ecx
     29a:	68 4d 4e 00 00       	push   $0x4e4d
     29f:	ff 35 68 60 00 00    	pushl  0x6068
     2a5:	e8 f6 36 00 00       	call   39a0 <printf>
    exit();
     2aa:	e8 73 35 00 00       	call   3822 <exit>
      printf(stdout, "child chdir failed\n");
     2af:	50                   	push   %eax
     2b0:	50                   	push   %eax
     2b1:	68 76 3f 00 00       	push   $0x3f76
     2b6:	ff 35 68 60 00 00    	pushl  0x6068
     2bc:	e8 df 36 00 00       	call   39a0 <printf>
      exit();
     2c1:	e8 5c 35 00 00       	call   3822 <exit>
      printf(stdout, "mkdir failed\n");
     2c6:	52                   	push   %edx
     2c7:	52                   	push   %edx
     2c8:	68 0c 3f 00 00       	push   $0x3f0c
     2cd:	ff 35 68 60 00 00    	pushl  0x6068
     2d3:	e8 c8 36 00 00       	call   39a0 <printf>
      exit();
...
000002e0 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     2e6:	68 9c 3f 00 00       	push   $0x3f9c
     2eb:	ff 35 68 60 00 00    	pushl  0x6068
     2f1:	e8 aa 36 00 00       	call   39a0 <printf>
  if(mkdir("oidir") < 0){
     2f6:	c7 04 24 ab 3f 00 00 	movl   $0x3fab,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     31f:	6a 02                	push   $0x2
     321:	68 ab 3f 00 00       	push   $0x3fab
    ...
    if(fd >= 0){
     ...
     335:	68 0c 4f 00 00       	push   $0x4f0c
     33a:	ff 35 68 60 00 00    	pushl  0x6068
     340:	e8 5b 36 00 00       	call   39a0 <printf>
      exit();
  ...
  sleep(1);
     ...
     353:	6a 01                	push   $0x1
     355:	e8 60 35 00 00       	call   38ba <sleep>
  if(unlink("oidir") != 0){
     35a:	c7 04 24 ab 3f 00 00 	movl   $0x3fab,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     375:	68 d4 3f 00 00       	push   $0x3fd4
     37a:	ff 35 68 60 00 00    	pushl  0x6068
     380:	e8 1b 36 00 00       	call   39a0 <printf>
    ...
    printf(stdout, "mkdir oidir failed\n");
     395:	51                   	push   %ecx
     396:	51                   	push   %ecx
     397:	68 b1 3f 00 00       	push   $0x3fb1
     39c:	ff 35 68 60 00 00    	pushl  0x6068
     3a2:	e8 f9 35 00 00       	call   39a0 <printf>
    exit();
     3a7:	e8 76 34 00 00       	call   3822 <exit>
    printf(stdout, "fork failed\n");
     3ac:	52                   	push   %edx
     3ad:	52                   	push   %edx
     3ae:	68 4d 4e 00 00       	push   $0x4e4d
     3b3:	ff 35 68 60 00 00    	pushl  0x6068
     3b9:	e8 e2 35 00 00       	call   39a0 <printf>
    exit();
     3be:	e8 5f 34 00 00       	call   3822 <exit>
    printf(stdout, "unlink failed\n");
     3c3:	50                   	push   %eax
     3c4:	50                   	push   %eax
     3c5:	68 c5 3f 00 00       	push   $0x3fc5
     3ca:	ff 35 68 60 00 00    	pushl  0x6068
     3d0:	e8 cb 35 00 00       	call   39a0 <printf>
    exit();
...
000003e0 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     3e6:	68 e6 3f 00 00       	push   $0x3fe6
     3eb:	ff 35 68 60 00 00    	pushl  0x6068
     3f1:	e8 aa 35 00 00       	call   39a0 <printf>
  fd = open("echo", 0);
     3f6:	58                   	pop    %eax
     3f7:	5a                   	pop    %edx
     3f8:	6a 00                	push   $0x0
     3fa:	68 f1 3f 00 00       	push   $0x3ff1
  ...
  fd = open("doesnotexist", 0);
     ...
     415:	59                   	pop    %ecx
     416:	6a 00                	push   $0x0
     418:	68 09 40 00 00       	push   $0x4009
  ...
  printf(stdout, "open test ok\n");
     ...
     42c:	68 34 40 00 00       	push   $0x4034
     431:	ff 35 68 60 00 00    	pushl  0x6068
     437:	e8 64 35 00 00       	call   39a0 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     441:	50                   	push   %eax
     442:	50                   	push   %eax
     443:	68 f6 3f 00 00       	push   $0x3ff6
     448:	ff 35 68 60 00 00    	pushl  0x6068
     44e:	e8 4d 35 00 00       	call   39a0 <printf>
    exit();
     453:	e8 ca 33 00 00       	call   3822 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     458:	50                   	push   %eax
     459:	50                   	push   %eax
     45a:	68 16 40 00 00       	push   $0x4016
     45f:	ff 35 68 60 00 00    	pushl  0x6068
     465:	e8 36 35 00 00       	call   39a0 <printf>
    exit();
...
00000470 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     478:	68 42 40 00 00       	push   $0x4042
     47d:	ff 35 68 60 00 00    	pushl  0x6068
     483:	e8 18 35 00 00       	call   39a0 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     488:	58                   	pop    %eax
     489:	5a                   	pop    %edx
     48a:	68 02 02 00 00       	push   $0x202
     48f:	68 53 40 00 00       	push   $0x4053
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4ab:	68 59 40 00 00       	push   $0x4059
     4b0:	ff 35 68 60 00 00    	pushl  0x6068
     4b6:	e8 e5 34 00 00       	call   39a0 <printf>
     4bb:	83 c4 10             	add    $0x10,%esp
     4be:	66 90                	xchg   %ax,%ax
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     4c0:	83 ec 04             	sub    $0x4,%esp
     4c3:	6a 0a                	push   $0xa
     4c5:	68 90 40 00 00       	push   $0x4090
     4ca:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4df:	6a 0a                	push   $0xa
     4e1:	68 9b 40 00 00       	push   $0x409b
     4e6:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     503:	68 a6 40 00 00       	push   $0x40a6
     508:	ff 35 68 60 00 00    	pushl  0x6068
     50e:	e8 8d 34 00 00       	call   39a0 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     51c:	5e                   	pop    %esi
     51d:	6a 00                	push   $0x0
     51f:	68 53 40 00 00       	push   $0x4053
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     539:	68 b1 40 00 00       	push   $0x40b1
     53e:	ff 35 68 60 00 00    	pushl  0x6068
     544:	e8 57 34 00 00       	call   39a0 <printf>
  i = read(fd, buf, 2000);
     549:	83 c4 0c             	add    $0xc,%esp
     54c:	68 d0 07 00 00       	push   $0x7d0
     551:	68 60 88 00 00       	push   $0x8860
     556:	53                   	push   %ebx
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     56d:	68 e5 40 00 00       	push   $0x40e5
     572:	ff 35 68 60 00 00    	pushl  0x6068
     578:	e8 23 34 00 00       	call   39a0 <printf>
  close(fd);
     57d:	89 1c 24             	mov    %ebx,(%esp)
     580:	e8 c5 32 00 00       	call   384a <close>
  if(unlink("small") < 0){
     585:	c7 04 24 53 40 00 00 	movl   $0x4053,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     59b:	68 0d 41 00 00       	push   $0x410d
     5a0:	ff 35 68 60 00 00    	pushl  0x6068
     5a6:	e8 f5 33 00 00       	call   39a0 <printf>
}
     ...
     5b8:	53                   	push   %ebx
     5b9:	68 30 4f 00 00       	push   $0x4f30
     5be:	ff 35 68 60 00 00    	pushl  0x6068
     5c4:	e8 d7 33 00 00       	call   39a0 <printf>
      exit();
     5c9:	e8 54 32 00 00       	call   3822 <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     5ce:	83 ec 04             	sub    $0x4,%esp
     5d1:	53                   	push   %ebx
     5d2:	68 54 4f 00 00       	push   $0x4f54
     5d7:	ff 35 68 60 00 00    	pushl  0x6068
     5dd:	e8 be 33 00 00       	call   39a0 <printf>
      exit();
     5e2:	e8 3b 32 00 00       	call   3822 <exit>
    printf(stdout, "error: open small failed!\n");
     5e7:	51                   	push   %ecx
     5e8:	51                   	push   %ecx
     5e9:	68 ca 40 00 00       	push   $0x40ca
     5ee:	ff 35 68 60 00 00    	pushl  0x6068
     5f4:	e8 a7 33 00 00       	call   39a0 <printf>
    exit();
     5f9:	e8 24 32 00 00       	call   3822 <exit>
    printf(stdout, "read failed\n");
     5fe:	52                   	push   %edx
     5ff:	52                   	push   %edx
     600:	68 11 44 00 00       	push   $0x4411
     605:	ff 35 68 60 00 00    	pushl  0x6068
     60b:	e8 90 33 00 00       	call   39a0 <printf>
    exit();
     610:	e8 0d 32 00 00       	call   3822 <exit>
    printf(stdout, "unlink small failed\n");
     615:	50                   	push   %eax
     616:	50                   	push   %eax
     617:	68 f8 40 00 00       	push   $0x40f8
     61c:	ff 35 68 60 00 00    	pushl  0x6068
     622:	e8 79 33 00 00       	call   39a0 <printf>
    exit();
     627:	e8 f6 31 00 00       	call   3822 <exit>
    printf(stdout, "error: creat small failed!\n");
     62c:	50                   	push   %eax
     62d:	50                   	push   %eax
     62e:	68 74 40 00 00       	push   $0x4074
     633:	ff 35 68 60 00 00    	pushl  0x6068
     639:	e8 62 33 00 00       	call   39a0 <printf>
    exit();
...
00000650 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     658:	68 21 41 00 00       	push   $0x4121
     65d:	ff 35 68 60 00 00    	pushl  0x6068
     663:	e8 38 33 00 00       	call   39a0 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     668:	58                   	pop    %eax
     669:	5a                   	pop    %edx
     66a:	68 02 02 00 00       	push   $0x202
     66f:	68 9b 41 00 00       	push   $0x419b
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     693:	89 1d 60 88 00 00    	mov    %ebx,0x8860
    if(write(fd, buf, 512) != 512){
     699:	68 00 02 00 00       	push   $0x200
     69e:	68 60 88 00 00       	push   $0x8860
     6a3:	56                   	push   %esi
  ...
  fd = open("big", O_RDONLY);
     ...
     6cc:	5e                   	pop    %esi
     6cd:	6a 00                	push   $0x0
     6cf:	68 9b 41 00 00       	push   $0x419b
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     6fb:	a1 60 88 00 00       	mov    0x8860,%eax
    ...
    i = read(fd, buf, 512);
     ...
     70f:	68 60 88 00 00       	push   $0x8860
     714:	56                   	push   %esi
  ...
  if(unlink("big") < 0){
     736:	c7 04 24 9b 41 00 00 	movl   $0x419b,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     750:	68 c2 41 00 00       	push   $0x41c2
     755:	ff 35 68 60 00 00    	pushl  0x6068
     75b:	e8 40 32 00 00       	call   39a0 <printf>
}
     ...
     76d:	53                   	push   %ebx
     76e:	68 4b 41 00 00       	push   $0x414b
     773:	ff 35 68 60 00 00    	pushl  0x6068
     779:	e8 22 32 00 00       	call   39a0 <printf>
      exit();
     77e:	e8 9f 30 00 00       	call   3822 <exit>
      printf(stdout, "read content of block %d is %d\n",
     783:	50                   	push   %eax
     784:	53                   	push   %ebx
     785:	68 78 4f 00 00       	push   $0x4f78
     78a:	ff 35 68 60 00 00    	pushl  0x6068
     790:	e8 0b 32 00 00       	call   39a0 <printf>
      exit();
     795:	e8 88 30 00 00       	call   3822 <exit>
      printf(stdout, "read failed %d\n", i);
     79a:	83 ec 04             	sub    $0x4,%esp
     79d:	50                   	push   %eax
     79e:	68 9f 41 00 00       	push   $0x419f
     7a3:	ff 35 68 60 00 00    	pushl  0x6068
     7a9:	e8 f2 31 00 00       	call   39a0 <printf>
      exit();
     7ae:	e8 6f 30 00 00       	call   3822 <exit>
        printf(stdout, "read only %d blocks from big", n);
     7b3:	52                   	push   %edx
     7b4:	68 8b 00 00 00       	push   $0x8b
     7b9:	68 82 41 00 00       	push   $0x4182
     7be:	ff 35 68 60 00 00    	pushl  0x6068
     7c4:	e8 d7 31 00 00       	call   39a0 <printf>
        exit();
     7c9:	e8 54 30 00 00       	call   3822 <exit>
    printf(stdout, "error: open big failed!\n");
     7ce:	51                   	push   %ecx
     7cf:	51                   	push   %ecx
     7d0:	68 69 41 00 00       	push   $0x4169
     7d5:	ff 35 68 60 00 00    	pushl  0x6068
    ...
    printf(stdout, "error: creat big failed!\n");
     7e5:	50                   	push   %eax
     7e6:	50                   	push   %eax
     7e7:	68 31 41 00 00       	push   $0x4131
     7ec:	ff 35 68 60 00 00    	pushl  0x6068
     7f2:	e8 a9 31 00 00       	call   39a0 <printf>
    exit();
     7f7:	e8 26 30 00 00       	call   3822 <exit>
    printf(stdout, "unlink big failed\n");
     7fc:	50                   	push   %eax
     7fd:	50                   	push   %eax
     7fe:	68 af 41 00 00       	push   $0x41af
     803:	ff 35 68 60 00 00    	pushl  0x6068
     809:	e8 92 31 00 00       	call   39a0 <printf>
    exit();
     ...
     824:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     82c:	68 98 4f 00 00       	push   $0x4f98
     831:	ff 35 68 60 00 00    	pushl  0x6068
     837:	e8 64 31 00 00       	call   39a0 <printf>
  name[0] = 'a';
     83c:	c6 05 60 a8 00 00 61 	movb   $0x61,0xa860
  name[2] = '\0';
     843:	c6 05 62 a8 00 00 00 	movb   $0x0,0xa862
     84a:	83 c4 10             	add    $0x10,%esp
     84d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     850:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     853:	88 1d 61 a8 00 00    	mov    %bl,0xa861
     859:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     85c:	68 02 02 00 00       	push   $0x202
     861:	68 60 a8 00 00       	push   $0xa860
  ...
  name[0] = 'a';
     87b:	c6 05 60 a8 00 00 61 	movb   $0x61,0xa860
  name[2] = '\0';
     882:	c6 05 62 a8 00 00 00 	movb   $0x0,0xa862
     889:	bb 30 00 00 00       	mov    $0x30,%ebx
     88e:	66 90                	xchg   %ax,%ax
    unlink(name);
     890:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     893:	88 1d 61 a8 00 00    	mov    %bl,0xa861
     899:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     89c:	68 60 a8 00 00       	push   $0xa860
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8b1:	68 c0 4f 00 00       	push   $0x4fc0
     8b6:	ff 35 68 60 00 00    	pushl  0x6068
     8bc:	e8 df 30 00 00       	call   39a0 <printf>
}
...
000008d0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     8d6:	68 d0 41 00 00       	push   $0x41d0
     8db:	ff 35 68 60 00 00    	pushl  0x6068
     8e1:	e8 ba 30 00 00       	call   39a0 <printf>
  if(mkdir("dir0") < 0){
     8e6:	c7 04 24 dc 41 00 00 	movl   $0x41dc,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     8fc:	68 dc 41 00 00       	push   $0x41dc
  ...
  if(chdir("..") < 0){
     ...
     914:	68 81 47 00 00       	push   $0x4781
  ...
  if(unlink("dir0") < 0){
     ...
     928:	68 dc 41 00 00       	push   $0x41dc
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     93c:	68 19 42 00 00       	push   $0x4219
     941:	ff 35 68 60 00 00    	pushl  0x6068
     947:	e8 54 30 00 00       	call   39a0 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     951:	50                   	push   %eax
     952:	50                   	push   %eax
     953:	68 0c 3f 00 00       	push   $0x3f0c
     958:	ff 35 68 60 00 00    	pushl  0x6068
     95e:	e8 3d 30 00 00       	call   39a0 <printf>
    exit();
     963:	e8 ba 2e 00 00       	call   3822 <exit>
    printf(stdout, "unlink dir0 failed\n");
     968:	50                   	push   %eax
     969:	50                   	push   %eax
     96a:	68 05 42 00 00       	push   $0x4205
     96f:	ff 35 68 60 00 00    	pushl  0x6068
     975:	e8 26 30 00 00       	call   39a0 <printf>
    exit();
     97a:	e8 a3 2e 00 00       	call   3822 <exit>
    printf(stdout, "chdir .. failed\n");
     97f:	52                   	push   %edx
     980:	52                   	push   %edx
     981:	68 f4 41 00 00       	push   $0x41f4
     986:	ff 35 68 60 00 00    	pushl  0x6068
     98c:	e8 0f 30 00 00       	call   39a0 <printf>
    exit();
     991:	e8 8c 2e 00 00       	call   3822 <exit>
    printf(stdout, "chdir dir0 failed\n");
     996:	51                   	push   %ecx
     997:	51                   	push   %ecx
     998:	68 e1 41 00 00       	push   $0x41e1
     99d:	ff 35 68 60 00 00    	pushl  0x6068
     9a3:	e8 f8 2f 00 00       	call   39a0 <printf>
    exit();
...
000009b0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     9b6:	68 28 42 00 00       	push   $0x4228
     9bb:	ff 35 68 60 00 00    	pushl  0x6068
     9c1:	e8 da 2f 00 00       	call   39a0 <printf>
  if(exec("echo", echoargv) < 0){
     9c6:	5a                   	pop    %edx
     9c7:	59                   	pop    %ecx
     9c8:	68 6c 60 00 00       	push   $0x606c
     9cd:	68 f1 3f 00 00       	push   $0x3ff1
    ...
    printf(stdout, "exec echo failed\n");
     9e0:	50                   	push   %eax
     9e1:	50                   	push   %eax
     9e2:	68 33 42 00 00       	push   $0x4233
     9e7:	ff 35 68 60 00 00    	pushl  0x6068
     9ed:	e8 ae 2f 00 00       	call   39a0 <printf>
    exit();
     ...
     a06:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a50:	57                   	push   %edi
     a51:	68 60 88 00 00       	push   $0x8860
     ...
     a6e:	f7 d9                	neg    %ecx
     a70:	38 9c 0b 60 88 00 00 	cmp    %bl,0x8860(%ebx,%ecx,1)
     ...
     a9a:	68 62 42 00 00       	push   $0x4262
     a9f:	6a 01                	push   $0x1
     aa1:	e8 fa 2e 00 00       	call   39a0 <printf>
          return;
    ...
    close(fds[0]);
     ...
     ace:	66 90                	xchg   %ax,%ax
        buf[i] = seq++;
     ad0:	88 84 03 60 88 00 00 	mov    %al,0x8860(%ebx,%eax,1)
     ...
     ae6:	68 60 88 00 00       	push   $0x8860
  ...
  printf(1, "pipe1 ok\n");
     b2d:	5a                   	pop    %edx
     b2e:	59                   	pop    %ecx
     b2f:	68 87 42 00 00       	push   $0x4287
     b34:	6a 01                	push   $0x1
     b36:	e8 65 2e 00 00       	call   39a0 <printf>
     ...
     b4a:	68 70 42 00 00       	push   $0x4270
     b4f:	6a 01                	push   $0x1
     b51:	e8 4a 2e 00 00       	call   39a0 <printf>
      exit();
     b56:	e8 c7 2c 00 00       	call   3822 <exit>
    printf(1, "pipe() failed\n");
     b5b:	57                   	push   %edi
     b5c:	57                   	push   %edi
     b5d:	68 45 42 00 00       	push   $0x4245
     b62:	6a 01                	push   $0x1
     b64:	e8 37 2e 00 00       	call   39a0 <printf>
    exit();
     b69:	e8 b4 2c 00 00       	call   3822 <exit>
    printf(1, "fork() failed\n");
     b6e:	50                   	push   %eax
     b6f:	50                   	push   %eax
     b70:	68 91 42 00 00       	push   $0x4291
     b75:	6a 01                	push   $0x1
     b77:	e8 24 2e 00 00       	call   39a0 <printf>
    exit();
     b7c:	e8 a1 2c 00 00       	call   3822 <exit>
        printf(1, "pipe1 oops 1\n");
     b81:	56                   	push   %esi
     b82:	56                   	push   %esi
     b83:	68 54 42 00 00       	push   $0x4254
     b88:	6a 01                	push   $0x1
     b8a:	e8 11 2e 00 00       	call   39a0 <printf>
        exit();
...
00000ba0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     ba9:	68 a0 42 00 00       	push   $0x42a0
     bae:	6a 01                	push   $0x1
     bb0:	e8 eb 2d 00 00       	call   39a0 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bfa:	6a 01                	push   $0x1
     bfc:	68 65 48 00 00       	push   $0x4865
     ...
     c11:	50                   	push   %eax
     c12:	50                   	push   %eax
     c13:	68 aa 42 00 00       	push   $0x42aa
     c18:	6a 01                	push   $0x1
     c1a:	e8 81 2d 00 00       	call   39a0 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c45:	68 60 88 00 00       	push   $0x8860
    ...
    printf(1, "preempt read error");
     c5a:	50                   	push   %eax
     c5b:	50                   	push   %eax
     c5c:	68 be 42 00 00       	push   $0x42be
     c61:	6a 01                	push   $0x1
     c63:	e8 38 2d 00 00       	call   39a0 <printf>
    return;
  ...
  printf(1, "kill... ");
     c7e:	58                   	pop    %eax
     c7f:	5a                   	pop    %edx
     c80:	68 d1 42 00 00       	push   $0x42d1
     c85:	6a 01                	push   $0x1
     c87:	e8 14 2d 00 00       	call   39a0 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ca4:	59                   	pop    %ecx
     ca5:	5b                   	pop    %ebx
     ca6:	68 da 42 00 00       	push   $0x42da
     cab:	6a 01                	push   $0x1
     cad:	e8 ee 2c 00 00       	call   39a0 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     cc1:	5e                   	pop    %esi
     cc2:	5f                   	pop    %edi
     cc3:	68 e3 42 00 00       	push   $0x42e3
     cc8:	6a 01                	push   $0x1
     cca:	e8 d1 2c 00 00       	call   39a0 <printf>
...
00000ce0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d0e:	68 4d 4e 00 00       	push   $0x4e4d
     d13:	6a 01                	push   $0x1
     d15:	e8 86 2c 00 00       	call   39a0 <printf>
      return;
     ...
     d2b:	68 ef 42 00 00       	push   $0x42ef
     d30:	6a 01                	push   $0x1
     d32:	e8 69 2c 00 00       	call   39a0 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     d4b:	68 ff 42 00 00       	push   $0x42ff
     d50:	6a 01                	push   $0x1
     d52:	e8 49 2c 00 00       	call   39a0 <printf>
...
00000d70 <mem>:
{
  ...
  printf(1, "mem test\n");
     d7b:	68 0c 43 00 00       	push   $0x430c
     d80:	6a 01                	push   $0x1
     d82:	e8 19 2c 00 00       	call   39a0 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     dac:	e8 4f 2e 00 00       	call   3c00 <malloc>
    ...
    while(m1){
     ...
     dc8:	e8 a3 2d 00 00       	call   3b70 <free>
    while(m1){
    ...
    m1 = malloc(1024*20);
     ...
     ddc:	e8 1f 2e 00 00       	call   3c00 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     deb:	50                   	push   %eax
     dec:	e8 7f 2d 00 00       	call   3b70 <free>
    printf(1, "mem ok\n");
     df1:	58                   	pop    %eax
     df2:	5a                   	pop    %edx
     df3:	68 30 43 00 00       	push   $0x4330
     df8:	6a 01                	push   $0x1
     dfa:	e8 a1 2b 00 00       	call   39a0 <printf>
    exit();
     dff:	e8 1e 2a 00 00       	call   3822 <exit>
     e04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(1, "couldn't allocate mem?!!\n");
     e08:	83 ec 08             	sub    $0x8,%esp
     e0b:	68 16 43 00 00       	push   $0x4316
     e10:	6a 01                	push   $0x1
     e12:	e8 89 2b 00 00       	call   39a0 <printf>
      kill(ppid);
...
00000e40 <sharedfd>:
{
  ...
  printf(1, "sharedfd test\n");
     e49:	68 38 43 00 00       	push   $0x4338
     e4e:	6a 01                	push   $0x1
     e50:	e8 4b 2b 00 00       	call   39a0 <printf>
  unlink("sharedfd");
     e55:	c7 04 24 47 43 00 00 	movl   $0x4347,(%esp)
     e5c:	e8 11 2a 00 00       	call   3872 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e61:	59                   	pop    %ecx
     e62:	5b                   	pop    %ebx
     e63:	68 02 02 00 00       	push   $0x202
     e68:	68 47 43 00 00       	push   $0x4347
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecf:	68 14 50 00 00       	push   $0x5014
     ed4:	6a 01                	push   $0x1
     ed6:	e8 c5 2a 00 00       	call   39a0 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     efc:	5a                   	pop    %edx
     efd:	6a 00                	push   $0x0
     eff:	68 47 43 00 00       	push   $0x4347
  ...
  unlink("sharedfd");
     f71:	c7 04 24 47 43 00 00 	movl   $0x4347,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     f93:	68 50 43 00 00       	push   $0x4350
     f98:	6a 01                	push   $0x1
     f9a:	e8 01 2a 00 00       	call   39a0 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fb3:	68 e8 4f 00 00       	push   $0x4fe8
     fb8:	6a 01                	push   $0x1
     fba:	e8 e1 29 00 00       	call   39a0 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fcd:	68 34 50 00 00       	push   $0x5034
     fd2:	6a 01                	push   $0x1
     fd4:	e8 c7 29 00 00       	call   39a0 <printf>
    return;
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     fe9:	53                   	push   %ebx
     fea:	57                   	push   %edi
     feb:	68 5d 43 00 00       	push   $0x435d
     ff0:	6a 01                	push   $0x1
     ff2:	e8 a9 29 00 00       	call   39a0 <printf>
    exit();
...
00001000 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1006:	be 72 43 00 00       	mov    $0x4372,%esi
  for(pi = 0; pi < 4; pi++){
    100b:	31 db                	xor    %ebx,%ebx
{
    100d:	83 ec 34             	sub    $0x34,%esp
  char *names[] = { "f0", "f1", "f2", "f3" };
    1010:	c7 45 d8 72 43 00 00 	movl   $0x4372,-0x28(%ebp)
    1017:	c7 45 dc bb 44 00 00 	movl   $0x44bb,-0x24(%ebp)
  printf(1, "fourfiles test\n");
    101e:	68 78 43 00 00       	push   $0x4378
    1023:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    1025:	c7 45 e0 bf 44 00 00 	movl   $0x44bf,-0x20(%ebp)
    102c:	c7 45 e4 75 43 00 00 	movl   $0x4375,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
    1033:	e8 68 29 00 00       	call   39a0 <printf>
  ...
  for(i = 0; i < 2; i++){
    ...
    107e:	c7 45 d0 72 43 00 00 	movl   $0x4372,-0x30(%ebp)
    fd = open(fname, 0);
    ...
    10a8:	68 60 88 00 00       	push   $0x8860
    ...
    10be:	66 90                	xchg   %ax,%ax
        if(buf[j] != '0'+i){
    10c0:	0f be b2 60 88 00 00 	movsbl 0x8860(%edx),%esi
  ...
  printf(1, "fourfiles ok\n");
    ...
    1112:	68 b6 43 00 00       	push   $0x43b6
    1117:	6a 01                	push   $0x1
    1119:	e8 82 28 00 00       	call   39a0 <printf>
}
    ...
    1161:	68 60 88 00 00       	push   $0x8860
    ...
    1176:	68 60 88 00 00       	push   $0x8860
    117b:	56                   	push   %esi
    ...
    1198:	68 99 43 00 00       	push   $0x4399
    119d:	6a 01                	push   $0x1
    119f:	e8 fc 27 00 00       	call   39a0 <printf>
          exit();
    11a4:	e8 79 26 00 00       	call   3822 <exit>
        printf(1, "create failed\n");
    11a9:	51                   	push   %ecx
    11aa:	51                   	push   %ecx
    11ab:	68 13 46 00 00       	push   $0x4613
    11b0:	6a 01                	push   $0x1
    11b2:	e8 e9 27 00 00       	call   39a0 <printf>
        exit();
    11b7:	e8 66 26 00 00       	call   3822 <exit>
      printf(1, "fork failed\n");
    11bc:	53                   	push   %ebx
    11bd:	53                   	push   %ebx
    11be:	68 4d 4e 00 00       	push   $0x4e4d
    11c3:	6a 01                	push   $0x1
    11c5:	e8 d6 27 00 00       	call   39a0 <printf>
      exit();
    11ca:	e8 53 26 00 00       	call   3822 <exit>
      printf(1, "wrong length %d\n", total);
    11cf:	50                   	push   %eax
    11d0:	53                   	push   %ebx
    11d1:	68 a5 43 00 00       	push   $0x43a5
    11d6:	6a 01                	push   $0x1
    11d8:	e8 c3 27 00 00       	call   39a0 <printf>
      exit();
    11dd:	e8 40 26 00 00       	call   3822 <exit>
          printf(1, "write failed %d\n", n);
    11e2:	52                   	push   %edx
    11e3:	50                   	push   %eax
    11e4:	68 88 43 00 00       	push   $0x4388
    11e9:	6a 01                	push   $0x1
    11eb:	e8 b0 27 00 00       	call   39a0 <printf>
          exit();
    ...
    1206:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    120b:	68 c4 43 00 00       	push   $0x43c4
    1210:	6a 01                	push   $0x1
    1212:	e8 89 27 00 00       	call   39a0 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    1304:	68 d7 43 00 00       	push   $0x43d7
    1309:	6a 01                	push   $0x1
    130b:	e8 90 26 00 00       	call   39a0 <printf>
}
    ...
    13a2:	52                   	push   %edx
    13a3:	52                   	push   %edx
    13a4:	68 c5 3f 00 00       	push   $0x3fc5
    13a9:	6a 01                	push   $0x1
    13ab:	e8 f0 25 00 00       	call   39a0 <printf>
            exit();
    ...
    13c0:	57                   	push   %edi
    13c1:	68 60 50 00 00       	push   $0x5060
    13c6:	6a 01                	push   $0x1
    13c8:	e8 d3 25 00 00       	call   39a0 <printf>
        exit();
    13cd:	e8 50 24 00 00       	call   3822 <exit>
          printf(1, "create failed\n");
    13d2:	51                   	push   %ecx
    13d3:	51                   	push   %ecx
    13d4:	68 13 46 00 00       	push   $0x4613
    13d9:	6a 01                	push   $0x1
    13db:	e8 c0 25 00 00       	call   39a0 <printf>
          exit();
    13e0:	e8 3d 24 00 00       	call   3822 <exit>
      printf(1, "fork failed\n");
    13e5:	53                   	push   %ebx
    13e6:	53                   	push   %ebx
    13e7:	68 4d 4e 00 00       	push   $0x4e4d
    13ec:	6a 01                	push   $0x1
    13ee:	e8 ad 25 00 00       	call   39a0 <printf>
      exit();
    ...
    1400:	50                   	push   %eax
    1401:	57                   	push   %edi
    1402:	68 84 50 00 00       	push   $0x5084
    1407:	6a 01                	push   $0x1
    1409:	e8 92 25 00 00       	call   39a0 <printf>
        exit();
...
00001420 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1428:	68 e8 43 00 00       	push   $0x43e8
    142d:	6a 01                	push   $0x1
    142f:	e8 6c 25 00 00       	call   39a0 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1434:	5b                   	pop    %ebx
    1435:	5e                   	pop    %esi
    1436:	68 02 02 00 00       	push   $0x202
    143b:	68 f9 43 00 00       	push   $0x43f9
  ...
  write(fd, "hello", 5);
    ...
    1455:	6a 05                	push   $0x5
    1457:	68 1e 44 00 00       	push   $0x441e
    145c:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    146b:	5a                   	pop    %edx
    146c:	6a 02                	push   $0x2
    146e:	68 f9 43 00 00       	push   $0x43f9
  ...
  if(unlink("unlinkread") != 0){
    ...
    1488:	68 f9 43 00 00       	push   $0x43f9
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14a5:	68 f9 43 00 00       	push   $0x43f9
  ...
  write(fd1, "yyy", 3);
    14b4:	6a 03                	push   $0x3
    14b6:	68 56 44 00 00       	push   $0x4456
    14bb:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14d1:	68 60 88 00 00       	push   $0x8860
    14d6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14e8:	80 3d 60 88 00 00 68 	cmpb   $0x68,0x8860
    14ef:	75 6b                	jne    155c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    14f1:	83 ec 04             	sub    $0x4,%esp
    14f4:	6a 0a                	push   $0xa
    14f6:	68 60 88 00 00       	push   $0x8860
    14fb:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    1512:	c7 04 24 f9 43 00 00 	movl   $0x43f9,(%esp)
    1519:	e8 54 23 00 00       	call   3872 <unlink>
  printf(1, "unlinkread ok\n");
    151e:	58                   	pop    %eax
    151f:	5a                   	pop    %edx
    1520:	68 a1 44 00 00       	push   $0x44a1
    1525:	6a 01                	push   $0x1
    1527:	e8 74 24 00 00       	call   39a0 <printf>
}
    ...
    1536:	51                   	push   %ecx
    1537:	51                   	push   %ecx
    1538:	68 04 44 00 00       	push   $0x4404
    153d:	6a 01                	push   $0x1
    153f:	e8 5c 24 00 00       	call   39a0 <printf>
    exit();
    1544:	e8 d9 22 00 00       	call   3822 <exit>
    printf(1, "unlinkread write failed\n");
    1549:	51                   	push   %ecx
    154a:	51                   	push   %ecx
    154b:	68 88 44 00 00       	push   $0x4488
    1550:	6a 01                	push   $0x1
    1552:	e8 49 24 00 00       	call   39a0 <printf>
    exit();
    1557:	e8 c6 22 00 00       	call   3822 <exit>
    printf(1, "unlinkread wrong data\n");
    155c:	53                   	push   %ebx
    155d:	53                   	push   %ebx
    155e:	68 71 44 00 00       	push   $0x4471
    1563:	6a 01                	push   $0x1
    1565:	e8 36 24 00 00       	call   39a0 <printf>
    exit();
    156a:	e8 b3 22 00 00       	call   3822 <exit>
    printf(1, "unlinkread read failed");
    156f:	56                   	push   %esi
    1570:	56                   	push   %esi
    1571:	68 5a 44 00 00       	push   $0x445a
    1576:	6a 01                	push   $0x1
    1578:	e8 23 24 00 00       	call   39a0 <printf>
    exit();
    157d:	e8 a0 22 00 00       	call   3822 <exit>
    printf(1, "unlink unlinkread failed\n");
    1582:	50                   	push   %eax
    1583:	50                   	push   %eax
    1584:	68 3c 44 00 00       	push   $0x443c
    1589:	6a 01                	push   $0x1
    ...
    1595:	50                   	push   %eax
    1596:	50                   	push   %eax
    1597:	68 24 44 00 00       	push   $0x4424
    159c:	6a 01                	push   $0x1
    159e:	e8 fd 23 00 00       	call   39a0 <printf>
    exit();
...
000015b0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    15b7:	68 b0 44 00 00       	push   $0x44b0
    15bc:	6a 01                	push   $0x1
    15be:	e8 dd 23 00 00       	call   39a0 <printf>
  unlink("lf1");
    15c3:	c7 04 24 ba 44 00 00 	movl   $0x44ba,(%esp)
    15ca:	e8 a3 22 00 00       	call   3872 <unlink>
  unlink("lf2");
    15cf:	c7 04 24 be 44 00 00 	movl   $0x44be,(%esp)
    15d6:	e8 97 22 00 00       	call   3872 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    15db:	58                   	pop    %eax
    15dc:	5a                   	pop    %edx
    15dd:	68 02 02 00 00       	push   $0x202
    15e2:	68 ba 44 00 00       	push   $0x44ba
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    15fc:	6a 05                	push   $0x5
    15fe:	68 1e 44 00 00       	push   $0x441e
    1603:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    161e:	5b                   	pop    %ebx
    161f:	58                   	pop    %eax
    1620:	68 be 44 00 00       	push   $0x44be
    1625:	68 ba 44 00 00       	push   $0x44ba
  ...
  unlink("lf1");
    ...
    163d:	68 ba 44 00 00       	push   $0x44ba
    1642:	e8 2b 22 00 00       	call   3872 <unlink>
  if(open("lf1", 0) >= 0){
    1647:	58                   	pop    %eax
    1648:	5a                   	pop    %edx
    1649:	6a 00                	push   $0x0
    164b:	68 ba 44 00 00       	push   $0x44ba
  ...
  fd = open("lf2", 0);
    ...
    1663:	6a 00                	push   $0x0
    1665:	68 be 44 00 00       	push   $0x44be
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1684:	68 60 88 00 00       	push   $0x8860
    1689:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    16a4:	58                   	pop    %eax
    16a5:	5a                   	pop    %edx
    16a6:	68 be 44 00 00       	push   $0x44be
    16ab:	68 be 44 00 00       	push   $0x44be
  ...
  unlink("lf2");
    ...
    16c3:	68 be 44 00 00       	push   $0x44be
    16c8:	e8 a5 21 00 00       	call   3872 <unlink>
  if(link("lf2", "lf1") >= 0){
    16cd:	59                   	pop    %ecx
    16ce:	5b                   	pop    %ebx
    16cf:	68 ba 44 00 00       	push   $0x44ba
    16d4:	68 be 44 00 00       	push   $0x44be
  ...
  if(link(".", "lf1") >= 0){
    ...
    16e8:	68 ba 44 00 00       	push   $0x44ba
    16ed:	68 82 47 00 00       	push   $0x4782
  ...
  printf(1, "linktest ok\n");
    ...
    1701:	68 58 45 00 00       	push   $0x4558
    1706:	6a 01                	push   $0x1
    1708:	e8 93 22 00 00       	call   39a0 <printf>
}
    ...
    1715:	50                   	push   %eax
    1716:	50                   	push   %eax
    1717:	68 c2 44 00 00       	push   $0x44c2
    171c:	6a 01                	push   $0x1
    171e:	e8 7d 22 00 00       	call   39a0 <printf>
    exit();
    1723:	e8 fa 20 00 00       	call   3822 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1728:	50                   	push   %eax
    1729:	50                   	push   %eax
    172a:	68 3c 45 00 00       	push   $0x453c
    172f:	6a 01                	push   $0x1
    1731:	e8 6a 22 00 00       	call   39a0 <printf>
    exit();
    1736:	e8 e7 20 00 00       	call   3822 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    173b:	52                   	push   %edx
    173c:	52                   	push   %edx
    173d:	68 cc 50 00 00       	push   $0x50cc
    1742:	6a 01                	push   $0x1
    1744:	e8 57 22 00 00       	call   39a0 <printf>
    exit();
    1749:	e8 d4 20 00 00       	call   3822 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    174e:	50                   	push   %eax
    174f:	50                   	push   %eax
    1750:	68 1e 45 00 00       	push   $0x451e
    1755:	6a 01                	push   $0x1
    1757:	e8 44 22 00 00       	call   39a0 <printf>
    exit();
    175c:	e8 c1 20 00 00       	call   3822 <exit>
    printf(1, "read lf2 failed\n");
    1761:	51                   	push   %ecx
    1762:	51                   	push   %ecx
    1763:	68 0d 45 00 00       	push   $0x450d
    1768:	6a 01                	push   $0x1
    176a:	e8 31 22 00 00       	call   39a0 <printf>
    exit();
    176f:	e8 ae 20 00 00       	call   3822 <exit>
    printf(1, "open lf2 failed\n");
    1774:	53                   	push   %ebx
    1775:	53                   	push   %ebx
    1776:	68 fc 44 00 00       	push   $0x44fc
    177b:	6a 01                	push   $0x1
    177d:	e8 1e 22 00 00       	call   39a0 <printf>
    exit();
    1782:	e8 9b 20 00 00       	call   3822 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1787:	50                   	push   %eax
    1788:	50                   	push   %eax
    1789:	68 a4 50 00 00       	push   $0x50a4
    178e:	6a 01                	push   $0x1
    1790:	e8 0b 22 00 00       	call   39a0 <printf>
    exit();
    1795:	e8 88 20 00 00       	call   3822 <exit>
    printf(1, "link lf1 lf2 failed\n");
    179a:	51                   	push   %ecx
    179b:	51                   	push   %ecx
    179c:	68 e7 44 00 00       	push   $0x44e7
    17a1:	6a 01                	push   $0x1
    17a3:	e8 f8 21 00 00       	call   39a0 <printf>
    exit();
    17a8:	e8 75 20 00 00       	call   3822 <exit>
    printf(1, "write lf1 failed\n");
    17ad:	50                   	push   %eax
    17ae:	50                   	push   %eax
    17af:	68 d5 44 00 00       	push   $0x44d5
    17b4:	6a 01                	push   $0x1
    17b6:	e8 e5 21 00 00       	call   39a0 <printf>
    exit();
    ...
    17cb:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  printf(1, "concreate test\n");
    17d3:	68 65 45 00 00       	push   $0x4565
    17d8:	6a 01                	push   $0x1
    17da:	e8 c1 21 00 00       	call   39a0 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1885:	53                   	push   %ebx
    1886:	68 78 45 00 00       	push   $0x4578
    188b:	6a 01                	push   $0x1
    188d:	e8 0e 21 00 00       	call   39a0 <printf>
        exit();
    ...
    18a3:	53                   	push   %ebx
    18a4:	68 75 45 00 00       	push   $0x4575
  ...
  for(i = 0; i < 40; i++){
    18c3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18c6:	53                   	push   %ebx
    18c7:	68 75 45 00 00       	push   $0x4575
  ...
  fd = open(".", 0);
    ...
    18f3:	58                   	pop    %eax
    18f4:	6a 00                	push   $0x0
    18f6:	68 82 47 00 00       	push   $0x4782
  ...
  printf(1, "concreate ok\n");
    ...
    1a43:	68 ca 45 00 00       	push   $0x45ca
    1a48:	6a 01                	push   $0x1
    1a4a:	e8 51 1f 00 00       	call   39a0 <printf>
}
    ...
    1a5a:	68 4d 4e 00 00       	push   $0x4e4d
    1a5f:	6a 01                	push   $0x1
    1a61:	e8 3a 1f 00 00       	call   39a0 <printf>
      exit();
    1a66:	e8 b7 1d 00 00       	call   3822 <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a6b:	51                   	push   %ecx
    1a6c:	51                   	push   %ecx
    1a6d:	68 f0 50 00 00       	push   $0x50f0
    1a72:	6a 01                	push   $0x1
    1a74:	e8 27 1f 00 00       	call   39a0 <printf>
    exit();
    ...
    1a81:	53                   	push   %ebx
    1a82:	50                   	push   %eax
    1a83:	68 ad 45 00 00       	push   $0x45ad
    1a88:	6a 01                	push   $0x1
    1a8a:	e8 11 1f 00 00       	call   39a0 <printf>
        exit();
    ...
    1a97:	56                   	push   %esi
    1a98:	50                   	push   %eax
    1a99:	68 94 45 00 00       	push   $0x4594
    1a9e:	6a 01                	push   $0x1
    1aa0:	e8 fb 1e 00 00       	call   39a0 <printf>
        exit();
...
00001ac0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ac9:	68 d8 45 00 00       	push   $0x45d8
    1ace:	6a 01                	push   $0x1
    1ad0:	e8 cb 1e 00 00       	call   39a0 <printf>
  unlink("x");
    1ad5:	c7 04 24 65 48 00 00 	movl   $0x4865,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b18:	68 65 48 00 00       	push   $0x4865
  ...
  for(i = 0; i < 100; i++){
    ...
    1b4d:	68 65 48 00 00       	push   $0x4865
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b76:	68 ed 45 00 00       	push   $0x45ed
    1b7b:	6a 01                	push   $0x1
    1b7d:	e8 1e 1e 00 00       	call   39a0 <printf>
}
    ...
    1b93:	68 65 48 00 00       	push   $0x4865
    1b98:	68 e9 45 00 00       	push   $0x45e9
    ...
    1baa:	52                   	push   %edx
    1bab:	52                   	push   %edx
    1bac:	68 4d 4e 00 00       	push   $0x4e4d
    1bb1:	6a 01                	push   $0x1
    1bb3:	e8 e8 1d 00 00       	call   39a0 <printf>
    exit();
...
00001bd0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1bd9:	68 fc 45 00 00       	push   $0x45fc
    1bde:	6a 01                	push   $0x1
    1be0:	e8 bb 1d 00 00       	call   39a0 <printf>
  unlink("bd");
    1be5:	c7 04 24 09 46 00 00 	movl   $0x4609,(%esp)
    1bec:	e8 81 1c 00 00       	call   3872 <unlink>
  fd = open("bd", O_CREATE);
    1bf1:	5a                   	pop    %edx
    1bf2:	59                   	pop    %ecx
    1bf3:	68 00 02 00 00       	push   $0x200
    1bf8:	68 09 46 00 00       	push   $0x4609
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1c2c:	57                   	push   %edi
    1c2d:	68 09 46 00 00       	push   $0x4609
    name[1] = '0' + (i / 64);
  ...
  unlink("bd");
    ...
    1c63:	68 09 46 00 00       	push   $0x4609
  ...
  printf(1, "bigdir ok\n");
    ...
    1cac:	68 4b 46 00 00       	push   $0x464b
    1cb1:	6a 01                	push   $0x1
    1cb3:	e8 e8 1c 00 00       	call   39a0 <printf>
}
    ...
    1cc6:	68 22 46 00 00       	push   $0x4622
    1ccb:	6a 01                	push   $0x1
    1ccd:	e8 ce 1c 00 00       	call   39a0 <printf>
      exit();
    1cd2:	e8 4b 1b 00 00       	call   3822 <exit>
      printf(1, "bigdir unlink failed");
    1cd7:	83 ec 08             	sub    $0x8,%esp
    1cda:	68 36 46 00 00       	push   $0x4636
    1cdf:	6a 01                	push   $0x1
    1ce1:	e8 ba 1c 00 00       	call   39a0 <printf>
      exit();
    1ce6:	e8 37 1b 00 00       	call   3822 <exit>
    printf(1, "bigdir create failed\n");
    1ceb:	50                   	push   %eax
    1cec:	50                   	push   %eax
    1ced:	68 0c 46 00 00       	push   $0x460c
    1cf2:	6a 01                	push   $0x1
    1cf4:	e8 a7 1c 00 00       	call   39a0 <printf>
    exit();
...
00001d00 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1d07:	68 56 46 00 00       	push   $0x4656
    1d0c:	6a 01                	push   $0x1
    1d0e:	e8 8d 1c 00 00       	call   39a0 <printf>
  unlink("ff");
    1d13:	c7 04 24 df 46 00 00 	movl   $0x46df,(%esp)
    1d1a:	e8 53 1b 00 00       	call   3872 <unlink>
  if(mkdir("dd") != 0){
    1d1f:	c7 04 24 7c 47 00 00 	movl   $0x477c,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d3e:	68 b5 46 00 00       	push   $0x46b5
  ...
  write(fd, "ff", 2);
    ...
    1d58:	6a 02                	push   $0x2
    1d5a:	68 df 46 00 00       	push   $0x46df
    1d5f:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1d6d:	c7 04 24 7c 47 00 00 	movl   $0x477c,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d87:	68 90 46 00 00       	push   $0x4690
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1da4:	68 b2 46 00 00       	push   $0x46b2
  ...
  write(fd, "FF", 2);
    ...
    1dbe:	6a 02                	push   $0x2
    1dc0:	68 d3 46 00 00       	push   $0x46d3
    1dc5:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1dd4:	5a                   	pop    %edx
    1dd5:	6a 00                	push   $0x0
    1dd7:	68 d6 46 00 00       	push   $0x46d6
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1df6:	68 60 88 00 00       	push   $0x8860
    1dfb:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e0d:	80 3d 60 88 00 00 66 	cmpb   $0x66,0x8860
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e23:	5b                   	pop    %ebx
    1e24:	58                   	pop    %eax
    1e25:	68 16 47 00 00       	push   $0x4716
    1e2a:	68 b2 46 00 00       	push   $0x46b2
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e42:	68 b2 46 00 00       	push   $0x46b2
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e5a:	6a 00                	push   $0x0
    1e5c:	68 b2 46 00 00       	push   $0x46b2
  ...
  if(chdir("dd") != 0){
    ...
    1e74:	68 7c 47 00 00       	push   $0x477c
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1e8c:	68 4a 47 00 00       	push   $0x474a
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ea4:	68 70 47 00 00       	push   $0x4770
  ...
  if(chdir("./..") != 0){
    ...
    1ebc:	68 7f 47 00 00       	push   $0x477f
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ed4:	6a 00                	push   $0x0
    1ed6:	68 16 47 00 00       	push   $0x4716
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1ef5:	68 60 88 00 00       	push   $0x8860
    1efa:	50                   	push   %eax
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f16:	5b                   	pop    %ebx
    1f17:	6a 00                	push   $0x0
    1f19:	68 b2 46 00 00       	push   $0x46b2
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f36:	68 ca 47 00 00       	push   $0x47ca
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f53:	68 ef 47 00 00       	push   $0x47ef
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f70:	68 7c 47 00 00       	push   $0x477c
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f88:	6a 02                	push   $0x2
    1f8a:	68 7c 47 00 00       	push   $0x477c
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fa2:	6a 01                	push   $0x1
    1fa4:	68 7c 47 00 00       	push   $0x477c
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fbc:	68 5e 48 00 00       	push   $0x485e
    1fc1:	68 ca 47 00 00       	push   $0x47ca
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fd9:	68 5e 48 00 00       	push   $0x485e
    1fde:	68 ef 47 00 00       	push   $0x47ef
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1ff6:	68 16 47 00 00       	push   $0x4716
    1ffb:	68 b5 46 00 00       	push   $0x46b5
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2013:	68 ca 47 00 00       	push   $0x47ca
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    202b:	68 ef 47 00 00       	push   $0x47ef
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2043:	68 16 47 00 00       	push   $0x4716
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    205b:	68 ef 47 00 00       	push   $0x47ef
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2073:	68 ca 47 00 00       	push   $0x47ca
  ...
  if(chdir("dd/ff") == 0){
    ...
    208b:	68 b5 46 00 00       	push   $0x46b5
  ...
  if(chdir("dd/xx") == 0){
    ...
    20a3:	68 61 48 00 00       	push   $0x4861
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20bb:	68 16 47 00 00       	push   $0x4716
  ...
  if(unlink("dd/ff") != 0){
    ...
    20d3:	68 b5 46 00 00       	push   $0x46b5
  ...
  if(unlink("dd") == 0){
    ...
    20eb:	68 7c 47 00 00       	push   $0x477c
  ...
  if(unlink("dd/dd") < 0){
    ...
    2103:	68 91 46 00 00       	push   $0x4691
  ...
  if(unlink("dd") < 0){
    ...
    211b:	68 7c 47 00 00       	push   $0x477c
  ...
  printf(1, "subdir ok\n");
    ...
    2133:	68 5e 49 00 00       	push   $0x495e
    2138:	6a 01                	push   $0x1
    213a:	e8 61 18 00 00       	call   39a0 <printf>
}
    ...
    2147:	50                   	push   %eax
    2148:	50                   	push   %eax
    2149:	68 fb 46 00 00       	push   $0x46fb
    214e:	6a 01                	push   $0x1
    2150:	e8 4b 18 00 00       	call   39a0 <printf>
    exit();
    2155:	e8 c8 16 00 00       	call   3822 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    215a:	50                   	push   %eax
    215b:	50                   	push   %eax
    215c:	68 56 47 00 00       	push   $0x4756
    2161:	6a 01                	push   $0x1
    2163:	e8 38 18 00 00       	call   39a0 <printf>
    exit();
    2168:	e8 b5 16 00 00       	call   3822 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    216d:	52                   	push   %edx
    216e:	52                   	push   %edx
    216f:	68 21 47 00 00       	push   $0x4721
    2174:	6a 01                	push   $0x1
    2176:	e8 25 18 00 00       	call   39a0 <printf>
    exit();
    217b:	e8 a2 16 00 00       	call   3822 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    2180:	50                   	push   %eax
    2181:	50                   	push   %eax
    2182:	68 d3 47 00 00       	push   $0x47d3
    2187:	6a 01                	push   $0x1
    2189:	e8 12 18 00 00       	call   39a0 <printf>
    exit();
    218e:	e8 8f 16 00 00       	call   3822 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2193:	52                   	push   %edx
    2194:	52                   	push   %edx
    2195:	68 94 51 00 00       	push   $0x5194
    219a:	6a 01                	push   $0x1
    219c:	e8 ff 17 00 00       	call   39a0 <printf>
    exit();
    21a1:	e8 7c 16 00 00       	call   3822 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    21a6:	52                   	push   %edx
    21a7:	52                   	push   %edx
    21a8:	68 67 48 00 00       	push   $0x4867
    21ad:	6a 01                	push   $0x1
    21af:	e8 ec 17 00 00       	call   39a0 <printf>
    exit();
    21b4:	e8 69 16 00 00       	call   3822 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21b9:	51                   	push   %ecx
    21ba:	51                   	push   %ecx
    21bb:	68 04 52 00 00       	push   $0x5204
    21c0:	6a 01                	push   $0x1
    21c2:	e8 d9 17 00 00       	call   39a0 <printf>
    exit();
    21c7:	e8 56 16 00 00       	call   3822 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    21cc:	50                   	push   %eax
    21cd:	50                   	push   %eax
    21ce:	68 e2 46 00 00       	push   $0x46e2
    21d3:	6a 01                	push   $0x1
    21d5:	e8 c6 17 00 00       	call   39a0 <printf>
    exit();
    21da:	e8 43 16 00 00       	call   3822 <exit>
    printf(1, "create dd/dd/ff failed\n");
    21df:	51                   	push   %ecx
    21e0:	51                   	push   %ecx
    21e1:	68 bb 46 00 00       	push   $0x46bb
    21e6:	6a 01                	push   $0x1
    21e8:	e8 b3 17 00 00       	call   39a0 <printf>
    exit();
    21ed:	e8 30 16 00 00       	call   3822 <exit>
    printf(1, "chdir ./.. failed\n");
    21f2:	50                   	push   %eax
    21f3:	50                   	push   %eax
    21f4:	68 84 47 00 00       	push   $0x4784
    21f9:	6a 01                	push   $0x1
    21fb:	e8 a0 17 00 00       	call   39a0 <printf>
    exit();
    2200:	e8 1d 16 00 00       	call   3822 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2205:	51                   	push   %ecx
    2206:	51                   	push   %ecx
    2207:	68 4c 51 00 00       	push   $0x514c
    220c:	6a 01                	push   $0x1
    220e:	e8 8d 17 00 00       	call   39a0 <printf>
    exit();
    2213:	e8 0a 16 00 00       	call   3822 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2218:	53                   	push   %ebx
    2219:	53                   	push   %ebx
    221a:	68 e0 51 00 00       	push   $0x51e0
    221f:	6a 01                	push   $0x1
    2221:	e8 7a 17 00 00       	call   39a0 <printf>
    exit();
    2226:	e8 f7 15 00 00       	call   3822 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    222b:	50                   	push   %eax
    222c:	50                   	push   %eax
    222d:	68 bc 51 00 00       	push   $0x51bc
    2232:	6a 01                	push   $0x1
    2234:	e8 67 17 00 00       	call   39a0 <printf>
    exit();
    2239:	e8 e4 15 00 00       	call   3822 <exit>
    printf(1, "open dd wronly succeeded!\n");
    223e:	50                   	push   %eax
    223f:	50                   	push   %eax
    2240:	68 43 48 00 00       	push   $0x4843
    2245:	6a 01                	push   $0x1
    2247:	e8 54 17 00 00       	call   39a0 <printf>
    exit();
    224c:	e8 d1 15 00 00       	call   3822 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2251:	50                   	push   %eax
    2252:	50                   	push   %eax
    2253:	68 2a 48 00 00       	push   $0x482a
    2258:	6a 01                	push   $0x1
    225a:	e8 41 17 00 00       	call   39a0 <printf>
    exit();
    225f:	e8 be 15 00 00       	call   3822 <exit>
    printf(1, "create dd succeeded!\n");
    2264:	50                   	push   %eax
    2265:	50                   	push   %eax
    2266:	68 14 48 00 00       	push   $0x4814
    226b:	6a 01                	push   $0x1
    226d:	e8 2e 17 00 00       	call   39a0 <printf>
    exit();
    2272:	e8 ab 15 00 00       	call   3822 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2277:	50                   	push   %eax
    2278:	50                   	push   %eax
    2279:	68 f8 47 00 00       	push   $0x47f8
    227e:	6a 01                	push   $0x1
    2280:	e8 1b 17 00 00       	call   39a0 <printf>
    exit();
    2285:	e8 98 15 00 00       	call   3822 <exit>
    printf(1, "chdir dd failed\n");
    228a:	50                   	push   %eax
    228b:	50                   	push   %eax
    228c:	68 39 47 00 00       	push   $0x4739
    2291:	6a 01                	push   $0x1
    2293:	e8 08 17 00 00       	call   39a0 <printf>
    exit();
    2298:	e8 85 15 00 00       	call   3822 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    229d:	50                   	push   %eax
    229e:	50                   	push   %eax
    229f:	68 70 51 00 00       	push   $0x5170
    22a4:	6a 01                	push   $0x1
    22a6:	e8 f5 16 00 00       	call   39a0 <printf>
    exit();
    22ab:	e8 72 15 00 00       	call   3822 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    22b0:	53                   	push   %ebx
    22b1:	53                   	push   %ebx
    22b2:	68 97 46 00 00       	push   $0x4697
    22b7:	6a 01                	push   $0x1
    22b9:	e8 e2 16 00 00       	call   39a0 <printf>
    exit();
    22be:	e8 5f 15 00 00       	call   3822 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22c3:	50                   	push   %eax
    22c4:	50                   	push   %eax
    22c5:	68 24 51 00 00       	push   $0x5124
    22ca:	6a 01                	push   $0x1
    22cc:	e8 cf 16 00 00       	call   39a0 <printf>
    exit();
    22d1:	e8 4c 15 00 00       	call   3822 <exit>
    printf(1, "create dd/ff failed\n");
    22d6:	50                   	push   %eax
    22d7:	50                   	push   %eax
    22d8:	68 7b 46 00 00       	push   $0x467b
    22dd:	6a 01                	push   $0x1
    22df:	e8 bc 16 00 00       	call   39a0 <printf>
    exit();
    22e4:	e8 39 15 00 00       	call   3822 <exit>
    printf(1, "subdir mkdir dd failed\n");
    22e9:	50                   	push   %eax
    22ea:	50                   	push   %eax
    22eb:	68 63 46 00 00       	push   $0x4663
    22f0:	6a 01                	push   $0x1
    22f2:	e8 a9 16 00 00       	call   39a0 <printf>
    exit();
    22f7:	e8 26 15 00 00       	call   3822 <exit>
    printf(1, "unlink dd failed\n");
    22fc:	50                   	push   %eax
    22fd:	50                   	push   %eax
    22fe:	68 4c 49 00 00       	push   $0x494c
    2303:	6a 01                	push   $0x1
    2305:	e8 96 16 00 00       	call   39a0 <printf>
    exit();
    230a:	e8 13 15 00 00       	call   3822 <exit>
    printf(1, "unlink dd/dd failed\n");
    230f:	52                   	push   %edx
    2310:	52                   	push   %edx
    2311:	68 37 49 00 00       	push   $0x4937
    2316:	6a 01                	push   $0x1
    2318:	e8 83 16 00 00       	call   39a0 <printf>
    exit();
    231d:	e8 00 15 00 00       	call   3822 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2322:	51                   	push   %ecx
    2323:	51                   	push   %ecx
    2324:	68 28 52 00 00       	push   $0x5228
    2329:	6a 01                	push   $0x1
    232b:	e8 70 16 00 00       	call   39a0 <printf>
    exit();
    2330:	e8 ed 14 00 00       	call   3822 <exit>
    printf(1, "unlink dd/ff failed\n");
    2335:	53                   	push   %ebx
    2336:	53                   	push   %ebx
    2337:	68 22 49 00 00       	push   $0x4922
    233c:	6a 01                	push   $0x1
    233e:	e8 5d 16 00 00       	call   39a0 <printf>
    exit();
    2343:	e8 da 14 00 00       	call   3822 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2348:	50                   	push   %eax
    2349:	50                   	push   %eax
    234a:	68 0a 49 00 00       	push   $0x490a
    234f:	6a 01                	push   $0x1
    2351:	e8 4a 16 00 00       	call   39a0 <printf>
    exit();
    2356:	e8 c7 14 00 00       	call   3822 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    235b:	50                   	push   %eax
    235c:	50                   	push   %eax
    235d:	68 f2 48 00 00       	push   $0x48f2
    2362:	6a 01                	push   $0x1
    2364:	e8 37 16 00 00       	call   39a0 <printf>
    exit();
    2369:	e8 b4 14 00 00       	call   3822 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    236e:	50                   	push   %eax
    236f:	50                   	push   %eax
    2370:	68 d6 48 00 00       	push   $0x48d6
    2375:	6a 01                	push   $0x1
    2377:	e8 24 16 00 00       	call   39a0 <printf>
    exit();
    237c:	e8 a1 14 00 00       	call   3822 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2381:	50                   	push   %eax
    2382:	50                   	push   %eax
    2383:	68 ba 48 00 00       	push   $0x48ba
    2388:	6a 01                	push   $0x1
    238a:	e8 11 16 00 00       	call   39a0 <printf>
    exit();
    238f:	e8 8e 14 00 00       	call   3822 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2394:	50                   	push   %eax
    2395:	50                   	push   %eax
    2396:	68 9d 48 00 00       	push   $0x489d
    239b:	6a 01                	push   $0x1
    239d:	e8 fe 15 00 00       	call   39a0 <printf>
    exit();
    23a2:	e8 7b 14 00 00       	call   3822 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    23a7:	50                   	push   %eax
    23a8:	50                   	push   %eax
    23a9:	68 82 48 00 00       	push   $0x4882
    23ae:	6a 01                	push   $0x1
    23b0:	e8 eb 15 00 00       	call   39a0 <printf>
    exit();
    23b5:	e8 68 14 00 00       	call   3822 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    23ba:	50                   	push   %eax
    23bb:	50                   	push   %eax
    23bc:	68 af 47 00 00       	push   $0x47af
    23c1:	6a 01                	push   $0x1
    23c3:	e8 d8 15 00 00       	call   39a0 <printf>
    exit();
    23c8:	e8 55 14 00 00       	call   3822 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    23cd:	50                   	push   %eax
    23ce:	50                   	push   %eax
    23cf:	68 97 47 00 00       	push   $0x4797
    23d4:	6a 01                	push   $0x1
    23d6:	e8 c5 15 00 00       	call   39a0 <printf>
    exit();
...
000023e0 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23ed:	68 69 49 00 00       	push   $0x4969
    23f2:	6a 01                	push   $0x1
    23f4:	e8 a7 15 00 00       	call   39a0 <printf>
  unlink("bigwrite");
    23f9:	c7 04 24 78 49 00 00 	movl   $0x4978,(%esp)
    ...
    2418:	68 78 49 00 00       	push   $0x4978
    ...
    242e:	53                   	push   %ebx
    242f:	68 60 88 00 00       	push   $0x8860
    2434:	50                   	push   %eax
    ...
    2444:	53                   	push   %ebx
    2445:	68 60 88 00 00       	push   $0x8860
    244a:	56                   	push   %esi
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2466:	c7 04 24 78 49 00 00 	movl   $0x4978,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2480:	68 ab 49 00 00       	push   $0x49ab
    2485:	6a 01                	push   $0x1
    2487:	e8 14 15 00 00       	call   39a0 <printf>
}
    ...
    2496:	50                   	push   %eax
    2497:	53                   	push   %ebx
    2498:	68 99 49 00 00       	push   $0x4999
    249d:	6a 01                	push   $0x1
    249f:	e8 fc 14 00 00       	call   39a0 <printf>
        exit();
    24a4:	e8 79 13 00 00       	call   3822 <exit>
      printf(1, "cannot create bigwrite\n");
    24a9:	83 ec 08             	sub    $0x8,%esp
    24ac:	68 81 49 00 00       	push   $0x4981
    24b1:	6a 01                	push   $0x1
    24b3:	e8 e8 14 00 00       	call   39a0 <printf>
      exit();
...
000024c0 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    24c9:	68 b8 49 00 00       	push   $0x49b8
    24ce:	6a 01                	push   $0x1
    24d0:	e8 cb 14 00 00       	call   39a0 <printf>
  unlink("bigfile");
    24d5:	c7 04 24 d4 49 00 00 	movl   $0x49d4,(%esp)
    24dc:	e8 91 13 00 00       	call   3872 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24e1:	58                   	pop    %eax
    24e2:	5a                   	pop    %edx
    24e3:	68 02 02 00 00       	push   $0x202
    24e8:	68 d4 49 00 00       	push   $0x49d4
  ...
  fd = open("bigfile", 0);
    ...
    254e:	5f                   	pop    %edi
    254f:	6a 00                	push   $0x0
    2551:	68 d4 49 00 00       	push   $0x49d4
  ...
  for(i = 0; ; i++){
    ...
    257b:	0f be 05 60 88 00 00 	movsbl 0x8860,%eax
    2582:	89 fa                	mov    %edi,%edx
    2584:	d1 fa                	sar    %edx
    2586:	39 d0                	cmp    %edx,%eax
    2588:	75 6e                	jne    25f8 <bigfile+0x138>
    258a:	0f be 15 8b 89 00 00 	movsbl 0x898b,%edx
  ...
  for(i = 0; ; i++){
    ...
    25a6:	68 60 88 00 00       	push   $0x8860
    25ab:	56                   	push   %esi
  ...
  unlink("bigfile");
    ...
    25d5:	68 d4 49 00 00       	push   $0x49d4
    25da:	e8 93 12 00 00       	call   3872 <unlink>
  printf(1, "bigfile test ok\n");
    25df:	58                   	pop    %eax
    25e0:	5a                   	pop    %edx
    25e1:	68 63 4a 00 00       	push   $0x4a63
    25e6:	6a 01                	push   $0x1
    25e8:	e8 b3 13 00 00       	call   39a0 <printf>
}
    ...
    25fb:	68 30 4a 00 00       	push   $0x4a30
    2600:	6a 01                	push   $0x1
    2602:	e8 99 13 00 00       	call   39a0 <printf>
      exit();
    2607:	e8 16 12 00 00       	call   3822 <exit>
      printf(1, "short read bigfile\n");
    260c:	83 ec 08             	sub    $0x8,%esp
    260f:	68 1c 4a 00 00       	push   $0x4a1c
    2614:	6a 01                	push   $0x1
    2616:	e8 85 13 00 00       	call   39a0 <printf>
      exit();
    261b:	e8 02 12 00 00       	call   3822 <exit>
      printf(1, "read bigfile failed\n");
    2620:	83 ec 08             	sub    $0x8,%esp
    2623:	68 07 4a 00 00       	push   $0x4a07
    2628:	6a 01                	push   $0x1
    262a:	e8 71 13 00 00       	call   39a0 <printf>
      exit();
    262f:	e8 ee 11 00 00       	call   3822 <exit>
      printf(1, "write bigfile failed\n");
    2634:	83 ec 08             	sub    $0x8,%esp
    2637:	68 dc 49 00 00       	push   $0x49dc
    263c:	6a 01                	push   $0x1
    263e:	e8 5d 13 00 00       	call   39a0 <printf>
      exit();
    2643:	e8 da 11 00 00       	call   3822 <exit>
    printf(1, "cannot open bigfile\n");
    2648:	53                   	push   %ebx
    2649:	53                   	push   %ebx
    264a:	68 f2 49 00 00       	push   $0x49f2
    264f:	6a 01                	push   $0x1
    2651:	e8 4a 13 00 00       	call   39a0 <printf>
    exit();
    2656:	e8 c7 11 00 00       	call   3822 <exit>
    printf(1, "cannot create bigfile");
    265b:	50                   	push   %eax
    265c:	50                   	push   %eax
    265d:	68 c6 49 00 00       	push   $0x49c6
    2662:	6a 01                	push   $0x1
    2664:	e8 37 13 00 00       	call   39a0 <printf>
    exit();
    2669:	e8 b4 11 00 00       	call   3822 <exit>
    printf(1, "read bigfile wrong total\n");
    266e:	51                   	push   %ecx
    266f:	51                   	push   %ecx
    2670:	68 49 4a 00 00       	push   $0x4a49
    2675:	6a 01                	push   $0x1
    2677:	e8 24 13 00 00       	call   39a0 <printf>
    exit();
...
00002690 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    2696:	68 74 4a 00 00       	push   $0x4a74
    269b:	6a 01                	push   $0x1
    269d:	e8 fe 12 00 00       	call   39a0 <printf>
  if(mkdir("12345678901234") != 0){
    26a2:	c7 04 24 af 4a 00 00 	movl   $0x4aaf,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26bc:	68 48 52 00 00       	push   $0x5248
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26d9:	68 98 52 00 00       	push   $0x5298
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26f8:	5a                   	pop    %edx
    26f9:	6a 00                	push   $0x0
    26fb:	68 08 53 00 00       	push   $0x5308
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2715:	c7 04 24 a0 4a 00 00 	movl   $0x4aa0,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    272b:	68 a4 53 00 00       	push   $0x53a4
  ...
  printf(1, "fourteen ok\n");
    ...
    273f:	68 be 4a 00 00       	push   $0x4abe
    2744:	6a 01                	push   $0x1
    2746:	e8 55 12 00 00       	call   39a0 <printf>
}
    ...
    2750:	50                   	push   %eax
    2751:	50                   	push   %eax
    2752:	68 83 4a 00 00       	push   $0x4a83
    2757:	6a 01                	push   $0x1
    2759:	e8 42 12 00 00       	call   39a0 <printf>
    exit();
    275e:	e8 bf 10 00 00       	call   3822 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2763:	50                   	push   %eax
    2764:	50                   	push   %eax
    2765:	68 c4 53 00 00       	push   $0x53c4
    276a:	6a 01                	push   $0x1
    ...
    2776:	52                   	push   %edx
    2777:	52                   	push   %edx
    2778:	68 74 53 00 00       	push   $0x5374
    277d:	6a 01                	push   $0x1
    277f:	e8 1c 12 00 00       	call   39a0 <printf>
    exit();
    2784:	e8 99 10 00 00       	call   3822 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2789:	51                   	push   %ecx
    278a:	51                   	push   %ecx
    278b:	68 38 53 00 00       	push   $0x5338
    2790:	6a 01                	push   $0x1
    2792:	e8 09 12 00 00       	call   39a0 <printf>
    exit();
    2797:	e8 86 10 00 00       	call   3822 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    279c:	51                   	push   %ecx
    279d:	51                   	push   %ecx
    279e:	68 c8 52 00 00       	push   $0x52c8
    27a3:	6a 01                	push   $0x1
    27a5:	e8 f6 11 00 00       	call   39a0 <printf>
    exit();
    27aa:	e8 73 10 00 00       	call   3822 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    27af:	50                   	push   %eax
    27b0:	50                   	push   %eax
    27b1:	68 68 52 00 00       	push   $0x5268
    27b6:	6a 01                	push   $0x1
    27b8:	e8 e3 11 00 00       	call   39a0 <printf>
    exit();
...
000027d0 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    27d6:	68 cb 4a 00 00       	push   $0x4acb
    27db:	6a 01                	push   $0x1
    27dd:	e8 be 11 00 00       	call   39a0 <printf>
  if(mkdir("dots") != 0){
    27e2:	c7 04 24 d7 4a 00 00 	movl   $0x4ad7,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    27fc:	68 d7 4a 00 00       	push   $0x4ad7
  ...
  if(unlink(".") == 0){
    ...
    2814:	68 82 47 00 00       	push   $0x4782
  ...
  if(unlink("..") == 0){
    ...
    282c:	68 81 47 00 00       	push   $0x4781
  ...
  if(chdir("/") != 0){
    ...
    2844:	68 55 3f 00 00       	push   $0x3f55
  ...
  if(unlink("dots/.") == 0){
    ...
    285c:	68 1f 4b 00 00       	push   $0x4b1f
  ...
  if(unlink("dots/..") == 0){
    ...
    2870:	68 3d 4b 00 00       	push   $0x4b3d
  ...
  if(unlink("dots") != 0){
    ...
    2884:	68 d7 4a 00 00       	push   $0x4ad7
  ...
  printf(1, "rmdot ok\n");
    ...
    2898:	68 72 4b 00 00       	push   $0x4b72
    289d:	6a 01                	push   $0x1
    289f:	e8 fc 10 00 00       	call   39a0 <printf>
}
    ...
    28a9:	50                   	push   %eax
    28aa:	50                   	push   %eax
    28ab:	68 dc 4a 00 00       	push   $0x4adc
    28b0:	6a 01                	push   $0x1
    ...
    28bc:	50                   	push   %eax
    28bd:	50                   	push   %eax
    28be:	68 5d 4b 00 00       	push   $0x4b5d
    28c3:	6a 01                	push   $0x1
    28c5:	e8 d6 10 00 00       	call   39a0 <printf>
    exit();
    28ca:	e8 53 0f 00 00       	call   3822 <exit>
    printf(1, "unlink dots/.. worked!\n");
    28cf:	52                   	push   %edx
    28d0:	52                   	push   %edx
    28d1:	68 45 4b 00 00       	push   $0x4b45
    28d6:	6a 01                	push   $0x1
    28d8:	e8 c3 10 00 00       	call   39a0 <printf>
    exit();
    28dd:	e8 40 0f 00 00       	call   3822 <exit>
    printf(1, "unlink dots/. worked!\n");
    28e2:	51                   	push   %ecx
    28e3:	51                   	push   %ecx
    28e4:	68 26 4b 00 00       	push   $0x4b26
    28e9:	6a 01                	push   $0x1
    28eb:	e8 b0 10 00 00       	call   39a0 <printf>
    exit();
    28f0:	e8 2d 0f 00 00       	call   3822 <exit>
    printf(1, "chdir / failed\n");
    28f5:	50                   	push   %eax
    28f6:	50                   	push   %eax
    28f7:	68 57 3f 00 00       	push   $0x3f57
    28fc:	6a 01                	push   $0x1
    28fe:	e8 9d 10 00 00       	call   39a0 <printf>
    exit();
    2903:	e8 1a 0f 00 00       	call   3822 <exit>
    printf(1, "rm .. worked!\n");
    2908:	50                   	push   %eax
    2909:	50                   	push   %eax
    290a:	68 10 4b 00 00       	push   $0x4b10
    290f:	6a 01                	push   $0x1
    2911:	e8 8a 10 00 00       	call   39a0 <printf>
    exit();
    2916:	e8 07 0f 00 00       	call   3822 <exit>
    printf(1, "rm . worked!\n");
    291b:	50                   	push   %eax
    291c:	50                   	push   %eax
    291d:	68 02 4b 00 00       	push   $0x4b02
    2922:	6a 01                	push   $0x1
    2924:	e8 77 10 00 00       	call   39a0 <printf>
    exit();
    2929:	e8 f4 0e 00 00       	call   3822 <exit>
    printf(1, "chdir dots failed\n");
    292e:	50                   	push   %eax
    292f:	50                   	push   %eax
    2930:	68 ef 4a 00 00       	push   $0x4aef
    2935:	6a 01                	push   $0x1
    2937:	e8 64 10 00 00       	call   39a0 <printf>
    exit();
...
00002950 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2957:	68 7c 4b 00 00       	push   $0x4b7c
    295c:	6a 01                	push   $0x1
    295e:	e8 3d 10 00 00       	call   39a0 <printf>
  fd = open("dirfile", O_CREATE);
    2963:	59                   	pop    %ecx
    2964:	5b                   	pop    %ebx
    2965:	68 00 02 00 00       	push   $0x200
    296a:	68 89 4b 00 00       	push   $0x4b89
  ...
  if(chdir("dirfile") == 0){
    2988:	c7 04 24 89 4b 00 00 	movl   $0x4b89,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    29a2:	6a 00                	push   $0x0
    29a4:	68 c2 4b 00 00       	push   $0x4bc2
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29c1:	68 c2 4b 00 00       	push   $0x4bc2
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29d9:	68 c2 4b 00 00       	push   $0x4bc2
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    29f1:	68 c2 4b 00 00       	push   $0x4bc2
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a09:	68 c2 4b 00 00       	push   $0x4bc2
    2a0e:	68 26 4c 00 00       	push   $0x4c26
  ...
  if(unlink("dirfile") != 0){
    ...
    2a26:	68 89 4b 00 00       	push   $0x4b89
  ...
  fd = open(".", O_RDWR);
    ...
    2a3e:	6a 02                	push   $0x2
    2a40:	68 82 47 00 00       	push   $0x4782
  ...
  fd = open(".", 0);
    ...
    2a58:	6a 00                	push   $0x0
    2a5a:	68 82 47 00 00       	push   $0x4782
  ...
  if(write(fd, "x", 1) > 0){
    2a69:	6a 01                	push   $0x1
    2a6b:	68 65 48 00 00       	push   $0x4865
    2a70:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2a86:	58                   	pop    %eax
    2a87:	5a                   	pop    %edx
    2a88:	68 59 4c 00 00       	push   $0x4c59
    2a8d:	6a 01                	push   $0x1
    2a8f:	e8 0c 0f 00 00       	call   39a0 <printf>
}
    ...
    2a9c:	50                   	push   %eax
    2a9d:	50                   	push   %eax
    2a9e:	68 cd 4b 00 00       	push   $0x4bcd
    2aa3:	6a 01                	push   $0x1
    2aa5:	e8 f6 0e 00 00       	call   39a0 <printf>
    exit();
    2aaa:	e8 73 0d 00 00       	call   3822 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2aaf:	50                   	push   %eax
    2ab0:	50                   	push   %eax
    2ab1:	68 a8 4b 00 00       	push   $0x4ba8
    2ab6:	6a 01                	push   $0x1
    2ab8:	e8 e3 0e 00 00       	call   39a0 <printf>
    exit();
    2abd:	e8 60 0d 00 00       	call   3822 <exit>
    printf(1, "create dirfile failed\n");
    2ac2:	52                   	push   %edx
    2ac3:	52                   	push   %edx
    2ac4:	68 91 4b 00 00       	push   $0x4b91
    2ac9:	6a 01                	push   $0x1
    2acb:	e8 d0 0e 00 00       	call   39a0 <printf>
    exit();
    2ad0:	e8 4d 0d 00 00       	call   3822 <exit>
    printf(1, "write . succeeded!\n");
    2ad5:	51                   	push   %ecx
    2ad6:	51                   	push   %ecx
    2ad7:	68 45 4c 00 00       	push   $0x4c45
    2adc:	6a 01                	push   $0x1
    2ade:	e8 bd 0e 00 00       	call   39a0 <printf>
    exit();
    2ae3:	e8 3a 0d 00 00       	call   3822 <exit>
    printf(1, "open . for writing succeeded!\n");
    2ae8:	53                   	push   %ebx
    2ae9:	53                   	push   %ebx
    2aea:	68 18 54 00 00       	push   $0x5418
    2aef:	6a 01                	push   $0x1
    2af1:	e8 aa 0e 00 00       	call   39a0 <printf>
    exit();
    2af6:	e8 27 0d 00 00       	call   3822 <exit>
    printf(1, "unlink dirfile failed!\n");
    2afb:	50                   	push   %eax
    2afc:	50                   	push   %eax
    2afd:	68 2d 4c 00 00       	push   $0x4c2d
    2b02:	6a 01                	push   $0x1
    2b04:	e8 97 0e 00 00       	call   39a0 <printf>
    exit();
    2b09:	e8 14 0d 00 00       	call   3822 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b0e:	50                   	push   %eax
    2b0f:	50                   	push   %eax
    2b10:	68 f8 53 00 00       	push   $0x53f8
    2b15:	6a 01                	push   $0x1
    2b17:	e8 84 0e 00 00       	call   39a0 <printf>
    exit();
    2b1c:	e8 01 0d 00 00       	call   3822 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2b21:	50                   	push   %eax
    2b22:	50                   	push   %eax
    2b23:	68 08 4c 00 00       	push   $0x4c08
    2b28:	6a 01                	push   $0x1
    2b2a:	e8 71 0e 00 00       	call   39a0 <printf>
    exit();
    2b2f:	e8 ee 0c 00 00       	call   3822 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2b34:	50                   	push   %eax
    2b35:	50                   	push   %eax
    2b36:	68 eb 4b 00 00       	push   $0x4beb
    2b3b:	6a 01                	push   $0x1
    2b3d:	e8 5e 0e 00 00       	call   39a0 <printf>
    exit();
    ...
    2b54:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2b5c:	68 69 4c 00 00       	push   $0x4c69
    2b61:	6a 01                	push   $0x1
    2b63:	e8 38 0e 00 00       	call   39a0 <printf>
    2b68:	83 c4 10             	add    $0x10,%esp
    2b6b:	90                   	nop
    2b6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(mkdir("irefd") != 0){
    2b70:	83 ec 0c             	sub    $0xc,%esp
    2b73:	68 7a 4c 00 00       	push   $0x4c7a
    ...
    2b8b:	68 7a 4c 00 00       	push   $0x4c7a
    ...
    2ba3:	68 2f 43 00 00       	push   $0x432f
    2ba8:	e8 dd 0c 00 00       	call   388a <mkdir>
    link("README", "");
    2bad:	59                   	pop    %ecx
    2bae:	58                   	pop    %eax
    2baf:	68 2f 43 00 00       	push   $0x432f
    2bb4:	68 26 4c 00 00       	push   $0x4c26
    2bb9:	e8 c4 0c 00 00       	call   3882 <link>
    fd = open("", O_CREATE);
    2bbe:	58                   	pop    %eax
    2bbf:	5a                   	pop    %edx
    2bc0:	68 00 02 00 00       	push   $0x200
    2bc5:	68 2f 43 00 00       	push   $0x432f
    ...
    2bea:	68 64 48 00 00       	push   $0x4864
    ...
    2c0a:	68 64 48 00 00       	push   $0x4864
  ...
  chdir("/");
    ...
    2c23:	68 55 3f 00 00       	push   $0x3f55
    2c28:	e8 65 0c 00 00       	call   3892 <chdir>
  printf(1, "empty file name OK\n");
    2c2d:	58                   	pop    %eax
    2c2e:	5a                   	pop    %edx
    2c2f:	68 a8 4c 00 00       	push   $0x4ca8
    2c34:	6a 01                	push   $0x1
    2c36:	e8 65 0d 00 00       	call   39a0 <printf>
}
    ...
    2c46:	68 80 4c 00 00       	push   $0x4c80
    2c4b:	6a 01                	push   $0x1
    2c4d:	e8 4e 0d 00 00       	call   39a0 <printf>
      exit();
    2c52:	e8 cb 0b 00 00       	call   3822 <exit>
      printf(1, "chdir irefd failed\n");
    2c57:	83 ec 08             	sub    $0x8,%esp
    2c5a:	68 94 4c 00 00       	push   $0x4c94
    2c5f:	6a 01                	push   $0x1
    2c61:	e8 3a 0d 00 00       	call   39a0 <printf>
      exit();
    ...
    2c74:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2c79:	68 bc 4c 00 00       	push   $0x4cbc
    2c7e:	6a 01                	push   $0x1
    2c80:	e8 1b 0d 00 00       	call   39a0 <printf>
  ...
  printf(1, "fork test OK\n");
    ...
    2ccb:	68 ee 4c 00 00       	push   $0x4cee
    2cd0:	6a 01                	push   $0x1
    2cd2:	e8 c9 0c 00 00       	call   39a0 <printf>
}
    ...
    2ce3:	68 38 54 00 00       	push   $0x5438
    2ce8:	6a 01                	push   $0x1
    2cea:	e8 b1 0c 00 00       	call   39a0 <printf>
    exit();
    ...
    2cfc:	68 c7 4c 00 00       	push   $0x4cc7
    2d01:	6a 01                	push   $0x1
    2d03:	e8 98 0c 00 00       	call   39a0 <printf>
      exit();
    2d08:	e8 15 0b 00 00       	call   3822 <exit>
    printf(1, "wait got too many\n");
    2d0d:	50                   	push   %eax
    2d0e:	50                   	push   %eax
    2d0f:	68 db 4c 00 00       	push   $0x4cdb
    2d14:	6a 01                	push   $0x1
    2d16:	e8 85 0c 00 00       	call   39a0 <printf>
    exit();
    ...
    2d26:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    2d2b:	68 fc 4c 00 00       	push   $0x4cfc
    2d30:	ff 35 68 60 00 00    	pushl  0x6068
    2d36:	e8 65 0c 00 00       	call   39a0 <printf>
  oldbrk = sbrk(0);
    2d3b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2d42:	e8 6b 0b 00 00       	call   38b2 <sbrk>
  a = sbrk(0);
    2d47:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2d4e:	89 c3                	mov    %eax,%ebx
  a = sbrk(0);
    2d50:	e8 5d 0b 00 00       	call   38b2 <sbrk>
    ...
    2d65:	6a 01                	push   $0x1
    2d67:	e8 46 0b 00 00       	call   38b2 <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    2d9d:	6a 01                	push   $0x1
    2d9f:	e8 0e 0b 00 00       	call   38b2 <sbrk>
  c = sbrk(1);
    2da4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dab:	e8 02 0b 00 00       	call   38b2 <sbrk>
  if(c != a + 1){
  ...
  a = sbrk(0);
    ...
    2dcb:	6a 00                	push   $0x0
    2dcd:	e8 e0 0a 00 00       	call   38b2 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dde:	e8 cf 0a 00 00       	call   38b2 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2df8:	6a 00                	push   $0x0
    2dfa:	e8 b3 0a 00 00       	call   38b2 <sbrk>
  c = sbrk(-4096);
    2dff:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e06:	89 c6                	mov    %eax,%esi
  c = sbrk(-4096);
    2e08:	e8 a5 0a 00 00       	call   38b2 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e1c:	6a 00                	push   $0x0
    2e1e:	e8 8f 0a 00 00       	call   38b2 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e37:	6a 00                	push   $0x0
    2e39:	e8 74 0a 00 00       	call   38b2 <sbrk>
    2e3e:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    2e40:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2e47:	e8 66 0a 00 00       	call   38b2 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e5c:	6a 00                	push   $0x0
    2e5e:	e8 4f 0a 00 00       	call   38b2 <sbrk>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fad:	6a 00                	push   $0x0
    2faf:	e8 fe 08 00 00       	call   38b2 <sbrk>
    2fb4:	83 c4 10             	add    $0x10,%esp
    2fb7:	39 d8                	cmp    %ebx,%eax
    2fb9:	77 3c                	ja     2ff7 <sbrktest+0x2d7>
  printf(stdout, "sbrk test OK\n");
    2fbb:	83 ec 08             	sub    $0x8,%esp
    2fbe:	68 a4 4d 00 00       	push   $0x4da4
    2fc3:	ff 35 68 60 00 00    	pushl  0x6068
    2fc9:	e8 d2 09 00 00       	call   39a0 <printf>
}
    ...
    2fdd:	56                   	push   %esi
    2fde:	57                   	push   %edi
    2fdf:	68 07 4d 00 00       	push   $0x4d07
    2fe4:	ff 35 68 60 00 00    	pushl  0x6068
    2fea:	e8 b1 09 00 00       	call   39a0 <printf>
      exit();
    ...
    2ffa:	6a 00                	push   $0x0
    2ffc:	e8 b1 08 00 00       	call   38b2 <sbrk>
    3001:	29 c3                	sub    %eax,%ebx
    3003:	89 1c 24             	mov    %ebx,(%esp)
    3006:	e8 a7 08 00 00       	call   38b2 <sbrk>
    300b:	83 c4 10             	add    $0x10,%esp
    300e:	eb ab                	jmp    2fbb <sbrktest+0x29b>
    printf(stdout, "failed sbrk leaked memory\n");
    3010:	50                   	push   %eax
    3011:	50                   	push   %eax
    3012:	68 89 4d 00 00       	push   $0x4d89
    3017:	ff 35 68 60 00 00    	pushl  0x6068
    301d:	e8 7e 09 00 00       	call   39a0 <printf>
    exit();
    3022:	e8 fb 07 00 00       	call   3822 <exit>
    printf(1, "pipe() failed\n");
    3027:	52                   	push   %edx
    3028:	52                   	push   %edx
    3029:	68 45 42 00 00       	push   $0x4245
    302e:	6a 01                	push   $0x1
    3030:	e8 6b 09 00 00       	call   39a0 <printf>
    exit();
    ...
    303d:	50                   	push   %eax
    303e:	56                   	push   %esi
    303f:	68 70 4d 00 00       	push   $0x4d70
    3044:	ff 35 68 60 00 00    	pushl  0x6068
    304a:	e8 51 09 00 00       	call   39a0 <printf>
      kill(ppid);
    ...
    305c:	51                   	push   %ecx
    305d:	51                   	push   %ecx
    305e:	68 4d 4e 00 00       	push   $0x4e4d
    3063:	ff 35 68 60 00 00    	pushl  0x6068
    3069:	e8 32 09 00 00       	call   39a0 <printf>
      exit();
    306e:	e8 af 07 00 00       	call   3822 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    3073:	50                   	push   %eax
    3074:	56                   	push   %esi
    3075:	68 2c 55 00 00       	push   $0x552c
    307a:	ff 35 68 60 00 00    	pushl  0x6068
    3080:	e8 1b 09 00 00       	call   39a0 <printf>
    exit();
    3085:	e8 98 07 00 00       	call   3822 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    308a:	53                   	push   %ebx
    308b:	53                   	push   %ebx
    308c:	68 fc 54 00 00       	push   $0x54fc
    3091:	ff 35 68 60 00 00    	pushl  0x6068
    3097:	e8 04 09 00 00       	call   39a0 <printf>
    exit();
    309c:	e8 81 07 00 00       	call   3822 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    30a1:	57                   	push   %edi
    30a2:	56                   	push   %esi
    30a3:	68 d4 54 00 00       	push   $0x54d4
    30a8:	ff 35 68 60 00 00    	pushl  0x6068
    30ae:	e8 ed 08 00 00       	call   39a0 <printf>
    exit();
    30b3:	e8 6a 07 00 00       	call   3822 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    30b8:	50                   	push   %eax
    30b9:	56                   	push   %esi
    30ba:	68 9c 54 00 00       	push   $0x549c
    30bf:	ff 35 68 60 00 00    	pushl  0x6068
    30c5:	e8 d6 08 00 00       	call   39a0 <printf>
    exit();
    30ca:	e8 53 07 00 00       	call   3822 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    30cf:	56                   	push   %esi
    30d0:	56                   	push   %esi
    30d1:	68 55 4d 00 00       	push   $0x4d55
    30d6:	ff 35 68 60 00 00    	pushl  0x6068
    ...
    30e6:	57                   	push   %edi
    30e7:	57                   	push   %edi
    30e8:	68 5c 54 00 00       	push   $0x545c
    30ed:	ff 35 68 60 00 00    	pushl  0x6068
    30f3:	e8 a8 08 00 00       	call   39a0 <printf>
    exit();
    ...
    3102:	50                   	push   %eax
    3103:	50                   	push   %eax
    3104:	68 39 4d 00 00       	push   $0x4d39
    3109:	ff 35 68 60 00 00    	pushl  0x6068
    310f:	e8 8c 08 00 00       	call   39a0 <printf>
    exit();
    3114:	e8 09 07 00 00       	call   3822 <exit>
    printf(stdout, "sbrk test fork failed\n");
    3119:	50                   	push   %eax
    311a:	50                   	push   %eax
    311b:	68 22 4d 00 00       	push   $0x4d22
    3120:	ff 35 68 60 00 00    	pushl  0x6068
    3126:	e8 75 08 00 00       	call   39a0 <printf>
    exit();
...
00003140 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    314a:	68 b2 4d 00 00       	push   $0x4db2
    314f:	ff 35 68 60 00 00    	pushl  0x6068
    3155:	e8 46 08 00 00       	call   39a0 <printf>
    ...
    316e:	6a 00                	push   $0x0
    3170:	e8 45 07 00 00       	call   38ba <sleep>
    sleep(0);
    3175:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    317c:	e8 39 07 00 00       	call   38ba <sleep>
    kill(pid);
    ...
    318f:	5a                   	pop    %edx
    3190:	53                   	push   %ebx
    3191:	68 c1 4d 00 00       	push   $0x4dc1
  ...
  printf(stdout, "validate ok\n");
    ...
    31b4:	68 e5 4d 00 00       	push   $0x4de5
    31b9:	ff 35 68 60 00 00    	pushl  0x6068
    31bf:	e8 dc 07 00 00       	call   39a0 <printf>
}
    ...
    31d6:	68 cc 4d 00 00       	push   $0x4dcc
    31db:	ff 35 68 60 00 00    	pushl  0x6068
    31e1:	e8 ba 07 00 00       	call   39a0 <printf>
      exit();
...
000031f0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    31f6:	68 f2 4d 00 00       	push   $0x4df2
    31fb:	ff 35 68 60 00 00    	pushl  0x6068
    3201:	e8 9a 07 00 00       	call   39a0 <printf>
    if(uninit[i] != '\0'){
    3206:	83 c4 10             	add    $0x10,%esp
    3209:	80 3d 40 61 00 00 00 	cmpb   $0x0,0x6140
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    3220:	80 b8 40 61 00 00 00 	cmpb   $0x0,0x6140(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    3236:	68 0d 4e 00 00       	push   $0x4e0d
    323b:	ff 35 68 60 00 00    	pushl  0x6068
    3241:	e8 5a 07 00 00       	call   39a0 <printf>
}
    ...
    324e:	68 fc 4d 00 00       	push   $0x4dfc
    3253:	ff 35 68 60 00 00    	pushl  0x6068
    3259:	e8 42 07 00 00       	call   39a0 <printf>
      exit();
...
00003270 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    3276:	68 1a 4e 00 00       	push   $0x4e1a
  ...
  fd = open("bigarg-ok", 0);
    ...
    329a:	6a 00                	push   $0x0
    329c:	68 1a 4e 00 00       	push   $0x4e1a
  ...
  unlink("bigarg-ok");
    32ba:	c7 04 24 1a 4e 00 00 	movl   $0x4e1a,(%esp)
    32c1:	e8 ac 05 00 00       	call   3872 <unlink>
}
    32c6:	83 c4 10             	add    $0x10,%esp
    32c9:	c9                   	leave  
    32ca:	c3                   	ret    
    32cb:	b8 a0 60 00 00       	mov    $0x60a0,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    32d0:	c7 00 50 55 00 00    	movl   $0x5550,(%eax)
    32d6:	83 c0 04             	add    $0x4,%eax
    for(i = 0; i < MAXARG-1; i++)
    32d9:	3d 1c 61 00 00       	cmp    $0x611c,%eax
    32de:	75 f0                	jne    32d0 <bigargtest+0x60>
    printf(stdout, "bigarg test\n");
    32e0:	51                   	push   %ecx
    32e1:	51                   	push   %ecx
    32e2:	68 24 4e 00 00       	push   $0x4e24
    32e7:	ff 35 68 60 00 00    	pushl  0x6068
    args[MAXARG-1] = 0;
    32ed:	c7 05 1c 61 00 00 00 	movl   $0x0,0x611c
    32f4:	00 00 00 
    printf(stdout, "bigarg test\n");
    32f7:	e8 a4 06 00 00       	call   39a0 <printf>
    exec("echo", args);
    32fc:	58                   	pop    %eax
    32fd:	5a                   	pop    %edx
    32fe:	68 a0 60 00 00       	push   $0x60a0
    3303:	68 f1 3f 00 00       	push   $0x3ff1
    3308:	e8 4d 05 00 00       	call   385a <exec>
    printf(stdout, "bigarg test ok\n");
    330d:	59                   	pop    %ecx
    330e:	58                   	pop    %eax
    330f:	68 31 4e 00 00       	push   $0x4e31
    3314:	ff 35 68 60 00 00    	pushl  0x6068
    331a:	e8 81 06 00 00       	call   39a0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    331f:	58                   	pop    %eax
    3320:	5a                   	pop    %edx
    3321:	68 00 02 00 00       	push   $0x200
    3326:	68 1a 4e 00 00       	push   $0x4e1a
    ...
    333d:	50                   	push   %eax
    333e:	50                   	push   %eax
    333f:	68 5a 4e 00 00       	push   $0x4e5a
    3344:	ff 35 68 60 00 00    	pushl  0x6068
    334a:	e8 51 06 00 00       	call   39a0 <printf>
    exit();
    334f:	e8 ce 04 00 00       	call   3822 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3354:	52                   	push   %edx
    3355:	52                   	push   %edx
    3356:	68 41 4e 00 00       	push   $0x4e41
    335b:	ff 35 68 60 00 00    	pushl  0x6068
    3361:	e8 3a 06 00 00       	call   39a0 <printf>
    exit();
    ...
    3376:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    337b:	68 6f 4e 00 00       	push   $0x4e6f
    3380:	6a 01                	push   $0x1
    3382:	e8 19 06 00 00       	call   39a0 <printf>
    ...
    3403:	50                   	push   %eax
    3404:	68 7c 4e 00 00       	push   $0x4e7c
    3409:	6a 01                	push   $0x1
    340b:	e8 90 05 00 00       	call   39a0 <printf>
    ...
    343a:	68 60 88 00 00       	push   $0x8860
    343f:	57                   	push   %edi
    ...
    3452:	56                   	push   %esi
    3453:	68 98 4e 00 00       	push   $0x4e98
    3458:	6a 01                	push   $0x1
    345a:	e8 41 05 00 00       	call   39a0 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3486:	50                   	push   %eax
    3487:	68 88 4e 00 00       	push   $0x4e88
    348c:	6a 01                	push   $0x1
    348e:	e8 0d 05 00 00       	call   39a0 <printf>
      break;
  ...
  printf(1, "fsfull test finished\n");
    ...
    351a:	68 a8 4e 00 00       	push   $0x4ea8
    351f:	6a 01                	push   $0x1
    3521:	e8 7a 04 00 00       	call   39a0 <printf>
}
...
00003540 <uio>:
{
  ...
  printf(1, "uio test\n");
    3546:	68 be 4e 00 00       	push   $0x4ebe
    354b:	6a 01                	push   $0x1
    354d:	e8 4e 04 00 00       	call   39a0 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    3568:	68 c8 4e 00 00       	push   $0x4ec8
    356d:	6a 01                	push   $0x1
    356f:	e8 2c 04 00 00       	call   39a0 <printf>
}
    ...
    358a:	52                   	push   %edx
    358b:	52                   	push   %edx
    358c:	68 30 56 00 00       	push   $0x5630
    3591:	6a 01                	push   $0x1
    3593:	e8 08 04 00 00       	call   39a0 <printf>
    exit();
    3598:	e8 85 02 00 00       	call   3822 <exit>
    printf (1, "fork failed\n");
    359d:	50                   	push   %eax
    359e:	50                   	push   %eax
    359f:	68 4d 4e 00 00       	push   $0x4e4d
    35a4:	6a 01                	push   $0x1
    35a6:	e8 f5 03 00 00       	call   39a0 <printf>
    exit();
    35ab:	e8 72 02 00 00       	call   3822 <exit>

000035b0 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    35b0:	69 05 64 60 00 00 0d 	imul   $0x19660d,0x6064,%eax
    35b7:	66 19 00 
{
    35ba:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    35c3:	a3 64 60 00 00       	mov    %eax,0x6064
}
    35c8:	c3                   	ret    
...
000038aa <getcpuid>:
SYSCALL(getcpuid)
    38aa:	b8 16 00 00 00       	mov    $0x16,%eax
    38af:	cd 40                	int    $0x40
    38b1:	c3                   	ret    

000038b2 <sbrk>:
SYSCALL(sbrk)
    38b2:	b8 0c 00 00 00       	mov    $0xc,%eax
    38b7:	cd 40                	int    $0x40
    38b9:	c3                   	ret    

000038ba <sleep>:
SYSCALL(sleep)
    38ba:	b8 0d 00 00 00       	mov    $0xd,%eax
    38bf:	cd 40                	int    $0x40
    38c1:	c3                   	ret    

000038c2 <uptime>:
SYSCALL(uptime)
    38c2:	b8 0e 00 00 00       	mov    $0xe,%eax
    38c7:	cd 40                	int    $0x40
    38c9:	c3                   	ret    
...
000038ea <cps>:
SYSCALL(cps);
    38ea:	b8 1c 00 00 00       	mov    $0x1c,%eax
    38ef:	cd 40                	int    $0x40
    38f1:	c3                   	ret    

000038f2 <chpri>:
SYSCALL(chpri);
    38f2:	b8 1b 00 00 00       	mov    $0x1b,%eax
    38f7:	cd 40                	int    $0x40
    38f9:	c3                   	ret    
    38fa:	66 90                	xchg   %ax,%ax
    38fc:	66 90                	xchg   %ax,%ax
...
{
    390b:	89 45 c0             	mov    %eax,-0x40(%ebp)
    neg = 1;
    x = -xx;
    390e:	89 d0                	mov    %edx,%eax
  if(sgn && xx < 0){
    3910:	79 76                	jns    3988 <printint+0x88>
    3912:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    3916:	74 70                	je     3988 <printint+0x88>
    x = -xx;
    3918:	f7 d8                	neg    %eax
    neg = 1;
    391a:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    3921:	31 f6                	xor    %esi,%esi
    3923:	8d 5d d7             	lea    -0x29(%ebp),%ebx
    3926:	eb 0a                	jmp    3932 <printint+0x32>
    3928:	90                   	nop
    3929:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  do{
    buf[i++] = digits[x % base];
    3930:	89 fe                	mov    %edi,%esi
    3932:	31 d2                	xor    %edx,%edx
    3934:	8d 7e 01             	lea    0x1(%esi),%edi
    3937:	f7 f1                	div    %ecx
    3939:	0f b6 92 88 56 00 00 	movzbl 0x5688(%edx),%edx
  }while((x /= base) != 0);
    3940:	85 c0                	test   %eax,%eax
    buf[i++] = digits[x % base];
    3942:	88 14 3b             	mov    %dl,(%ebx,%edi,1)
  }while((x /= base) != 0);
    3945:	75 e9                	jne    3930 <printint+0x30>
  if(neg)
    3947:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    394a:	85 c0                	test   %eax,%eax
    394c:	74 08                	je     3956 <printint+0x56>
    buf[i++] = '-';
    394e:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
    3953:	8d 7e 02             	lea    0x2(%esi),%edi
    3956:	8d 74 3d d7          	lea    -0x29(%ebp,%edi,1),%esi
    395a:	8b 7d c0             	mov    -0x40(%ebp),%edi
    395d:	8d 76 00             	lea    0x0(%esi),%esi
    3960:	0f b6 06             	movzbl (%esi),%eax
  write(fd, &c, 1);
    3963:	83 ec 04             	sub    $0x4,%esp
    3966:	83 ee 01             	sub    $0x1,%esi
    3969:	6a 01                	push   $0x1
    396b:	53                   	push   %ebx
    396c:	57                   	push   %edi
    396d:	88 45 d7             	mov    %al,-0x29(%ebp)
    3970:	e8 cd fe ff ff       	call   3842 <write>

  while(--i >= 0)
    3975:	83 c4 10             	add    $0x10,%esp
    3978:	39 de                	cmp    %ebx,%esi
    397a:	75 e4                	jne    3960 <printint+0x60>
    putc(fd, buf[i]);
}
    397c:	8d 65 f4             	lea    -0xc(%ebp),%esp
    397f:	5b                   	pop    %ebx
    3980:	5e                   	pop    %esi
    3981:	5f                   	pop    %edi
    3982:	5d                   	pop    %ebp
  ...
  neg = 0;
    3988:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
    398f:	eb 90                	jmp    3921 <printint+0x21>
    3991:	eb 0d                	jmp    39a0 <printf>
    3993:	90                   	nop
    3994:	90                   	nop
    3995:	90                   	nop
    3996:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    39a9:	8b 75 0c             	mov    0xc(%ebp),%esi
    39ac:	0f b6 1e             	movzbl (%esi),%ebx
    39af:	84 db                	test   %bl,%bl
    39b1:	0f 84 b3 00 00 00    	je     3a6a <printf+0xca>
  ap = (uint*)(void*)&fmt + 1;
    39b7:	8d 45 10             	lea    0x10(%ebp),%eax
    39ba:	83 c6 01             	add    $0x1,%esi
  state = 0;
    39bd:	31 ff                	xor    %edi,%edi
  ap = (uint*)(void*)&fmt + 1;
    39bf:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    39c2:	eb 2f                	jmp    39f3 <printf+0x53>
    39c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    39c8:	83 f8 25             	cmp    $0x25,%eax
    39cb:	0f 84 a7 00 00 00    	je     3a78 <printf+0xd8>
  write(fd, &c, 1);
    39d1:	8d 45 e2             	lea    -0x1e(%ebp),%eax
    39d4:	83 ec 04             	sub    $0x4,%esp
    39d7:	88 5d e2             	mov    %bl,-0x1e(%ebp)
    39da:	6a 01                	push   $0x1
    39dc:	50                   	push   %eax
    39dd:	ff 75 08             	pushl  0x8(%ebp)
    39e0:	e8 5d fe ff ff       	call   3842 <write>
    39e5:	83 c4 10             	add    $0x10,%esp
    39e8:	83 c6 01             	add    $0x1,%esi
  for(i = 0; fmt[i]; i++){
    39eb:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
    39ef:	84 db                	test   %bl,%bl
    39f1:	74 77                	je     3a6a <printf+0xca>
    if(state == 0){
    39f3:	85 ff                	test   %edi,%edi
    c = fmt[i] & 0xff;
    39f5:	0f be cb             	movsbl %bl,%ecx
    39f8:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    39fb:	74 cb                	je     39c8 <printf+0x28>
        state = '%';
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
    39fd:	83 ff 25             	cmp    $0x25,%edi
    3a00:	75 e6                	jne    39e8 <printf+0x48>
      if(c == 'd'){
    3a02:	83 f8 64             	cmp    $0x64,%eax
    3a05:	0f 84 05 01 00 00    	je     3b10 <printf+0x170>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    3a0b:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    3a11:	83 f9 70             	cmp    $0x70,%ecx
    3a14:	74 72                	je     3a88 <printf+0xe8>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    3a16:	83 f8 73             	cmp    $0x73,%eax
    3a19:	0f 84 99 00 00 00    	je     3ab8 <printf+0x118>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    3a1f:	83 f8 63             	cmp    $0x63,%eax
    3a22:	0f 84 08 01 00 00    	je     3b30 <printf+0x190>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    3a28:	83 f8 25             	cmp    $0x25,%eax
    3a2b:	0f 84 ef 00 00 00    	je     3b20 <printf+0x180>
  write(fd, &c, 1);
    3a31:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3a34:	83 ec 04             	sub    $0x4,%esp
    3a37:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3a3b:	6a 01                	push   $0x1
    3a3d:	50                   	push   %eax
    3a3e:	ff 75 08             	pushl  0x8(%ebp)
    3a41:	e8 fc fd ff ff       	call   3842 <write>
    3a46:	83 c4 0c             	add    $0xc,%esp
    3a49:	8d 45 e6             	lea    -0x1a(%ebp),%eax
    3a4c:	88 5d e6             	mov    %bl,-0x1a(%ebp)
    3a4f:	6a 01                	push   $0x1
    3a51:	50                   	push   %eax
    3a52:	ff 75 08             	pushl  0x8(%ebp)
    3a55:	83 c6 01             	add    $0x1,%esi
      ...
      state = 0;
    3a58:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
    3a5a:	e8 e3 fd ff ff       	call   3842 <write>
  for(i = 0; fmt[i]; i++){
    3a5f:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
  write(fd, &c, 1);
    3a63:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    3a66:	84 db                	test   %bl,%bl
    3a68:	75 89                	jne    39f3 <printf+0x53>
    }
  }
}
    3a6a:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3a6d:	5b                   	pop    %ebx
    3a6e:	5e                   	pop    %esi
    3a6f:	5f                   	pop    %edi
    3a70:	5d                   	pop    %ebp
    ...
    3a72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        state = '%';
    3a78:	bf 25 00 00 00       	mov    $0x25,%edi
    3a7d:	e9 66 ff ff ff       	jmp    39e8 <printf+0x48>
    3a82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    3a88:	83 ec 0c             	sub    $0xc,%esp
    3a8b:	b9 10 00 00 00       	mov    $0x10,%ecx
    3a90:	6a 00                	push   $0x0
    3a92:	8b 7d d4             	mov    -0x2c(%ebp),%edi
    3a95:	8b 45 08             	mov    0x8(%ebp),%eax
    3a98:	8b 17                	mov    (%edi),%edx
    3a9a:	e8 61 fe ff ff       	call   3900 <printint>
        ap++;
    3a9f:	89 f8                	mov    %edi,%eax
    3aa1:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3aa4:	31 ff                	xor    %edi,%edi
        ap++;
    3aa6:	83 c0 04             	add    $0x4,%eax
    3aa9:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    3aac:	e9 37 ff ff ff       	jmp    39e8 <printf+0x48>
    3ab1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    3ab8:	8b 45 d4             	mov    -0x2c(%ebp),%eax
    3abb:	8b 08                	mov    (%eax),%ecx
        ap++;
    3abd:	83 c0 04             	add    $0x4,%eax
    3ac0:	89 45 d4             	mov    %eax,-0x2c(%ebp)
        if(s == 0)
    3ac3:	85 c9                	test   %ecx,%ecx
    3ac5:	0f 84 8e 00 00 00    	je     3b59 <printf+0x1b9>
        while(*s != 0){
    3acb:	0f b6 01             	movzbl (%ecx),%eax
      state = 0;
    3ace:	31 ff                	xor    %edi,%edi
        s = (char*)*ap;
    3ad0:	89 cb                	mov    %ecx,%ebx
        while(*s != 0){
    3ad2:	84 c0                	test   %al,%al
    3ad4:	0f 84 0e ff ff ff    	je     39e8 <printf+0x48>
    3ada:	89 75 d0             	mov    %esi,-0x30(%ebp)
    3add:	89 de                	mov    %ebx,%esi
    3adf:	8b 5d 08             	mov    0x8(%ebp),%ebx
    3ae2:	8d 7d e3             	lea    -0x1d(%ebp),%edi
    3ae5:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    3ae8:	83 ec 04             	sub    $0x4,%esp
          s++;
    3aeb:	83 c6 01             	add    $0x1,%esi
    3aee:	88 45 e3             	mov    %al,-0x1d(%ebp)
  write(fd, &c, 1);
    3af1:	6a 01                	push   $0x1
    3af3:	57                   	push   %edi
    3af4:	53                   	push   %ebx
    3af5:	e8 48 fd ff ff       	call   3842 <write>
        while(*s != 0){
    3afa:	0f b6 06             	movzbl (%esi),%eax
    3afd:	83 c4 10             	add    $0x10,%esp
    3b00:	84 c0                	test   %al,%al
    3b02:	75 e4                	jne    3ae8 <printf+0x148>
    3b04:	8b 75 d0             	mov    -0x30(%ebp),%esi
      state = 0;
    3b07:	31 ff                	xor    %edi,%edi
    3b09:	e9 da fe ff ff       	jmp    39e8 <printf+0x48>
    3b0e:	66 90                	xchg   %ax,%ax
        printint(fd, *ap, 10, 1);
    3b10:	83 ec 0c             	sub    $0xc,%esp
    3b13:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3b18:	6a 01                	push   $0x1
    3b1a:	e9 73 ff ff ff       	jmp    3a92 <printf+0xf2>
    3b1f:	90                   	nop
  write(fd, &c, 1);
    3b20:	83 ec 04             	sub    $0x4,%esp
    3b23:	88 5d e5             	mov    %bl,-0x1b(%ebp)
    3b26:	8d 45 e5             	lea    -0x1b(%ebp),%eax
    3b29:	6a 01                	push   $0x1
    3b2b:	e9 21 ff ff ff       	jmp    3a51 <printf+0xb1>
        putc(fd, *ap);
    3b30:	8b 7d d4             	mov    -0x2c(%ebp),%edi
  write(fd, &c, 1);
    3b33:	83 ec 04             	sub    $0x4,%esp
        putc(fd, *ap);
    3b36:	8b 07                	mov    (%edi),%eax
  write(fd, &c, 1);
    3b38:	6a 01                	push   $0x1
        ap++;
    3b3a:	83 c7 04             	add    $0x4,%edi
        putc(fd, *ap);
    3b3d:	88 45 e4             	mov    %al,-0x1c(%ebp)
  write(fd, &c, 1);
    3b40:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    3b43:	50                   	push   %eax
    3b44:	ff 75 08             	pushl  0x8(%ebp)
    3b47:	e8 f6 fc ff ff       	call   3842 <write>
        ap++;
    3b4c:	89 7d d4             	mov    %edi,-0x2c(%ebp)
    3b4f:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3b52:	31 ff                	xor    %edi,%edi
    3b54:	e9 8f fe ff ff       	jmp    39e8 <printf+0x48>
          s = "(null)";
    3b59:	bb 80 56 00 00       	mov    $0x5680,%ebx
        while(*s != 0){
    3b5e:	b8 28 00 00 00       	mov    $0x28,%eax
    3b63:	e9 72 ff ff ff       	jmp    3ada <printf+0x13a>
    3b68:	66 90                	xchg   %ax,%ax
    3b6a:	66 90                	xchg   %ax,%ax
    3b6c:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3b71:	a1 20 61 00 00       	mov    0x6120,%eax
{
    3b76:	89 e5                	mov    %esp,%ebp
    3b78:	57                   	push   %edi
    3b79:	56                   	push   %esi
    3b7a:	53                   	push   %ebx
    3b7b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  bp = (Header*)ap - 1;
    3b7e:	8d 4b f8             	lea    -0x8(%ebx),%ecx
    3b81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3b88:	39 c8                	cmp    %ecx,%eax
    3b8a:	8b 10                	mov    (%eax),%edx
    3b8c:	73 32                	jae    3bc0 <free+0x50>
    3b8e:	39 d1                	cmp    %edx,%ecx
    3b90:	72 04                	jb     3b96 <free+0x26>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3b92:	39 d0                	cmp    %edx,%eax
    3b94:	72 32                	jb     3bc8 <free+0x58>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3b96:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3b99:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3b9c:	39 fa                	cmp    %edi,%edx
    3b9e:	74 30                	je     3bd0 <free+0x60>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    3ba0:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    3ba3:	8b 50 04             	mov    0x4(%eax),%edx
    3ba6:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3ba9:	39 f1                	cmp    %esi,%ecx
    3bab:	74 3a                	je     3be7 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3bad:	89 08                	mov    %ecx,(%eax)
  freep = p;
    3baf:	a3 20 61 00 00       	mov    %eax,0x6120
}
    3bb4:	5b                   	pop    %ebx
    3bb5:	5e                   	pop    %esi
    3bb6:	5f                   	pop    %edi
    ...
    3bc2:	72 04                	jb     3bc8 <free+0x58>
    3bc4:	39 d1                	cmp    %edx,%ecx
    3bc6:	72 ce                	jb     3b96 <free+0x26>
{
    3bc8:	89 d0                	mov    %edx,%eax
    3bca:	eb bc                	jmp    3b88 <free+0x18>
    3bcc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    bp->s.size += p->s.ptr->s.size;
    3bd0:	03 72 04             	add    0x4(%edx),%esi
    3bd3:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3bd6:	8b 10                	mov    (%eax),%edx
    3bd8:	8b 12                	mov    (%edx),%edx
    3bda:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    3bdd:	8b 50 04             	mov    0x4(%eax),%edx
    3be0:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3be3:	39 f1                	cmp    %esi,%ecx
    3be5:	75 c6                	jne    3bad <free+0x3d>
    p->s.size += bp->s.size;
    3be7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    3bea:	a3 20 61 00 00       	mov    %eax,0x6120
    p->s.size += bp->s.size;
    3bef:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3bf2:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3bf5:	89 10                	mov    %edx,(%eax)
}
    3bf7:	5b                   	pop    %ebx
    3bf8:	5e                   	pop    %esi
    3bf9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c0c:	8b 15 20 61 00 00    	mov    0x6120,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3c12:	8d 78 07             	lea    0x7(%eax),%edi
    3c15:	c1 ef 03             	shr    $0x3,%edi
    3c18:	83 c7 01             	add    $0x1,%edi
  if((prevp = freep) == 0){
    3c1b:	85 d2                	test   %edx,%edx
    3c1d:	0f 84 9d 00 00 00    	je     3cc0 <malloc+0xc0>
    3c23:	8b 02                	mov    (%edx),%eax
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    3c28:	39 cf                	cmp    %ecx,%edi
    3c2a:	76 6c                	jbe    3c98 <malloc+0x98>
    3c2c:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
    3c32:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3c37:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    3c3a:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    3c41:	eb 0e                	jmp    3c51 <malloc+0x51>
    3c43:	90                   	nop
    3c44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3c48:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3c4a:	8b 48 04             	mov    0x4(%eax),%ecx
    3c4d:	39 f9                	cmp    %edi,%ecx
    3c4f:	73 47                	jae    3c98 <malloc+0x98>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    3c51:	39 05 20 61 00 00    	cmp    %eax,0x6120
    3c57:	89 c2                	mov    %eax,%edx
    3c59:	75 ed                	jne    3c48 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    3c5b:	83 ec 0c             	sub    $0xc,%esp
    3c5e:	56                   	push   %esi
    3c5f:	e8 4e fc ff ff       	call   38b2 <sbrk>
  if(p == (char*)-1)
    3c64:	83 c4 10             	add    $0x10,%esp
    3c67:	83 f8 ff             	cmp    $0xffffffff,%eax
    3c6a:	74 1c                	je     3c88 <malloc+0x88>
  hp->s.size = nu;
    3c6c:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3c6f:	83 ec 0c             	sub    $0xc,%esp
    3c72:	83 c0 08             	add    $0x8,%eax
    3c75:	50                   	push   %eax
    3c76:	e8 f5 fe ff ff       	call   3b70 <free>
  return freep;
    3c7b:	8b 15 20 61 00 00    	mov    0x6120,%edx
      if((p = morecore(nunits)) == 0)
    3c81:	83 c4 10             	add    $0x10,%esp
    3c84:	85 d2                	test   %edx,%edx
    3c86:	75 c0                	jne    3c48 <malloc+0x48>
        return 0;
  }
}
    3c88:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    3c8b:	31 c0                	xor    %eax,%eax
}
    3c8d:	5b                   	pop    %ebx
    3c8e:	5e                   	pop    %esi
    3c8f:	5f                   	pop    %edi
    3c90:	5d                   	pop    %ebp
    3c91:	c3                   	ret    
    3c92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    3c98:	39 cf                	cmp    %ecx,%edi
    3c9a:	74 54                	je     3cf0 <malloc+0xf0>
        p->s.size -= nunits;
    3c9c:	29 f9                	sub    %edi,%ecx
    3c9e:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    3ca1:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3ca4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3ca7:	89 15 20 61 00 00    	mov    %edx,0x6120
}
    3cad:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    3cb0:	83 c0 08             	add    $0x8,%eax
}
    3cb3:	5b                   	pop    %ebx
    3cb4:	5e                   	pop    %esi
    3cb5:	5f                   	pop    %edi
    ...
    base.s.ptr = freep = prevp = &base;
    3cc0:	c7 05 20 61 00 00 24 	movl   $0x6124,0x6120
    3cc7:	61 00 00 
    3cca:	c7 05 24 61 00 00 24 	movl   $0x6124,0x6124
    3cd1:	61 00 00 
    base.s.size = 0;
    3cd4:	b8 24 61 00 00       	mov    $0x6124,%eax
    3cd9:	c7 05 28 61 00 00 00 	movl   $0x0,0x6128
    3ce0:	00 00 00 
    3ce3:	e9 44 ff ff ff       	jmp    3c2c <malloc+0x2c>
    3ce8:	90                   	nop
    3ce9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        prevp->s.ptr = p->s.ptr;
    3cf0:	8b 08                	mov    (%eax),%ecx
    3cf2:	89 0a                	mov    %ecx,(%edx)
    3cf4:	eb b1                	jmp    3ca7 <malloc+0xa7>
...
void add_thread(int *pid,void *ustack){
    3d00:	ba 80 a8 00 00       	mov    $0xa880,%edx
	int i;
	for(i=0;i<NTHREAD;i++){
    3d05:	31 c0                	xor    %eax,%eax
		if(threads[i].used==0){
    3d07:	8b 4a 08             	mov    0x8(%edx),%ecx
    3d0a:	85 c9                	test   %ecx,%ecx
    3d0c:	74 12                	je     3d20 <add_thread+0x20>
	for(i=0;i<NTHREAD;i++){
    3d0e:	83 c0 01             	add    $0x1,%eax
    3d11:	83 c2 0c             	add    $0xc,%edx
    3d14:	83 f8 04             	cmp    $0x4,%eax
    3d17:	75 ee                	jne    3d07 <add_thread+0x7>
    3d19:	f3 c3                	repz ret 
    3d1b:	90                   	nop
...
void add_thread(int *pid,void *ustack){
    3d20:	55                   	push   %ebp
			threads[i].pid=*pid;
    3d21:	8d 04 40             	lea    (%eax,%eax,2),%eax
void add_thread(int *pid,void *ustack){
    3d24:	89 e5                	mov    %esp,%ebp
			threads[i].pid=*pid;
    3d26:	c1 e0 02             	shl    $0x2,%eax
    3d29:	8b 55 08             	mov    0x8(%ebp),%edx
    3d2c:	8b 0a                	mov    (%edx),%ecx
    3d2e:	8d 90 80 a8 00 00    	lea    0xa880(%eax),%edx
			threads[i].ustack=ustack;
			threads[i].used=1;
    3d34:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
			threads[i].pid=*pid;
    3d3b:	89 88 80 a8 00 00    	mov    %ecx,0xa880(%eax)
			threads[i].ustack=ustack;
    3d41:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d44:	89 42 04             	mov    %eax,0x4(%edx)
			break;
		}
	}
}
...
00003d50 <remove_thread>:

void remove_thread(int *pid)
{
    3d50:	55                   	push   %ebp
    3d51:	b8 80 a8 00 00       	mov    $0xa880,%eax
    int i;
	for(i=0;i<NTHREAD;i++){
    3d56:	31 d2                	xor    %edx,%edx
{
    3d58:	89 e5                	mov    %esp,%ebp
    3d5a:	56                   	push   %esi
    3d5b:	53                   	push   %ebx
    3d5c:	8b 4d 08             	mov    0x8(%ebp),%ecx
    	if(threads[i].used && threads[i].pid==*pid)
    3d5f:	8b 58 08             	mov    0x8(%eax),%ebx
    3d62:	85 db                	test   %ebx,%ebx
    3d64:	74 06                	je     3d6c <remove_thread+0x1c>
    3d66:	8b 31                	mov    (%ecx),%esi
    3d68:	39 30                	cmp    %esi,(%eax)
    3d6a:	74 14                	je     3d80 <remove_thread+0x30>
	for(i=0;i<NTHREAD;i++){
    3d6c:	83 c2 01             	add    $0x1,%edx
    3d6f:	83 c0 0c             	add    $0xc,%eax
    3d72:	83 fa 04             	cmp    $0x4,%edx
    3d75:	75 e8                	jne    3d5f <remove_thread+0xf>
    		threads[i].ustack=0;
    		threads[i].used=0;
    		break;
    	}
    ...
    3d80:	8d 1c 52             	lea    (%edx,%edx,2),%ebx
    3d83:	83 ec 0c             	sub    $0xc,%esp
    3d86:	c1 e3 02             	shl    $0x2,%ebx
    3d89:	ff b3 84 a8 00 00    	pushl  0xa884(%ebx)
    3d8f:	e8 dc fd ff ff       	call   3b70 <free>
    		threads[i].pid=0;
    3d94:	c7 83 80 a8 00 00 00 	movl   $0x0,0xa880(%ebx)
    3d9b:	00 00 00 
    		threads[i].ustack=0;
    3d9e:	c7 83 84 a8 00 00 00 	movl   $0x0,0xa884(%ebx)
    3da5:	00 00 00 
    		break;
    3da8:	83 c4 10             	add    $0x10,%esp
    		threads[i].used=0;
    3dab:	c7 83 88 a8 00 00 00 	movl   $0x0,0xa888(%ebx)
    3db2:	00 00 00 
}
    3db5:	8d 65 f8             	lea    -0x8(%ebp),%esp
    3db8:	5b                   	pop    %ebx
    3db9:	5e                   	pop    %esi
    3dba:	5d                   	pop    %ebp
    3dbb:	c3                   	ret    
...
00003dc0 <thread_create>:

int thread_create(void(*start_routine)(void*),void* arg){
    3dc0:	55                   	push   %ebp
    3dc1:	89 e5                	mov    %esp,%ebp
    3dc3:	53                   	push   %ebx
    3dc4:	83 ec 04             	sub    $0x4,%esp
	//if first time running any threads,initialize thread table with zeros
	static int first=1;
	if(first){
    3dc7:	a1 80 60 00 00       	mov    0x6080,%eax
    3dcc:	85 c0                	test   %eax,%eax
    3dce:	74 2d                	je     3dfd <thread_create+0x3d>
		first=0;
    3dd0:	c7 05 80 60 00 00 00 	movl   $0x0,0x6080
    3dd7:	00 00 00 
    3dda:	b8 80 a8 00 00       	mov    $0xa880,%eax
		int i;
		for(i=0;i<NTHREAD;i++){
			threads[i].pid=0;
    3ddf:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			threads[i].ustack=0;
    3de5:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    3dec:	83 c0 0c             	add    $0xc,%eax
			threads[i].used=0;
    3def:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
		for(i=0;i<NTHREAD;i++){
    3df6:	3d b0 a8 00 00       	cmp    $0xa8b0,%eax
    3dfb:	75 e2                	jne    3ddf <thread_create+0x1f>
		}
	}
	void *stack=malloc(PGSIZE);//allocate one page for user stack
    3dfd:	83 ec 0c             	sub    $0xc,%esp
    3e00:	68 00 10 00 00       	push   $0x1000
    3e05:	e8 f6 fd ff ff       	call   3c00 <malloc>
	int pid=clone(start_routine,arg,stack); //system call for kernel thread
    3e0a:	83 c4 0c             	add    $0xc,%esp
	void *stack=malloc(PGSIZE);//allocate one page for user stack
    3e0d:	89 c3                	mov    %eax,%ebx
	int pid=clone(start_routine,arg,stack); //system call for kernel thread
    3e0f:	50                   	push   %eax
    3e10:	ff 75 0c             	pushl  0xc(%ebp)
    3e13:	ff 75 08             	pushl  0x8(%ebp)
    3e16:	e8 bf fa ff ff       	call   38da <clone>
    3e1b:	b9 80 a8 00 00       	mov    $0xa880,%ecx
    3e20:	83 c4 10             	add    $0x10,%esp
	for(i=0;i<NTHREAD;i++){
    3e23:	31 d2                	xor    %edx,%edx
		if(threads[i].used==0){
    3e25:	83 79 08 00          	cmpl   $0x0,0x8(%ecx)
    3e29:	74 15                	je     3e40 <thread_create+0x80>
	for(i=0;i<NTHREAD;i++){
    3e2b:	83 c2 01             	add    $0x1,%edx
    3e2e:	83 c1 0c             	add    $0xc,%ecx
    3e31:	83 fa 04             	cmp    $0x4,%edx
    3e34:	75 ef                	jne    3e25 <thread_create+0x65>
	add_thread(&pid,stack);//save new thread to thread table
	return pid;
}
    3e36:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3e39:	c9                   	leave  
    3e3a:	c3                   	ret    
    3e3b:	90                   	nop
    3e3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
			threads[i].pid=*pid;
    3e40:	8d 14 52             	lea    (%edx,%edx,2),%edx
    3e43:	c1 e2 02             	shl    $0x2,%edx
			threads[i].ustack=ustack;
    3e46:	89 9a 84 a8 00 00    	mov    %ebx,0xa884(%edx)
			threads[i].pid=*pid;
    3e4c:	89 82 80 a8 00 00    	mov    %eax,0xa880(%edx)
			threads[i].used=1;
    3e52:	c7 82 88 a8 00 00 01 	movl   $0x1,0xa888(%edx)
    3e59:	00 00 00 
}
    3e5c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3e5f:	c9                   	leave  
    3e60:	c3                   	ret    
    3e61:	eb 0d                	jmp    3e70 <thread_join>
    3e63:	90                   	nop
    3e64:	90                   	nop
    3e65:	90                   	nop
    3e66:	90                   	nop
...
00003e70 <thread_join>:

int thread_join(void){
    3e70:	55                   	push   %ebp
    3e71:	89 e5                	mov    %esp,%ebp
    3e73:	53                   	push   %ebx
    3e74:	bb 80 a8 00 00       	mov    $0xa880,%ebx
    3e79:	83 ec 14             	sub    $0x14,%esp
	int i;
	for(i=0;i<NTHREAD;i++){
		if(threads[i].used==1){
    3e7c:	83 7b 08 01          	cmpl   $0x1,0x8(%ebx)
    3e80:	74 16                	je     3e98 <thread_join+0x28>
    3e82:	83 c3 0c             	add    $0xc,%ebx
	for(i=0;i<NTHREAD;i++){
    3e85:	81 fb b0 a8 00 00    	cmp    $0xa8b0,%ebx
    3e8b:	75 ef                	jne    3e7c <thread_join+0xc>
				remove_thread(&pid);
				return pid;
			}
		}
    ...
    3e98:	8d 43 04             	lea    0x4(%ebx),%eax
    3e9b:	83 ec 0c             	sub    $0xc,%esp
    3e9e:	50                   	push   %eax
    3e9f:	e8 3e fa ff ff       	call   38e2 <join>
			if(pid>0){
    3ea4:	83 c4 10             	add    $0x10,%esp
    3ea7:	85 c0                	test   %eax,%eax
			int pid=join(&threads[i].ustack);  //回收子线程
    3ea9:	89 45 f4             	mov    %eax,-0xc(%ebp)
			if(pid>0){
    3eac:	7e d4                	jle    3e82 <thread_join+0x12>
				remove_thread(&pid);
    3eae:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3eb1:	83 ec 0c             	sub    $0xc,%esp
    3eb4:	50                   	push   %eax
    3eb5:	e8 96 fe ff ff       	call   3d50 <remove_thread>
				return pid;
    3eba:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ebd:	83 c4 10             	add    $0x10,%esp
    3ec0:	eb cd                	jmp    3e8f <thread_join+0x1f>
    3ec2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
void printTCB(void){
    3ed6:	83 ec 04             	sub    $0x4,%esp
		printf(1,"TCB %d: %d\n",i,threads[i].used);
    3ed9:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
    3edc:	ff 34 85 88 a8 00 00 	pushl  0xa888(,%eax,4)
    3ee3:	53                   	push   %ebx
	for(i=0;i<NTHREAD;i++)
    3ee4:	83 c3 01             	add    $0x1,%ebx
		printf(1,"TCB %d: %d\n",i,threads[i].used);
    3ee7:	68 99 56 00 00       	push   $0x5699
    3eec:	6a 01                	push   $0x1
    3eee:	e8 ad fa ff ff       	call   39a0 <printf>
	for(i=0;i<NTHREAD;i++)
    3ef3:	83 c4 10             	add    $0x10,%esp
    3ef6:	83 fb 04             	cmp    $0x4,%ebx
    3ef9:	75 de                	jne    3ed9 <printTCB+0x9>
}
    3efb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3efe:	c9                   	leave  
    3eff:	c3                   	ret    
