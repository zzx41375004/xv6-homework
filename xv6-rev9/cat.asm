 ...
 429:	85 d2                	test   %edx,%edx
{
 ...
 457:	f7 f1                	div    %ecx
 459:	0f b6 92 5c 0a 00 00 	movzbl 0xa5c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 674:	e9 8f fe ff ff       	jmp    508 <printf+0x48>
          s = "(null)";
 679:	bb 52 0a 00 00       	mov    $0xa52,%ebx
        while(*s != 0){
...
void add_thread(int *pid,void *ustack){
 820:	ba 60 10 00 00       	mov    $0x1060,%edx
	int i;
	for(i=0;i<NTHREAD;i++){
...
void add_thread(int *pid,void *ustack){
 ...
 84e:	8d 90 60 10 00 00    	lea    0x1060(%eax),%edx
			threads[i].ustack=ustack;
			threads[i].used=1;
 854:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
			threads[i].pid=*pid;
 85b:	89 88 60 10 00 00    	mov    %ecx,0x1060(%eax)
			threads[i].ustack=ustack;
...
{
 870:	55                   	push   %ebp
 871:	b8 60 10 00 00       	mov    $0x1060,%eax
    int i;
	for(i=0;i<NTHREAD;i++){
 876:	31 d2                	xor    %edx,%edx
{
 ...
 8a9:	ff b3 64 10 00 00    	pushl  0x1064(%ebx)
 8af:	e8 dc fd ff ff       	call   690 <free>
    		threads[i].pid=0;
 8b4:	c7 83 60 10 00 00 00 	movl   $0x0,0x1060(%ebx)
 8bb:	00 00 00 
    		threads[i].ustack=0;
 8be:	c7 83 64 10 00 00 00 	movl   $0x0,0x1064(%ebx)
 8c5:	00 00 00 
    		break;
 8c8:	83 c4 10             	add    $0x10,%esp
    		threads[i].used=0;
 8cb:	c7 83 68 10 00 00 00 	movl   $0x0,0x1068(%ebx)
 8d2:	00 00 00 
}
...
int thread_create(void(*start_routine)(void*),void* arg){
 ...
 8f7:	00 00 00 
 8fa:	b8 60 10 00 00       	mov    $0x1060,%eax
		int i;
		for(i=0;i<NTHREAD;i++){
			threads[i].pid=0;
 ...
 90f:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
		for(i=0;i<NTHREAD;i++){
 916:	3d 90 10 00 00       	cmp    $0x1090,%eax
 ...
 93b:	b9 60 10 00 00       	mov    $0x1060,%ecx
 ...
 963:	c1 e2 02             	shl    $0x2,%edx
			threads[i].ustack=ustack;
 966:	89 9a 64 10 00 00    	mov    %ebx,0x1064(%edx)
			threads[i].pid=*pid;
 96c:	89 82 60 10 00 00    	mov    %eax,0x1060(%edx)
			threads[i].used=1;
 972:	c7 82 68 10 00 00 01 	movl   $0x1,0x1068(%edx)
 979:	00 00 00 
}
...
int thread_join(void){
 ...
 993:	53                   	push   %ebx
 994:	bb 60 10 00 00       	mov    $0x1060,%ebx
 ...
 9a2:	83 c3 0c             	add    $0xc,%ebx
	for(i=0;i<NTHREAD;i++){
 9a5:	81 fb 90 10 00 00    	cmp    $0x1090,%ebx
...
void printTCB(void){
 ...
 9fc:	ff 34 85 68 10 00 00 	pushl  0x1068(,%eax,4)
 a03:	53                   	push   %ebx
	for(i=0;i<NTHREAD;i++)
 a04:	83 c3 01             	add    $0x1,%ebx
		printf(1,"TCB %d: %d\n",i,threads[i].used);
 a07:	68 6d 0a 00 00       	push   $0xa6d
 a0c:	6a 01                	push   $0x1
