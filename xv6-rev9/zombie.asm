...
free(void *ap)
{
 ...
 5d1:	a1 20 0d 00 00       	mov    0xd20,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 20 0d 00 00       	mov    %eax,0xd20
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 20 0d 00 00       	mov    %eax,0xd20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 20 0d 00 00    	mov    0xd20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
    ...
    if(p == freep)
 6b1:	39 05 20 0d 00 00    	cmp    %eax,0xd20
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 20 0d 00 00    	mov    0xd20,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 20 0d 00 00    	mov    %edx,0xd20
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 20 0d 00 00 24 	movl   $0xd24,0xd20
 727:	0d 00 00 
 72a:	c7 05 24 0d 00 00 24 	movl   $0xd24,0xd24
 731:	0d 00 00 
    base.s.size = 0;
 734:	b8 24 0d 00 00       	mov    $0xd24,%eax
 739:	c7 05 28 0d 00 00 00 	movl   $0x0,0xd28
 740:	00 00 00 
...
void add_thread(int *pid,void *ustack){
 760:	ba 40 0d 00 00       	mov    $0xd40,%edx
	int i;
	for(i=0;i<NTHREAD;i++){
...
void add_thread(int *pid,void *ustack){
 ...
 78e:	8d 90 40 0d 00 00    	lea    0xd40(%eax),%edx
			threads[i].ustack=ustack;
			threads[i].used=1;
 794:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
			threads[i].pid=*pid;
 79b:	89 88 40 0d 00 00    	mov    %ecx,0xd40(%eax)
			threads[i].ustack=ustack;
...
{
 7b0:	55                   	push   %ebp
 7b1:	b8 40 0d 00 00       	mov    $0xd40,%eax
    int i;
	for(i=0;i<NTHREAD;i++){
 7b6:	31 d2                	xor    %edx,%edx
{
 ...
 7e9:	ff b3 44 0d 00 00    	pushl  0xd44(%ebx)
 7ef:	e8 dc fd ff ff       	call   5d0 <free>
    		threads[i].pid=0;
 7f4:	c7 83 40 0d 00 00 00 	movl   $0x0,0xd40(%ebx)
 7fb:	00 00 00 
    		threads[i].ustack=0;
 7fe:	c7 83 44 0d 00 00 00 	movl   $0x0,0xd44(%ebx)
 805:	00 00 00 
    		break;
 808:	83 c4 10             	add    $0x10,%esp
    		threads[i].used=0;
 80b:	c7 83 48 0d 00 00 00 	movl   $0x0,0xd48(%ebx)
 812:	00 00 00 
}
...
int thread_create(void(*start_routine)(void*),void* arg){
 ...
 824:	83 ec 04             	sub    $0x4,%esp
	...
	static int first=1;
	if(first){
 827:	a1 10 0d 00 00       	mov    0xd10,%eax
 82c:	85 c0                	test   %eax,%eax
 82e:	74 2d                	je     85d <thread_create+0x3d>
		first=0;
 830:	c7 05 10 0d 00 00 00 	movl   $0x0,0xd10
 837:	00 00 00 
 83a:	b8 40 0d 00 00       	mov    $0xd40,%eax
		int i;
		for(i=0;i<NTHREAD;i++){
			threads[i].pid=0;
 ...
 84f:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
		for(i=0;i<NTHREAD;i++){
 856:	3d 70 0d 00 00       	cmp    $0xd70,%eax
 ...
 87b:	b9 40 0d 00 00       	mov    $0xd40,%ecx
 ...
 8a3:	c1 e2 02             	shl    $0x2,%edx
			threads[i].ustack=ustack;
 8a6:	89 9a 44 0d 00 00    	mov    %ebx,0xd44(%edx)
			threads[i].pid=*pid;
 8ac:	89 82 40 0d 00 00    	mov    %eax,0xd40(%edx)
			threads[i].used=1;
 8b2:	c7 82 48 0d 00 00 01 	movl   $0x1,0xd48(%edx)
 8b9:	00 00 00 
}
...
int thread_join(void){
 ...
 8d3:	53                   	push   %ebx
 8d4:	bb 40 0d 00 00       	mov    $0xd40,%ebx
 ...
 8e2:	83 c3 0c             	add    $0xc,%ebx
	for(i=0;i<NTHREAD;i++){
 8e5:	81 fb 70 0d 00 00    	cmp    $0xd70,%ebx
...
void printTCB(void){
 ...
 93c:	ff 34 85 48 0d 00 00 	pushl  0xd48(,%eax,4)
 943:	53                   	push   %ebx
	for(i=0;i<NTHREAD;i++)
 944:	83 c3 01             	add    $0x1,%ebx
		printf(1,"TCB %d: %d\n",i,threads[i].used);
 947:	68 85 09 00 00       	push   $0x985
 94c:	6a 01                	push   $0x1
