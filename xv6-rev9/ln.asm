 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 3c7:	f7 f1                	div    %ecx
 3c9:	0f b6 92 cc 09 00 00 	movzbl 0x9cc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb c3 09 00 00       	mov    $0x9c3,%ebx
        while(*s != 0){
...
void add_thread(int *pid,void *ustack){
 790:	ba a0 0d 00 00       	mov    $0xda0,%edx
	int i;
	for(i=0;i<NTHREAD;i++){
...
void add_thread(int *pid,void *ustack){
 ...
 7be:	8d 90 a0 0d 00 00    	lea    0xda0(%eax),%edx
			threads[i].ustack=ustack;
			threads[i].used=1;
 7c4:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
			threads[i].pid=*pid;
 7cb:	89 88 a0 0d 00 00    	mov    %ecx,0xda0(%eax)
			threads[i].ustack=ustack;
...
{
 7e0:	55                   	push   %ebp
 7e1:	b8 a0 0d 00 00       	mov    $0xda0,%eax
    int i;
	for(i=0;i<NTHREAD;i++){
 7e6:	31 d2                	xor    %edx,%edx
{
 ...
 819:	ff b3 a4 0d 00 00    	pushl  0xda4(%ebx)
 81f:	e8 dc fd ff ff       	call   600 <free>
    		threads[i].pid=0;
 824:	c7 83 a0 0d 00 00 00 	movl   $0x0,0xda0(%ebx)
 82b:	00 00 00 
    		threads[i].ustack=0;
 82e:	c7 83 a4 0d 00 00 00 	movl   $0x0,0xda4(%ebx)
 835:	00 00 00 
    		break;
 838:	83 c4 10             	add    $0x10,%esp
    		threads[i].used=0;
 83b:	c7 83 a8 0d 00 00 00 	movl   $0x0,0xda8(%ebx)
 842:	00 00 00 
}
...
int thread_create(void(*start_routine)(void*),void* arg){
 ...
 854:	83 ec 04             	sub    $0x4,%esp
	...
	static int first=1;
	if(first){
 857:	a1 6c 0d 00 00       	mov    0xd6c,%eax
 85c:	85 c0                	test   %eax,%eax
 85e:	74 2d                	je     88d <thread_create+0x3d>
		first=0;
 860:	c7 05 6c 0d 00 00 00 	movl   $0x0,0xd6c
 867:	00 00 00 
 86a:	b8 a0 0d 00 00       	mov    $0xda0,%eax
		int i;
		for(i=0;i<NTHREAD;i++){
			threads[i].pid=0;
 ...
 87f:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
		for(i=0;i<NTHREAD;i++){
 886:	3d d0 0d 00 00       	cmp    $0xdd0,%eax
 ...
 8ab:	b9 a0 0d 00 00       	mov    $0xda0,%ecx
 ...
 8d3:	c1 e2 02             	shl    $0x2,%edx
			threads[i].ustack=ustack;
 8d6:	89 9a a4 0d 00 00    	mov    %ebx,0xda4(%edx)
			threads[i].pid=*pid;
 8dc:	89 82 a0 0d 00 00    	mov    %eax,0xda0(%edx)
			threads[i].used=1;
 8e2:	c7 82 a8 0d 00 00 01 	movl   $0x1,0xda8(%edx)
 8e9:	00 00 00 
}
...
int thread_join(void){
 ...
 903:	53                   	push   %ebx
 904:	bb a0 0d 00 00       	mov    $0xda0,%ebx
 ...
 912:	83 c3 0c             	add    $0xc,%ebx
	for(i=0;i<NTHREAD;i++){
 915:	81 fb d0 0d 00 00    	cmp    $0xdd0,%ebx
...
void printTCB(void){
 ...
 96c:	ff 34 85 a8 0d 00 00 	pushl  0xda8(,%eax,4)
 973:	53                   	push   %ebx
	for(i=0;i<NTHREAD;i++)
 974:	83 c3 01             	add    $0x1,%ebx
		printf(1,"TCB %d: %d\n",i,threads[i].used);
 977:	68 dd 09 00 00       	push   $0x9dd
 97c:	6a 01                	push   $0x1
