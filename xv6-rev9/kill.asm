 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 3c7:	f7 f1                	div    %ecx
 3c9:	0f b6 92 b8 09 00 00 	movzbl 0x9b8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb b0 09 00 00       	mov    $0x9b0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 60 0d 00 00       	mov    0xd60,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 60 0d 00 00       	mov    %eax,0xd60
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 60 0d 00 00       	mov    %eax,0xd60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 60 0d 00 00    	mov    0xd60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 60 0d 00 00    	mov    0xd60,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 60 0d 00 00    	mov    %edx,0xd60
}
 ...
 749:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 60 0d 00 00 64 	movl   $0xd64,0xd60
 757:	0d 00 00 
 75a:	c7 05 64 0d 00 00 64 	movl   $0xd64,0xd64
 761:	0d 00 00 
    base.s.size = 0;
 764:	b8 64 0d 00 00       	mov    $0xd64,%eax
 769:	c7 05 68 0d 00 00 00 	movl   $0x0,0xd68
 770:	00 00 00 
...
void add_thread(int *pid,void *ustack){
 790:	ba 80 0d 00 00       	mov    $0xd80,%edx
	int i;
	for(i=0;i<NTHREAD;i++){
 795:	31 c0                	xor    %eax,%eax
		if(threads[i].used==0){
 797:	8b 4a 08             	mov    0x8(%edx),%ecx
 79a:	85 c9                	test   %ecx,%ecx
 79c:	74 12                	je     7b0 <add_thread+0x20>
	for(i=0;i<NTHREAD;i++){
 79e:	83 c0 01             	add    $0x1,%eax
 7a1:	83 c2 0c             	add    $0xc,%edx
 7a4:	83 f8 04             	cmp    $0x4,%eax
 7a7:	75 ee                	jne    797 <add_thread+0x7>
 7a9:	f3 c3                	repz ret 
 7ab:	90                   	nop
...
void add_thread(int *pid,void *ustack){
 7b0:	55                   	push   %ebp
			threads[i].pid=*pid;
 7b1:	8d 04 40             	lea    (%eax,%eax,2),%eax
void add_thread(int *pid,void *ustack){
 7b4:	89 e5                	mov    %esp,%ebp
			threads[i].pid=*pid;
 7b6:	c1 e0 02             	shl    $0x2,%eax
 7b9:	8b 55 08             	mov    0x8(%ebp),%edx
 7bc:	8b 0a                	mov    (%edx),%ecx
 7be:	8d 90 80 0d 00 00    	lea    0xd80(%eax),%edx
			threads[i].ustack=ustack;
			threads[i].used=1;
 7c4:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
			threads[i].pid=*pid;
 7cb:	89 88 80 0d 00 00    	mov    %ecx,0xd80(%eax)
			threads[i].ustack=ustack;
...
{
 7e0:	55                   	push   %ebp
 7e1:	b8 80 0d 00 00       	mov    $0xd80,%eax
    int i;
	for(i=0;i<NTHREAD;i++){
 7e6:	31 d2                	xor    %edx,%edx
{
 ...
 819:	ff b3 84 0d 00 00    	pushl  0xd84(%ebx)
 81f:	e8 dc fd ff ff       	call   600 <free>
    		threads[i].pid=0;
 824:	c7 83 80 0d 00 00 00 	movl   $0x0,0xd80(%ebx)
 82b:	00 00 00 
    		threads[i].ustack=0;
 82e:	c7 83 84 0d 00 00 00 	movl   $0x0,0xd84(%ebx)
 835:	00 00 00 
    		break;
 838:	83 c4 10             	add    $0x10,%esp
    		threads[i].used=0;
 83b:	c7 83 88 0d 00 00 00 	movl   $0x0,0xd88(%ebx)
 842:	00 00 00 
}
...
int thread_create(void(*start_routine)(void*),void* arg){
 ...
 854:	83 ec 04             	sub    $0x4,%esp
	...
	static int first=1;
	if(first){
 857:	a1 5c 0d 00 00       	mov    0xd5c,%eax
 85c:	85 c0                	test   %eax,%eax
 85e:	74 2d                	je     88d <thread_create+0x3d>
		first=0;
 860:	c7 05 5c 0d 00 00 00 	movl   $0x0,0xd5c
 867:	00 00 00 
 86a:	b8 80 0d 00 00       	mov    $0xd80,%eax
		int i;
		for(i=0;i<NTHREAD;i++){
			threads[i].pid=0;
 86f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			threads[i].ustack=0;
 875:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 87c:	83 c0 0c             	add    $0xc,%eax
			threads[i].used=0;
 87f:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
		for(i=0;i<NTHREAD;i++){
 886:	3d b0 0d 00 00       	cmp    $0xdb0,%eax
 88b:	75 e2                	jne    86f <thread_create+0x1f>
		}
	}
	void *stack=malloc(PGSIZE);//allocate one page for user stack
 88d:	83 ec 0c             	sub    $0xc,%esp
 890:	68 00 10 00 00       	push   $0x1000
 895:	e8 f6 fd ff ff       	call   690 <malloc>
	int pid=clone(start_routine,arg,stack); //system call for kernel thread
 89a:	83 c4 0c             	add    $0xc,%esp
	void *stack=malloc(PGSIZE);//allocate one page for user stack
 89d:	89 c3                	mov    %eax,%ebx
	int pid=clone(start_routine,arg,stack); //system call for kernel thread
 89f:	50                   	push   %eax
 8a0:	ff 75 0c             	pushl  0xc(%ebp)
 8a3:	ff 75 08             	pushl  0x8(%ebp)
 8a6:	e8 bf fa ff ff       	call   36a <clone>
 8ab:	b9 80 0d 00 00       	mov    $0xd80,%ecx
 8b0:	83 c4 10             	add    $0x10,%esp
	for(i=0;i<NTHREAD;i++){
 8b3:	31 d2                	xor    %edx,%edx
		if(threads[i].used==0){
 8b5:	83 79 08 00          	cmpl   $0x0,0x8(%ecx)
 8b9:	74 15                	je     8d0 <thread_create+0x80>
	for(i=0;i<NTHREAD;i++){
 8bb:	83 c2 01             	add    $0x1,%edx
 8be:	83 c1 0c             	add    $0xc,%ecx
 8c1:	83 fa 04             	cmp    $0x4,%edx
 8c4:	75 ef                	jne    8b5 <thread_create+0x65>
 ...
 8cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
			threads[i].pid=*pid;
 8d0:	8d 14 52             	lea    (%edx,%edx,2),%edx
 8d3:	c1 e2 02             	shl    $0x2,%edx
			threads[i].ustack=ustack;
 8d6:	89 9a 84 0d 00 00    	mov    %ebx,0xd84(%edx)
			threads[i].pid=*pid;
 8dc:	89 82 80 0d 00 00    	mov    %eax,0xd80(%edx)
			threads[i].used=1;
 8e2:	c7 82 88 0d 00 00 01 	movl   $0x1,0xd88(%edx)
 8e9:	00 00 00 
}
 8ec:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 8ef:	c9                   	leave  
 8f0:	c3                   	ret    
 8f1:	eb 0d                	jmp    900 <thread_join>
 8f3:	90                   	nop
 8f4:	90                   	nop
 8f5:	90                   	nop
 8f6:	90                   	nop
...
int thread_join(void){
 ...
 903:	53                   	push   %ebx
 904:	bb 80 0d 00 00       	mov    $0xd80,%ebx
 ...
 912:	83 c3 0c             	add    $0xc,%ebx
	for(i=0;i<NTHREAD;i++){
 915:	81 fb b0 0d 00 00    	cmp    $0xdb0,%ebx
 ...
 92e:	50                   	push   %eax
 92f:	e8 3e fa ff ff       	call   372 <join>
			if(pid>0){
 ...
 944:	50                   	push   %eax
 945:	e8 96 fe ff ff       	call   7e0 <remove_thread>
				return pid;
...
void printTCB(void){
 ...
 96c:	ff 34 85 88 0d 00 00 	pushl  0xd88(,%eax,4)
 973:	53                   	push   %ebx
	for(i=0;i<NTHREAD;i++)
 974:	83 c3 01             	add    $0x1,%ebx
		printf(1,"TCB %d: %d\n",i,threads[i].used);
 977:	68 c9 09 00 00       	push   $0x9c9
 97c:	6a 01                	push   $0x1
 97e:	e8 ad fa ff ff       	call   430 <printf>
	for(i=0;i<NTHREAD;i++)
