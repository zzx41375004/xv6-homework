...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      57:	6a 64                	push   $0x64
      59:	68 c0 1b 00 00       	push   $0x1bc0
      5e:	e8 9d 00 00 00       	call   100 <getcmd>
      63:	83 c4 10             	add    $0x10,%esp
      66:	85 c0                	test   %eax,%eax
      68:	78 37                	js     a1 <main+0xa1>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6a:	80 3d c0 1b 00 00 63 	cmpb   $0x63,0x1bc0
      71:	75 ce                	jne    41 <main+0x41>
      73:	80 3d c1 1b 00 00 64 	cmpb   $0x64,0x1bc1
  ...
  exit();
      ...
      e6:	50                   	push   %eax
      e7:	68 c3 1b 00 00       	push   $0x1bc3
      ec:	68 a5 14 00 00       	push   $0x14a5
      f1:	6a 02                	push   $0x2
...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     10e:	68 fc 13 00 00       	push   $0x13fc
     113:	6a 02                	push   $0x2
...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 99 14 00 00       	push   $0x1499
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 b4 14 00 00 	jmp    *0x14b4(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 06 14 00 00       	push   $0x1406
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 16 14 00 00       	push   $0x1416
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 ff 13 00 00       	push   $0x13ff
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 26 14 00 00       	push   $0x1426
     ...
     2d8:	68 2b 14 00 00       	push   $0x142b
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 26 14 00 00       	push   $0x1426
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 a8 1b 00 00       	push   $0x1ba8
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 a8 1b 00 00       	push   $0x1ba8
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 a0 1b 00 00       	push   $0x1ba0
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 a8 1b 00 00       	push   $0x1ba8
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 a8 1b 00 00       	push   $0x1ba8
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 4d 14 00 00       	push   $0x144d
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 30 14 00 00       	push   $0x1430
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 50 14 00 00       	push   $0x1450
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 67 14 00 00       	push   $0x1467
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 59 14 00 00       	push   $0x1459
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 52 14 00 00       	push   $0x1452
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 6c 14 00 00       	push   $0x146c
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 6e 14 00 00       	push   $0x146e
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 6a 14 00 00       	push   $0x146a
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 50 14 00 00       	push   $0x1450
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 8c 14 00 00       	push   $0x148c
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 cc 14 00 00 	jmp    *0x14cc(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 08 15 00 00       	push   $0x1508
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 8e 14 00 00       	push   $0x148e
     aa6:	6a 02                	push   $0x2
     aa8:	e8 e3 03 00 00       	call   e90 <printf>
    panic("syntax");
     aad:	c7 04 24 52 14 00 00 	movl   $0x1452,(%esp)
     ...
     df9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e27:	f7 f1                	div    %ecx
     e29:	0f b6 92 ec 14 00 00 	movzbl 0x14ec(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1044:	e9 8f fe ff ff       	jmp    ed8 <printf+0x48>
          s = "(null)";
    1049:	bb e4 14 00 00       	mov    $0x14e4,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1061:	a1 24 1c 00 00       	mov    0x1c24,%eax
{
  ...
  freep = p;
    109f:	a3 24 1c 00 00       	mov    %eax,0x1c24
}
    10a4:	5b                   	pop    %ebx
    10a5:	5e                   	pop    %esi
    10a6:	5f                   	pop    %edi
    ...
    10b6:	72 ce                	jb     1086 <free+0x26>
{
  ...
  freep = p;
    10da:	a3 24 1c 00 00       	mov    %eax,0x1c24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    10fc:	8b 15 24 1c 00 00    	mov    0x1c24,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    116b:	8b 15 24 1c 00 00    	mov    0x1c24,%edx
    ...
    1194:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1197:	89 15 24 1c 00 00    	mov    %edx,0x1c24
}
    ...
    base.s.ptr = freep = prevp = &base;
    11b0:	c7 05 24 1c 00 00 28 	movl   $0x1c28,0x1c24
    11b7:	1c 00 00 
    11ba:	c7 05 28 1c 00 00 28 	movl   $0x1c28,0x1c28
    11c1:	1c 00 00 
    base.s.size = 0;
    11c4:	b8 28 1c 00 00       	mov    $0x1c28,%eax
    11c9:	c7 05 2c 1c 00 00 00 	movl   $0x0,0x1c2c
    11d0:	00 00 00 
...
void add_thread(int *pid,void *ustack){
    11f0:	ba 40 1c 00 00       	mov    $0x1c40,%edx
	int i;
	for(i=0;i<NTHREAD;i++){
...
void add_thread(int *pid,void *ustack){
    ...
    121e:	8d 90 40 1c 00 00    	lea    0x1c40(%eax),%edx
			threads[i].ustack=ustack;
			threads[i].used=1;
    1224:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
			threads[i].pid=*pid;
    122b:	89 88 40 1c 00 00    	mov    %ecx,0x1c40(%eax)
			threads[i].ustack=ustack;
...
{
    1240:	55                   	push   %ebp
    1241:	b8 40 1c 00 00       	mov    $0x1c40,%eax
    int i;
	for(i=0;i<NTHREAD;i++){
    1246:	31 d2                	xor    %edx,%edx
{
    ...
    1279:	ff b3 44 1c 00 00    	pushl  0x1c44(%ebx)
    127f:	e8 dc fd ff ff       	call   1060 <free>
    		threads[i].pid=0;
    1284:	c7 83 40 1c 00 00 00 	movl   $0x0,0x1c40(%ebx)
    128b:	00 00 00 
    		threads[i].ustack=0;
    128e:	c7 83 44 1c 00 00 00 	movl   $0x0,0x1c44(%ebx)
    1295:	00 00 00 
    		break;
    1298:	83 c4 10             	add    $0x10,%esp
    		threads[i].used=0;
    129b:	c7 83 48 1c 00 00 00 	movl   $0x0,0x1c48(%ebx)
    12a2:	00 00 00 
}
...
int thread_create(void(*start_routine)(void*),void* arg){
	...
	static int first=1;
	if(first){
    12b7:	a1 b0 1b 00 00       	mov    0x1bb0,%eax
    12bc:	85 c0                	test   %eax,%eax
    12be:	74 2d                	je     12ed <thread_create+0x3d>
		first=0;
    12c0:	c7 05 b0 1b 00 00 00 	movl   $0x0,0x1bb0
    12c7:	00 00 00 
    12ca:	b8 40 1c 00 00       	mov    $0x1c40,%eax
		int i;
		for(i=0;i<NTHREAD;i++){
			threads[i].pid=0;
    ...
    12df:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
		for(i=0;i<NTHREAD;i++){
    12e6:	3d 70 1c 00 00       	cmp    $0x1c70,%eax
    ...
    130b:	b9 40 1c 00 00       	mov    $0x1c40,%ecx
    ...
    1333:	c1 e2 02             	shl    $0x2,%edx
			threads[i].ustack=ustack;
    1336:	89 9a 44 1c 00 00    	mov    %ebx,0x1c44(%edx)
			threads[i].pid=*pid;
    133c:	89 82 40 1c 00 00    	mov    %eax,0x1c40(%edx)
			threads[i].used=1;
    1342:	c7 82 48 1c 00 00 01 	movl   $0x1,0x1c48(%edx)
    1349:	00 00 00 
}
...
int thread_join(void){
    ...
    1363:	53                   	push   %ebx
    1364:	bb 40 1c 00 00       	mov    $0x1c40,%ebx
	...
	for(i=0;i<NTHREAD;i++){
    1375:	81 fb 70 1c 00 00    	cmp    $0x1c70,%ebx
...
void printTCB(void){
    ...
    13cc:	ff 34 85 48 1c 00 00 	pushl  0x1c48(,%eax,4)
    13d3:	53                   	push   %ebx
	for(i=0;i<NTHREAD;i++)
    13d4:	83 c3 01             	add    $0x1,%ebx
		printf(1,"TCB %d: %d\n",i,threads[i].used);
    13d7:	68 fd 14 00 00       	push   $0x14fd
    13dc:	6a 01                	push   $0x1
