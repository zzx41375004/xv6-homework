 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 f0 09 00 00 	movzbl 0x9f0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb e9 09 00 00       	mov    $0x9e9,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 a0 0d 00 00       	mov    0xda0,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 a0 0d 00 00       	mov    %eax,0xda0
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 a0 0d 00 00       	mov    %eax,0xda0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 a0 0d 00 00    	mov    %edx,0xda0
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 a0 0d 00 00 a4 	movl   $0xda4,0xda0
 777:	0d 00 00 
 77a:	c7 05 a4 0d 00 00 a4 	movl   $0xda4,0xda4
 781:	0d 00 00 
    base.s.size = 0;
 784:	b8 a4 0d 00 00       	mov    $0xda4,%eax
 789:	c7 05 a8 0d 00 00 00 	movl   $0x0,0xda8
 790:	00 00 00 
...
void add_thread(int *pid,void *ustack){
 7b0:	ba c0 0d 00 00       	mov    $0xdc0,%edx
	int i;
	for(i=0;i<NTHREAD;i++){
 7b5:	31 c0                	xor    %eax,%eax
		if(threads[i].used==0){
 7b7:	8b 4a 08             	mov    0x8(%edx),%ecx
 7ba:	85 c9                	test   %ecx,%ecx
 7bc:	74 12                	je     7d0 <add_thread+0x20>
	for(i=0;i<NTHREAD;i++){
 7be:	83 c0 01             	add    $0x1,%eax
 7c1:	83 c2 0c             	add    $0xc,%edx
 7c4:	83 f8 04             	cmp    $0x4,%eax
 7c7:	75 ee                	jne    7b7 <add_thread+0x7>
 7c9:	f3 c3                	repz ret 
 7cb:	90                   	nop
...
void add_thread(int *pid,void *ustack){
 7d0:	55                   	push   %ebp
			threads[i].pid=*pid;
 7d1:	8d 04 40             	lea    (%eax,%eax,2),%eax
void add_thread(int *pid,void *ustack){
 7d4:	89 e5                	mov    %esp,%ebp
			threads[i].pid=*pid;
 7d6:	c1 e0 02             	shl    $0x2,%eax
 7d9:	8b 55 08             	mov    0x8(%ebp),%edx
 7dc:	8b 0a                	mov    (%edx),%ecx
 7de:	8d 90 c0 0d 00 00    	lea    0xdc0(%eax),%edx
			threads[i].ustack=ustack;
			threads[i].used=1;
 7e4:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
			threads[i].pid=*pid;
 7eb:	89 88 c0 0d 00 00    	mov    %ecx,0xdc0(%eax)
			threads[i].ustack=ustack;
...
00000800 <remove_thread>:

void remove_thread(int *pid)
{
 800:	55                   	push   %ebp
 801:	b8 c0 0d 00 00       	mov    $0xdc0,%eax
    int i;
	for(i=0;i<NTHREAD;i++){
 806:	31 d2                	xor    %edx,%edx
{
 ...
 80f:	8b 58 08             	mov    0x8(%eax),%ebx
 812:	85 db                	test   %ebx,%ebx
 814:	74 06                	je     81c <remove_thread+0x1c>
 816:	8b 31                	mov    (%ecx),%esi
 818:	39 30                	cmp    %esi,(%eax)
 81a:	74 14                	je     830 <remove_thread+0x30>
	for(i=0;i<NTHREAD;i++){
 81c:	83 c2 01             	add    $0x1,%edx
 81f:	83 c0 0c             	add    $0xc,%eax
 822:	83 fa 04             	cmp    $0x4,%edx
 825:	75 e8                	jne    80f <remove_thread+0xf>
    		threads[i].ustack=0;
    		threads[i].used=0;
    		break;
    	}
 ...
 830:	8d 1c 52             	lea    (%edx,%edx,2),%ebx
 833:	83 ec 0c             	sub    $0xc,%esp
 836:	c1 e3 02             	shl    $0x2,%ebx
 839:	ff b3 c4 0d 00 00    	pushl  0xdc4(%ebx)
 83f:	e8 dc fd ff ff       	call   620 <free>
    		threads[i].pid=0;
 844:	c7 83 c0 0d 00 00 00 	movl   $0x0,0xdc0(%ebx)
 84b:	00 00 00 
    		threads[i].ustack=0;
 84e:	c7 83 c4 0d 00 00 00 	movl   $0x0,0xdc4(%ebx)
 855:	00 00 00 
    		break;
 858:	83 c4 10             	add    $0x10,%esp
    		threads[i].used=0;
 85b:	c7 83 c8 0d 00 00 00 	movl   $0x0,0xdc8(%ebx)
 862:	00 00 00 
}
 865:	8d 65 f8             	lea    -0x8(%ebp),%esp
 868:	5b                   	pop    %ebx
 869:	5e                   	pop    %esi
 86a:	5d                   	pop    %ebp
 86b:	c3                   	ret    
...
int thread_create(void(*start_routine)(void*),void* arg){
 ...
 874:	83 ec 04             	sub    $0x4,%esp
	...
	static int first=1;
	if(first){
 877:	a1 98 0d 00 00       	mov    0xd98,%eax
 87c:	85 c0                	test   %eax,%eax
 87e:	74 2d                	je     8ad <thread_create+0x3d>
		first=0;
 880:	c7 05 98 0d 00 00 00 	movl   $0x0,0xd98
 887:	00 00 00 
 88a:	b8 c0 0d 00 00       	mov    $0xdc0,%eax
		int i;
		for(i=0;i<NTHREAD;i++){
			threads[i].pid=0;
 88f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			threads[i].ustack=0;
 895:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 89c:	83 c0 0c             	add    $0xc,%eax
			threads[i].used=0;
 89f:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
		for(i=0;i<NTHREAD;i++){
 8a6:	3d f0 0d 00 00       	cmp    $0xdf0,%eax
 8ab:	75 e2                	jne    88f <thread_create+0x1f>
		}
	}
	void *stack=malloc(PGSIZE);//allocate one page for user stack
 8ad:	83 ec 0c             	sub    $0xc,%esp
 8b0:	68 00 10 00 00       	push   $0x1000
 8b5:	e8 f6 fd ff ff       	call   6b0 <malloc>
 ...
 8c6:	e8 bf fa ff ff       	call   38a <clone>
 8cb:	b9 c0 0d 00 00       	mov    $0xdc0,%ecx
 8d0:	83 c4 10             	add    $0x10,%esp
	for(i=0;i<NTHREAD;i++){
 8d3:	31 d2                	xor    %edx,%edx
		if(threads[i].used==0){
 8d5:	83 79 08 00          	cmpl   $0x0,0x8(%ecx)
 8d9:	74 15                	je     8f0 <thread_create+0x80>
	for(i=0;i<NTHREAD;i++){
 8db:	83 c2 01             	add    $0x1,%edx
 8de:	83 c1 0c             	add    $0xc,%ecx
 8e1:	83 fa 04             	cmp    $0x4,%edx
 8e4:	75 ef                	jne    8d5 <thread_create+0x65>
 ...
 8ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
			threads[i].pid=*pid;
 8f0:	8d 14 52             	lea    (%edx,%edx,2),%edx
 8f3:	c1 e2 02             	shl    $0x2,%edx
			threads[i].ustack=ustack;
 8f6:	89 9a c4 0d 00 00    	mov    %ebx,0xdc4(%edx)
			threads[i].pid=*pid;
 8fc:	89 82 c0 0d 00 00    	mov    %eax,0xdc0(%edx)
			threads[i].used=1;
 902:	c7 82 c8 0d 00 00 01 	movl   $0x1,0xdc8(%edx)
 909:	00 00 00 
}
 90c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 90f:	c9                   	leave  
 910:	c3                   	ret    
 911:	eb 0d                	jmp    920 <thread_join>
 913:	90                   	nop
 914:	90                   	nop
 915:	90                   	nop
 916:	90                   	nop
...
int thread_join(void){
 ...
 923:	53                   	push   %ebx
 924:	bb c0 0d 00 00       	mov    $0xdc0,%ebx
 929:	83 ec 14             	sub    $0x14,%esp
	int i;
	for(i=0;i<NTHREAD;i++){
		if(threads[i].used==1){
 92c:	83 7b 08 01          	cmpl   $0x1,0x8(%ebx)
 930:	74 16                	je     948 <thread_join+0x28>
 932:	83 c3 0c             	add    $0xc,%ebx
	for(i=0;i<NTHREAD;i++){
 935:	81 fb f0 0d 00 00    	cmp    $0xdf0,%ebx
 93b:	75 ef                	jne    92c <thread_join+0xc>
				remove_thread(&pid);
				return pid;
			}
		}
 ...
 948:	8d 43 04             	lea    0x4(%ebx),%eax
 94b:	83 ec 0c             	sub    $0xc,%esp
 94e:	50                   	push   %eax
 94f:	e8 3e fa ff ff       	call   392 <join>
			if(pid>0){
 ...
 959:	89 45 f4             	mov    %eax,-0xc(%ebp)
			if(pid>0){
 95c:	7e d4                	jle    932 <thread_join+0x12>
				remove_thread(&pid);
 95e:	8d 45 f4             	lea    -0xc(%ebp),%eax
 961:	83 ec 0c             	sub    $0xc,%esp
 964:	50                   	push   %eax
 965:	e8 96 fe ff ff       	call   800 <remove_thread>
				return pid;
 96a:	8b 45 f4             	mov    -0xc(%ebp),%eax
 96d:	83 c4 10             	add    $0x10,%esp
 970:	eb cd                	jmp    93f <thread_join+0x1f>
...
void printTCB(void){
 986:	83 ec 04             	sub    $0x4,%esp
		printf(1,"TCB %d: %d\n",i,threads[i].used);
 989:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
 98c:	ff 34 85 c8 0d 00 00 	pushl  0xdc8(,%eax,4)
 993:	53                   	push   %ebx
	for(i=0;i<NTHREAD;i++)
 994:	83 c3 01             	add    $0x1,%ebx
		printf(1,"TCB %d: %d\n",i,threads[i].used);
 997:	68 01 0a 00 00       	push   $0xa01
 99c:	6a 01                	push   $0x1
 99e:	e8 ad fa ff ff       	call   450 <printf>
	for(i=0;i<NTHREAD;i++)
 9a3:	83 c4 10             	add    $0x10,%esp
 9a6:	83 fb 04             	cmp    $0x4,%ebx
 9a9:	75 de                	jne    989 <printTCB+0x9>
}
 9ab:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 9ae:	c9                   	leave  
 9af:	c3                   	ret    
