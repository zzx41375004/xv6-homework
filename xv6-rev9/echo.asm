...
main(int argc, char *argv[])
{
  ...
  28:	68 ac 09 00 00       	push   $0x9ac
  2d:	50                   	push   %eax
  2e:	68 ae 09 00 00       	push   $0x9ae
  33:	6a 01                	push   $0x1
  ...
  47:	68 d7 09 00 00       	push   $0x9d7
  4c:	50                   	push   %eax
  4d:	68 ae 09 00 00       	push   $0x9ae
  52:	6a 01                	push   $0x1
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 3d7:	f7 f1                	div    %ecx
 3d9:	0f b6 92 bc 09 00 00 	movzbl 0x9bc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb b3 09 00 00       	mov    $0x9b3,%ebx
        while(*s != 0){
 ...
 611:	a1 80 0d 00 00       	mov    0xd80,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 80 0d 00 00       	mov    %eax,0xd80
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 80 0d 00 00    	mov    0xd80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 80 0d 00 00    	cmp    %eax,0xd80
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 80 0d 00 00    	mov    0xd80,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 80 0d 00 00    	mov    %edx,0xd80
}
 ...
 767:	0d 00 00 
 76a:	c7 05 84 0d 00 00 84 	movl   $0xd84,0xd84
 771:	0d 00 00 
    base.s.size = 0;
 774:	b8 84 0d 00 00       	mov    $0xd84,%eax
 779:	c7 05 88 0d 00 00 00 	movl   $0x0,0xd88
 780:	00 00 00 
...
void add_thread(int *pid,void *ustack){
 7a0:	ba a0 0d 00 00       	mov    $0xda0,%edx
	int i;
	for(i=0;i<NTHREAD;i++){
...
void add_thread(int *pid,void *ustack){
 ...
 7ce:	8d 90 a0 0d 00 00    	lea    0xda0(%eax),%edx
			threads[i].ustack=ustack;
			threads[i].used=1;
 7d4:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
			threads[i].pid=*pid;
 7db:	89 88 a0 0d 00 00    	mov    %ecx,0xda0(%eax)
			threads[i].ustack=ustack;
...
{
 7f0:	55                   	push   %ebp
 7f1:	b8 a0 0d 00 00       	mov    $0xda0,%eax
    int i;
	for(i=0;i<NTHREAD;i++){
 7f6:	31 d2                	xor    %edx,%edx
{
 ...
 829:	ff b3 a4 0d 00 00    	pushl  0xda4(%ebx)
 82f:	e8 dc fd ff ff       	call   610 <free>
    		threads[i].pid=0;
 834:	c7 83 a0 0d 00 00 00 	movl   $0x0,0xda0(%ebx)
 83b:	00 00 00 
    		threads[i].ustack=0;
 83e:	c7 83 a4 0d 00 00 00 	movl   $0x0,0xda4(%ebx)
 845:	00 00 00 
    		break;
 848:	83 c4 10             	add    $0x10,%esp
    		threads[i].used=0;
 84b:	c7 83 a8 0d 00 00 00 	movl   $0x0,0xda8(%ebx)
 852:	00 00 00 
}
...
int thread_create(void(*start_routine)(void*),void* arg){
 ...
 864:	83 ec 04             	sub    $0x4,%esp
	...
	static int first=1;
	if(first){
 867:	a1 60 0d 00 00       	mov    0xd60,%eax
 86c:	85 c0                	test   %eax,%eax
 86e:	74 2d                	je     89d <thread_create+0x3d>
		first=0;
 870:	c7 05 60 0d 00 00 00 	movl   $0x0,0xd60
 877:	00 00 00 
 87a:	b8 a0 0d 00 00       	mov    $0xda0,%eax
		int i;
		for(i=0;i<NTHREAD;i++){
			threads[i].pid=0;
 ...
 88f:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
		for(i=0;i<NTHREAD;i++){
 896:	3d d0 0d 00 00       	cmp    $0xdd0,%eax
 ...
 8bb:	b9 a0 0d 00 00       	mov    $0xda0,%ecx
 ...
 8e3:	c1 e2 02             	shl    $0x2,%edx
			threads[i].ustack=ustack;
 8e6:	89 9a a4 0d 00 00    	mov    %ebx,0xda4(%edx)
			threads[i].pid=*pid;
 8ec:	89 82 a0 0d 00 00    	mov    %eax,0xda0(%edx)
			threads[i].used=1;
 8f2:	c7 82 a8 0d 00 00 01 	movl   $0x1,0xda8(%edx)
 8f9:	00 00 00 
}
...
int thread_join(void){
 ...
 913:	53                   	push   %ebx
 914:	bb a0 0d 00 00       	mov    $0xda0,%ebx
 ...
 922:	83 c3 0c             	add    $0xc,%ebx
	for(i=0;i<NTHREAD;i++){
 925:	81 fb d0 0d 00 00    	cmp    $0xdd0,%ebx
...
void printTCB(void){
 ...
 97c:	ff 34 85 a8 0d 00 00 	pushl  0xda8(,%eax,4)
 983:	53                   	push   %ebx
	for(i=0;i<NTHREAD;i++)
 984:	83 c3 01             	add    $0x1,%ebx
		printf(1,"TCB %d: %d\n",i,threads[i].used);
 987:	68 cd 09 00 00       	push   $0x9cd
 98c:	6a 01                	push   $0x1
