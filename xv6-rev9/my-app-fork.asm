...
_my-app-fork:     file format elf32-i386
...
int main(int argc, char const *argv[])
{
  ...
  11:	68 6c 09 00 00       	push   $0x96c
  16:	6a 01                	push   $0x1
  18:	e8 e3 03 00 00       	call   400 <printf>
	a=fork();
  1d:	e8 58 02 00 00       	call   27a <fork>
	a=fork();
  22:	e8 53 02 00 00       	call   27a <fork>
  27:	83 c4 10             	add    $0x10,%esp
  2a:	eb fe                	jmp    2a <main+0x2a>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 88 09 00 00 	movzbl 0x988(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 80 09 00 00       	mov    $0x980,%ebx
        while(*s != 0){
 ...
 5d1:	a1 40 0d 00 00       	mov    0xd40,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 40 0d 00 00       	mov    %eax,0xd40
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 40 0d 00 00       	mov    %eax,0xd40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 40 0d 00 00    	mov    0xd40,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
    ...
    if(p == freep)
 6b1:	39 05 40 0d 00 00    	cmp    %eax,0xd40
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 40 0d 00 00    	mov    0xd40,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 40 0d 00 00    	mov    %edx,0xd40
}
 ...
 727:	0d 00 00 
 72a:	c7 05 44 0d 00 00 44 	movl   $0xd44,0xd44
 731:	0d 00 00 
    base.s.size = 0;
 734:	b8 44 0d 00 00       	mov    $0xd44,%eax
 739:	c7 05 48 0d 00 00 00 	movl   $0x0,0xd48
 740:	00 00 00 
...
void add_thread(int *pid,void *ustack){
 760:	ba 60 0d 00 00       	mov    $0xd60,%edx
	int i;
	for(i=0;i<NTHREAD;i++){
 765:	31 c0                	xor    %eax,%eax
		if(threads[i].used==0){
 767:	8b 4a 08             	mov    0x8(%edx),%ecx
 76a:	85 c9                	test   %ecx,%ecx
 76c:	74 12                	je     780 <add_thread+0x20>
	for(i=0;i<NTHREAD;i++){
 76e:	83 c0 01             	add    $0x1,%eax
 771:	83 c2 0c             	add    $0xc,%edx
 774:	83 f8 04             	cmp    $0x4,%eax
 777:	75 ee                	jne    767 <add_thread+0x7>
 779:	f3 c3                	repz ret 
 77b:	90                   	nop
...
void add_thread(int *pid,void *ustack){
 780:	55                   	push   %ebp
			threads[i].pid=*pid;
 781:	8d 04 40             	lea    (%eax,%eax,2),%eax
void add_thread(int *pid,void *ustack){
 784:	89 e5                	mov    %esp,%ebp
			threads[i].pid=*pid;
 786:	c1 e0 02             	shl    $0x2,%eax
 789:	8b 55 08             	mov    0x8(%ebp),%edx
 78c:	8b 0a                	mov    (%edx),%ecx
 78e:	8d 90 60 0d 00 00    	lea    0xd60(%eax),%edx
			threads[i].ustack=ustack;
			threads[i].used=1;
 794:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
			threads[i].pid=*pid;
 79b:	89 88 60 0d 00 00    	mov    %ecx,0xd60(%eax)
			threads[i].ustack=ustack;
...
000007b0 <remove_thread>:

void remove_thread(int *pid)
{
 7b0:	55                   	push   %ebp
 7b1:	b8 60 0d 00 00       	mov    $0xd60,%eax
    int i;
	for(i=0;i<NTHREAD;i++){
 7b6:	31 d2                	xor    %edx,%edx
{
 7b8:	89 e5                	mov    %esp,%ebp
 7ba:	56                   	push   %esi
 7bb:	53                   	push   %ebx
 7bc:	8b 4d 08             	mov    0x8(%ebp),%ecx
    	if(threads[i].used && threads[i].pid==*pid)
 7bf:	8b 58 08             	mov    0x8(%eax),%ebx
 7c2:	85 db                	test   %ebx,%ebx
 7c4:	74 06                	je     7cc <remove_thread+0x1c>
 7c6:	8b 31                	mov    (%ecx),%esi
 7c8:	39 30                	cmp    %esi,(%eax)
 7ca:	74 14                	je     7e0 <remove_thread+0x30>
	for(i=0;i<NTHREAD;i++){
 7cc:	83 c2 01             	add    $0x1,%edx
 7cf:	83 c0 0c             	add    $0xc,%eax
 7d2:	83 fa 04             	cmp    $0x4,%edx
 7d5:	75 e8                	jne    7bf <remove_thread+0xf>
    		threads[i].ustack=0;
    		threads[i].used=0;
    		break;
    	}
 ...
 7e0:	8d 1c 52             	lea    (%edx,%edx,2),%ebx
 7e3:	83 ec 0c             	sub    $0xc,%esp
 7e6:	c1 e3 02             	shl    $0x2,%ebx
 7e9:	ff b3 64 0d 00 00    	pushl  0xd64(%ebx)
 7ef:	e8 dc fd ff ff       	call   5d0 <free>
    		threads[i].pid=0;
 7f4:	c7 83 60 0d 00 00 00 	movl   $0x0,0xd60(%ebx)
 7fb:	00 00 00 
    		threads[i].ustack=0;
 7fe:	c7 83 64 0d 00 00 00 	movl   $0x0,0xd64(%ebx)
 805:	00 00 00 
    		break;
 808:	83 c4 10             	add    $0x10,%esp
    		threads[i].used=0;
 80b:	c7 83 68 0d 00 00 00 	movl   $0x0,0xd68(%ebx)
 812:	00 00 00 
}
...
int thread_create(void(*start_routine)(void*),void* arg){
 ...
 824:	83 ec 04             	sub    $0x4,%esp
	...
	static int first=1;
	if(first){
 827:	a1 24 0d 00 00       	mov    0xd24,%eax
 82c:	85 c0                	test   %eax,%eax
 82e:	74 2d                	je     85d <thread_create+0x3d>
		first=0;
 830:	c7 05 24 0d 00 00 00 	movl   $0x0,0xd24
 837:	00 00 00 
 83a:	b8 60 0d 00 00       	mov    $0xd60,%eax
		int i;
		for(i=0;i<NTHREAD;i++){
			threads[i].pid=0;
 83f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			threads[i].ustack=0;
 845:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 84c:	83 c0 0c             	add    $0xc,%eax
			threads[i].used=0;
 84f:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
		for(i=0;i<NTHREAD;i++){
 856:	3d 90 0d 00 00       	cmp    $0xd90,%eax
 85b:	75 e2                	jne    83f <thread_create+0x1f>
		}
	}
	void *stack=malloc(PGSIZE);//allocate one page for user stack
 85d:	83 ec 0c             	sub    $0xc,%esp
 860:	68 00 10 00 00       	push   $0x1000
 865:	e8 f6 fd ff ff       	call   660 <malloc>
 ...
 876:	e8 bf fa ff ff       	call   33a <clone>
 87b:	b9 60 0d 00 00       	mov    $0xd60,%ecx
 880:	83 c4 10             	add    $0x10,%esp
	for(i=0;i<NTHREAD;i++){
 883:	31 d2                	xor    %edx,%edx
		if(threads[i].used==0){
 885:	83 79 08 00          	cmpl   $0x0,0x8(%ecx)
 889:	74 15                	je     8a0 <thread_create+0x80>
	for(i=0;i<NTHREAD;i++){
 88b:	83 c2 01             	add    $0x1,%edx
 88e:	83 c1 0c             	add    $0xc,%ecx
 891:	83 fa 04             	cmp    $0x4,%edx
 894:	75 ef                	jne    885 <thread_create+0x65>
	add_thread(&pid,stack);//save new thread to thread table
	return pid;
}
 896:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 899:	c9                   	leave  
 89a:	c3                   	ret    
 89b:	90                   	nop
 89c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
			threads[i].pid=*pid;
 8a0:	8d 14 52             	lea    (%edx,%edx,2),%edx
 8a3:	c1 e2 02             	shl    $0x2,%edx
			threads[i].ustack=ustack;
 8a6:	89 9a 64 0d 00 00    	mov    %ebx,0xd64(%edx)
			threads[i].pid=*pid;
 8ac:	89 82 60 0d 00 00    	mov    %eax,0xd60(%edx)
			threads[i].used=1;
 8b2:	c7 82 68 0d 00 00 01 	movl   $0x1,0xd68(%edx)
 8b9:	00 00 00 
}
 8bc:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 8bf:	c9                   	leave  
 8c0:	c3                   	ret    
 8c1:	eb 0d                	jmp    8d0 <thread_join>
 8c3:	90                   	nop
 8c4:	90                   	nop
 8c5:	90                   	nop
 8c6:	90                   	nop
...
int thread_join(void){
 ...
 8d3:	53                   	push   %ebx
 8d4:	bb 60 0d 00 00       	mov    $0xd60,%ebx
 ...
 8e2:	83 c3 0c             	add    $0xc,%ebx
	for(i=0;i<NTHREAD;i++){
 8e5:	81 fb 90 0d 00 00    	cmp    $0xd90,%ebx
 ...
 8fe:	50                   	push   %eax
 8ff:	e8 3e fa ff ff       	call   342 <join>
			if(pid>0){
 ...
 914:	50                   	push   %eax
 915:	e8 96 fe ff ff       	call   7b0 <remove_thread>
				return pid;
...
void printTCB(void){
 ...
 93c:	ff 34 85 68 0d 00 00 	pushl  0xd68(,%eax,4)
 943:	53                   	push   %ebx
	for(i=0;i<NTHREAD;i++)
 944:	83 c3 01             	add    $0x1,%ebx
		printf(1,"TCB %d: %d\n",i,threads[i].used);
 947:	68 99 09 00 00       	push   $0x999
 94c:	6a 01                	push   $0x1
 94e:	e8 ad fa ff ff       	call   400 <printf>
	for(i=0;i<NTHREAD;i++)
