...
main(int argc, char *argv[])
{
  ...
  28:	68 a0 09 00 00       	push   $0x9a0
  2d:	50                   	push   %eax
  2e:	68 a2 09 00 00       	push   $0x9a2
  33:	6a 01                	push   $0x1
  ...
  47:	68 ca 09 00 00       	push   $0x9ca
  4c:	50                   	push   %eax
  4d:	68 a2 09 00 00       	push   $0x9a2
  52:	6a 01                	push   $0x1
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 3d7:	f7 f1                	div    %ecx
 3d9:	0f b6 92 b0 09 00 00 	movzbl 0x9b0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb a7 09 00 00       	mov    $0x9a7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 40 0d 00 00       	mov    0xd40,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 40 0d 00 00       	mov    %eax,0xd40
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 40 0d 00 00    	mov    0xd40,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 40 0d 00 00    	cmp    %eax,0xd40
 6f7:	89 c2                	mov    %eax,%edx
 6f9:	75 ed                	jne    6e8 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
 6fb:	83 ec 0c             	sub    $0xc,%esp
 6fe:	56                   	push   %esi
 6ff:	e8 4e fc ff ff       	call   352 <sbrk>
  if(p == (char*)-1)
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 40 0d 00 00    	mov    0xd40,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 40 0d 00 00    	mov    %edx,0xd40
}
 ...
 767:	0d 00 00 
 76a:	c7 05 44 0d 00 00 44 	movl   $0xd44,0xd44
 771:	0d 00 00 
    base.s.size = 0;
 774:	b8 44 0d 00 00       	mov    $0xd44,%eax
 779:	c7 05 48 0d 00 00 00 	movl   $0x0,0xd48
 780:	00 00 00 
...
void add_thread(int* pid, void* ustack){
 7a0:	ba 60 0d 00 00       	mov    $0xd60,%edx
    for (int i = 0; i < NTHREAD; ++i)
 7a5:	31 c0                	xor    %eax,%eax
    {
        if(threads[i].used == 0){
 7a7:	8b 4a 08             	mov    0x8(%edx),%ecx
 7aa:	85 c9                	test   %ecx,%ecx
 7ac:	74 12                	je     7c0 <add_thread+0x20>
    for (int i = 0; i < NTHREAD; ++i)
 7ae:	83 c0 01             	add    $0x1,%eax
 7b1:	83 c2 0c             	add    $0xc,%edx
 7b4:	83 f8 04             	cmp    $0x4,%eax
 7b7:	75 ee                	jne    7a7 <add_thread+0x7>
 7b9:	f3 c3                	repz ret 
 7bb:	90                   	nop
...
void add_thread(int* pid, void* ustack){
 7c0:	55                   	push   %ebp
            threads[i].pid = *pid;
 7c1:	8d 04 40             	lea    (%eax,%eax,2),%eax
void add_thread(int* pid, void* ustack){
 7c4:	89 e5                	mov    %esp,%ebp
            threads[i].pid = *pid;
 7c6:	c1 e0 02             	shl    $0x2,%eax
 7c9:	8b 55 08             	mov    0x8(%ebp),%edx
 7cc:	8b 0a                	mov    (%edx),%ecx
 7ce:	8d 90 60 0d 00 00    	lea    0xd60(%eax),%edx
            threads[i].ustack = ustack;
            threads[i].used = 1;
 7d4:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            threads[i].pid = *pid;
 7db:	89 88 60 0d 00 00    	mov    %ecx,0xd60(%eax)
            threads[i].ustack = ustack;
...
000007f0 <remove_thread>:

void remove_thread(int* pid){
 7f0:	55                   	push   %ebp
 7f1:	b8 60 0d 00 00       	mov    $0xd60,%eax
    for (int i = 0; i < NTHREAD; ++i)
...
void remove_thread(int* pid){
 ...
 7ff:	8b 58 08             	mov    0x8(%eax),%ebx
 802:	85 db                	test   %ebx,%ebx
 804:	74 06                	je     80c <remove_thread+0x1c>
 806:	8b 31                	mov    (%ecx),%esi
 808:	39 30                	cmp    %esi,(%eax)
 80a:	74 14                	je     820 <remove_thread+0x30>
    for (int i = 0; i < NTHREAD; ++i)
 80c:	83 c2 01             	add    $0x1,%edx
 80f:	83 c0 0c             	add    $0xc,%eax
 812:	83 fa 04             	cmp    $0x4,%edx
 815:	75 e8                	jne    7ff <remove_thread+0xf>
            threads[i].ustack = 0;
            threads[i].used = 0;
            break;
        }
 ...
 820:	8d 1c 52             	lea    (%edx,%edx,2),%ebx
 823:	83 ec 0c             	sub    $0xc,%esp
 826:	c1 e3 02             	shl    $0x2,%ebx
 829:	ff b3 64 0d 00 00    	pushl  0xd64(%ebx)
 82f:	e8 dc fd ff ff       	call   610 <free>
            threads[i].pid = 0;
 834:	c7 83 60 0d 00 00 00 	movl   $0x0,0xd60(%ebx)
 83b:	00 00 00 
            threads[i].ustack = 0;
 83e:	c7 83 64 0d 00 00 00 	movl   $0x0,0xd64(%ebx)
 845:	00 00 00 
            break;
 848:	83 c4 10             	add    $0x10,%esp
            threads[i].used = 0;
 84b:	c7 83 68 0d 00 00 00 	movl   $0x0,0xd68(%ebx)
 852:	00 00 00 
}
 855:	8d 65 f8             	lea    -0x8(%ebp),%esp
 858:	5b                   	pop    %ebx
 859:	5e                   	pop    %esi
 85a:	5d                   	pop    %ebp
 85b:	c3                   	ret    
...
int thread_create(void(*start_routine)(void*), void *arg){
 ...
 864:	83 ec 04             	sub    $0x4,%esp
    static int first = 1;
    if(first){
 867:	a1 30 0d 00 00       	mov    0xd30,%eax
 86c:	85 c0                	test   %eax,%eax
 86e:	74 2d                	je     89d <thread_create+0x3d>
        first = 0;
 870:	c7 05 30 0d 00 00 00 	movl   $0x0,0xd30
 877:	00 00 00 
 87a:	b8 60 0d 00 00       	mov    $0xd60,%eax
        for (int i = 0; i < NTHREAD; ++i)
        {
            threads[i].pid = 0;
 87f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
            threads[i].ustack = 0;
 885:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 88c:	83 c0 0c             	add    $0xc,%eax
            threads[i].used = 0;
 88f:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
        for (int i = 0; i < NTHREAD; ++i)
 896:	3d 90 0d 00 00       	cmp    $0xd90,%eax
 89b:	75 e2                	jne    87f <thread_create+0x1f>
        }
    }
    void *stack = malloc(PGSIZE);
 89d:	83 ec 0c             	sub    $0xc,%esp
 8a0:	68 00 10 00 00       	push   $0x1000
 8a5:	e8 f6 fd ff ff       	call   6a0 <malloc>
 ...
 8ad:	89 c3                	mov    %eax,%ebx
    int pid = clone(start_routine, arg, stack);
 8af:	50                   	push   %eax
 8b0:	ff 75 0c             	pushl  0xc(%ebp)
 8b3:	ff 75 08             	pushl  0x8(%ebp)
 8b6:	e8 bf fa ff ff       	call   37a <clone>
 8bb:	b9 60 0d 00 00       	mov    $0xd60,%ecx
 8c0:	83 c4 10             	add    $0x10,%esp
    for (int i = 0; i < NTHREAD; ++i)
 8c3:	31 d2                	xor    %edx,%edx
        if(threads[i].used == 0){
 8c5:	83 79 08 00          	cmpl   $0x0,0x8(%ecx)
 8c9:	74 15                	je     8e0 <thread_create+0x80>
    for (int i = 0; i < NTHREAD; ++i)
 8cb:	83 c2 01             	add    $0x1,%edx
 8ce:	83 c1 0c             	add    $0xc,%ecx
 8d1:	83 fa 04             	cmp    $0x4,%edx
 8d4:	75 ef                	jne    8c5 <thread_create+0x65>
 ...
 8dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            threads[i].pid = *pid;
 8e0:	8d 14 52             	lea    (%edx,%edx,2),%edx
 8e3:	c1 e2 02             	shl    $0x2,%edx
            threads[i].ustack = ustack;
 8e6:	89 9a 64 0d 00 00    	mov    %ebx,0xd64(%edx)
            threads[i].pid = *pid;
 8ec:	89 82 60 0d 00 00    	mov    %eax,0xd60(%edx)
            threads[i].used = 1;
 8f2:	c7 82 68 0d 00 00 01 	movl   $0x1,0xd68(%edx)
 8f9:	00 00 00 
}
 8fc:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 8ff:	c9                   	leave  
 900:	c3                   	ret    
 901:	eb 0d                	jmp    910 <thread_join>
 903:	90                   	nop
 904:	90                   	nop
 905:	90                   	nop
 906:	90                   	nop
...
int thread_join(void){
 ...
 913:	53                   	push   %ebx
 914:	bb 60 0d 00 00       	mov    $0xd60,%ebx
 919:	83 ec 14             	sub    $0x14,%esp
    for(int i = 0; i < NTHREAD; ++i){
        if(threads[i].used == 1){
 91c:	83 7b 08 01          	cmpl   $0x1,0x8(%ebx)
 920:	74 16                	je     938 <thread_join+0x28>
 922:	83 c3 0c             	add    $0xc,%ebx
    for(int i = 0; i < NTHREAD; ++i){
 925:	81 fb 90 0d 00 00    	cmp    $0xd90,%ebx
 92b:	75 ef                	jne    91c <thread_join+0xc>
                remove_thread(&pid);
                return pid;
            }
        }
 ...
 938:	8d 43 04             	lea    0x4(%ebx),%eax
 93b:	83 ec 0c             	sub    $0xc,%esp
 93e:	50                   	push   %eax
 93f:	e8 3e fa ff ff       	call   382 <join>
            if(pid > 0){
 ...
 949:	89 45 f4             	mov    %eax,-0xc(%ebp)
            if(pid > 0){
 94c:	7e d4                	jle    922 <thread_join+0x12>
                remove_thread(&pid);
 94e:	8d 45 f4             	lea    -0xc(%ebp),%eax
 951:	83 ec 0c             	sub    $0xc,%esp
 954:	50                   	push   %eax
 955:	e8 96 fe ff ff       	call   7f0 <remove_thread>
                return pid;
 95a:	8b 45 f4             	mov    -0xc(%ebp),%eax
 95d:	83 c4 10             	add    $0x10,%esp
 960:	eb cd                	jmp    92f <thread_join+0x1f>
...
void printTCB(void){
 ...
 973:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 974:	31 db                	xor    %ebx,%ebx
void printTCB(void){
 976:	83 ec 04             	sub    $0x4,%esp
    {
        printf(1,"TCB %d:%d\n",i,threads[i].used);
 979:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
 97c:	ff 34 85 68 0d 00 00 	pushl  0xd68(,%eax,4)
 983:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 984:	83 c3 01             	add    $0x1,%ebx
        printf(1,"TCB %d:%d\n",i,threads[i].used);
 987:	68 c1 09 00 00       	push   $0x9c1
 98c:	6a 01                	push   $0x1
 98e:	e8 ad fa ff ff       	call   440 <printf>
    for (int i = 0; i < NTHREAD; ++i)
 993:	83 c4 10             	add    $0x10,%esp
 996:	83 fb 04             	cmp    $0x4,%ebx
 999:	75 de                	jne    979 <printTCB+0x9>
    }
