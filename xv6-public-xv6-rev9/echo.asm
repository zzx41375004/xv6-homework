...
main(int argc, char *argv[])
{
  ...
  28:	68 90 09 00 00       	push   $0x990
  2d:	50                   	push   %eax
  2e:	68 92 09 00 00       	push   $0x992
  33:	6a 01                	push   $0x1
  ...
  47:	68 be 09 00 00       	push   $0x9be
  4c:	50                   	push   %eax
  4d:	68 92 09 00 00       	push   $0x992
  52:	6a 01                	push   $0x1
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 3d7:	f7 f1                	div    %ecx
 3d9:	0f b6 92 a0 09 00 00 	movzbl 0x9a0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb 97 09 00 00       	mov    $0x997,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 a0 0d 00 00       	mov    0xda0,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 a0 0d 00 00       	mov    %eax,0xda0
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 a0 0d 00 00       	mov    %eax,0xda0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 a0 0d 00 00    	cmp    %eax,0xda0
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 a0 0d 00 00    	mov    %edx,0xda0
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 a0 0d 00 00 a4 	movl   $0xda4,0xda0
 767:	0d 00 00 
 76a:	c7 05 a4 0d 00 00 a4 	movl   $0xda4,0xda4
 771:	0d 00 00 
    base.s.size = 0;
 774:	b8 a4 0d 00 00       	mov    $0xda4,%eax
 779:	c7 05 a8 0d 00 00 00 	movl   $0x0,0xda8
 780:	00 00 00 
...
{
 7a0:	55                   	push   %ebp
 7a1:	b8 c0 0d 00 00       	mov    $0xdc0,%eax
 ...
 7a6:	31 d2                	xor    %edx,%edx
{
 ...
 7d9:	ff b3 c4 0d 00 00    	pushl  0xdc4(%ebx)
 7df:	e8 2c fe ff ff       	call   610 <free>
            threads[i].pid = 0;
 7e4:	c7 83 c0 0d 00 00 00 	movl   $0x0,0xdc0(%ebx)
 7eb:	00 00 00 
            threads[i].ustack = 0;
 7ee:	c7 83 c4 0d 00 00 00 	movl   $0x0,0xdc4(%ebx)
 7f5:	00 00 00 
            break;
 7f8:	83 c4 10             	add    $0x10,%esp
            threads[i].used = 0;
 7fb:	c7 83 c8 0d 00 00 00 	movl   $0x0,0xdc8(%ebx)
 802:	00 00 00 
}
...
{
 810:	55                   	push   %ebp
 811:	ba c0 0d 00 00       	mov    $0xdc0,%edx
    for (int i = 0; i < NTHREAD; ++i)
 816:	31 c0                	xor    %eax,%eax
{
 818:	89 e5                	mov    %esp,%ebp
    {
        if (threads[i].used == 0)
 81a:	8b 4a 08             	mov    0x8(%edx),%ecx
 81d:	85 c9                	test   %ecx,%ecx
 81f:	74 10                	je     831 <findPos+0x21>
    for (int i = 0; i < NTHREAD; ++i)
 821:	83 c0 01             	add    $0x1,%eax
 824:	83 c2 0c             	add    $0xc,%edx
 827:	83 f8 04             	cmp    $0x4,%eax
 82a:	75 ee                	jne    81a <findPos+0xa>
        {
            return i;
        }
    }
...
{
 840:	55                   	push   %ebp
 841:	b8 c0 0d 00 00       	mov    $0xdc0,%eax
 ...
 84a:	31 db                	xor    %ebx,%ebx
{
 84c:	83 ec 10             	sub    $0x10,%esp
        if (threads[i].used == 0)
 84f:	8b 50 08             	mov    0x8(%eax),%edx
 852:	85 d2                	test   %edx,%edx
 854:	74 2a                	je     880 <thread_create+0x40>
    for (int i = 0; i < NTHREAD; ++i)
 856:	83 c3 01             	add    $0x1,%ebx
 859:	83 c0 0c             	add    $0xc,%eax
 85c:	83 fb 04             	cmp    $0x4,%ebx
 85f:	75 ee                	jne    84f <thread_create+0xf>
    int pos = findPos();
    if (pos == -1)
    {
        printf(1, "Create thread failed! Perhaps because there are too many threads!\n");
 861:	83 ec 08             	sub    $0x8,%esp
 864:	68 cc 09 00 00       	push   $0x9cc
 869:	6a 01                	push   $0x1
 86b:	e8 d0 fb ff ff       	call   440 <printf>
        return -1;
 ...
 883:	68 00 10 00 00       	push   $0x1000
 888:	e8 13 fe ff ff       	call   6a0 <malloc>
    int pid = clone(start_routine, arg, stack);
 88d:	83 c4 0c             	add    $0xc,%esp
    void *stack = malloc(PGSIZE);
 ...
 899:	e8 dc fa ff ff       	call   37a <clone>
    if (pid == -1)
 89e:	83 c4 10             	add    $0x10,%esp
 8a1:	83 f8 ff             	cmp    $0xffffffff,%eax
 8a4:	74 2a                	je     8d0 <thread_create+0x90>
        threads[pos].pid = pid;
 8a6:	8d 14 5b             	lea    (%ebx,%ebx,2),%edx
 8a9:	c1 e2 02             	shl    $0x2,%edx
        threads[pos].ustack = stack;
 8ac:	89 b2 c4 0d 00 00    	mov    %esi,0xdc4(%edx)
        threads[pos].pid = pid;
 8b2:	89 82 c0 0d 00 00    	mov    %eax,0xdc0(%edx)
        threads[pos].used = 1;
 8b8:	c7 82 c8 0d 00 00 01 	movl   $0x1,0xdc8(%edx)
 8bf:	00 00 00 
}
 ...
 8d6:	68 b1 09 00 00       	push   $0x9b1
 8db:	6a 01                	push   $0x1
 8dd:	e8 5e fb ff ff       	call   440 <printf>
        free(stack);
 8e2:	89 34 24             	mov    %esi,(%esp)
 8e5:	e8 26 fd ff ff       	call   610 <free>
 8ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8ed:	83 c4 10             	add    $0x10,%esp
}
 8f0:	8d 65 f8             	lea    -0x8(%ebp),%esp
 8f3:	5b                   	pop    %ebx
 8f4:	5e                   	pop    %esi
 8f5:	5d                   	pop    %ebp
 8f6:	c3                   	ret    
...
int thread_join(void)
{
 ...
 903:	53                   	push   %ebx
 904:	bb c0 0d 00 00       	mov    $0xdc0,%ebx
 909:	83 ec 14             	sub    $0x14,%esp
    for (int i = 0; i < NTHREAD; ++i)
    {
        if (threads[i].used == 1)
 90c:	83 7b 08 01          	cmpl   $0x1,0x8(%ebx)
 910:	74 16                	je     928 <thread_join+0x28>
 912:	83 c3 0c             	add    $0xc,%ebx
    for (int i = 0; i < NTHREAD; ++i)
 915:	81 fb f0 0d 00 00    	cmp    $0xdf0,%ebx
 91b:	75 ef                	jne    90c <thread_join+0xc>
                remove_thread(&pid);
                return pid;
            }
        }
 ...
 928:	8d 43 04             	lea    0x4(%ebx),%eax
 92b:	83 ec 0c             	sub    $0xc,%esp
 92e:	50                   	push   %eax
 92f:	e8 4e fa ff ff       	call   382 <join>
            if (pid > 0)
 ...
 939:	89 45 f4             	mov    %eax,-0xc(%ebp)
            if (pid > 0)
 93c:	7e d4                	jle    912 <thread_join+0x12>
                remove_thread(&pid);
 93e:	8d 45 f4             	lea    -0xc(%ebp),%eax
 941:	83 ec 0c             	sub    $0xc,%esp
 944:	50                   	push   %eax
 945:	e8 56 fe ff ff       	call   7a0 <remove_thread>
                return pid;
 94a:	8b 45 f4             	mov    -0xc(%ebp),%eax
 94d:	83 c4 10             	add    $0x10,%esp
 950:	eb cd                	jmp    91f <thread_join+0x1f>
...
void printTCB(void)
{
 ...
 963:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 964:	31 db                	xor    %ebx,%ebx
{
 966:	83 ec 04             	sub    $0x4,%esp
    {
        printf(1, "TCB %d:%d\n", i, threads[i].used);
 969:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
 96c:	ff 34 85 c8 0d 00 00 	pushl  0xdc8(,%eax,4)
 973:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 974:	83 c3 01             	add    $0x1,%ebx
        printf(1, "TCB %d:%d\n", i, threads[i].used);
 977:	68 c0 09 00 00       	push   $0x9c0
 97c:	6a 01                	push   $0x1
 97e:	e8 bd fa ff ff       	call   440 <printf>
    for (int i = 0; i < NTHREAD; ++i)
 983:	83 c4 10             	add    $0x10,%esp
 986:	83 fb 04             	cmp    $0x4,%ebx
 989:	75 de                	jne    969 <printTCB+0x9>
    }
}
