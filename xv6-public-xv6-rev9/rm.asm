 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 e4 09 00 00 	movzbl 0x9e4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb dd 09 00 00       	mov    $0x9dd,%ebx
        while(*s != 0){
...
int thread_create(void(*start_routine)(void*), void *arg){
 ...
 874:	83 ec 04             	sub    $0x4,%esp
    static int first = 1;
    if(first){
 877:	a1 68 0d 00 00       	mov    0xd68,%eax
 87c:	85 c0                	test   %eax,%eax
 87e:	74 2d                	je     8ad <thread_create+0x3d>
        first = 0;
 880:	c7 05 68 0d 00 00 00 	movl   $0x0,0xd68
 887:	00 00 00 
