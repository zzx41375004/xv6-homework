 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 d4 09 00 00 	movzbl 0x9d4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb cd 09 00 00       	mov    $0x9cd,%ebx
        while(*s != 0){
...
{
 7b0:	55                   	push   %ebp
 7b1:	b8 e0 0d 00 00       	mov    $0xde0,%eax
 ...
 7b6:	31 d2                	xor    %edx,%edx
{
 ...
 7e9:	ff b3 e4 0d 00 00    	pushl  0xde4(%ebx)
 7ef:	e8 2c fe ff ff       	call   620 <free>
            threads[i].pid = 0;
 7f4:	c7 83 e0 0d 00 00 00 	movl   $0x0,0xde0(%ebx)
 7fb:	00 00 00 
            threads[i].ustack = 0;
 7fe:	c7 83 e4 0d 00 00 00 	movl   $0x0,0xde4(%ebx)
 805:	00 00 00 
            break;
 808:	83 c4 10             	add    $0x10,%esp
            threads[i].used = 0;
 80b:	c7 83 e8 0d 00 00 00 	movl   $0x0,0xde8(%ebx)
 812:	00 00 00 
}
...
{
 820:	55                   	push   %ebp
 821:	ba e0 0d 00 00       	mov    $0xde0,%edx
    for (int i = 0; i < NTHREAD; ++i)
...
{
 850:	55                   	push   %ebp
 851:	b8 e0 0d 00 00       	mov    $0xde0,%eax
 ...
 85a:	31 db                	xor    %ebx,%ebx
{
 ...
 8b9:	c1 e2 02             	shl    $0x2,%edx
        threads[pos].ustack = stack;
 8bc:	89 b2 e4 0d 00 00    	mov    %esi,0xde4(%edx)
        threads[pos].pid = pid;
 8c2:	89 82 e0 0d 00 00    	mov    %eax,0xde0(%edx)
        threads[pos].used = 1;
 8c8:	c7 82 e8 0d 00 00 01 	movl   $0x1,0xde8(%edx)
 8cf:	00 00 00 
}
...
int thread_join(void)
{
 ...
 913:	53                   	push   %ebx
 914:	bb e0 0d 00 00       	mov    $0xde0,%ebx
 ...
 922:	83 c3 0c             	add    $0xc,%ebx
    for (int i = 0; i < NTHREAD; ++i)
 925:	81 fb 10 0e 00 00    	cmp    $0xe10,%ebx
 ...
 974:	31 db                	xor    %ebx,%ebx
{
 ...
 97c:	ff 34 85 e8 0d 00 00 	pushl  0xde8(,%eax,4)
 983:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 984:	83 c3 01             	add    $0x1,%ebx
        printf(1, "TCB %d:%d\n", i, threads[i].used);
 987:	68 f4 09 00 00       	push   $0x9f4
 98c:	6a 01                	push   $0x1
