...
_a-zzx-app:     file format elf32-i386
...
main(int argc, char const *argv[])
{
   ...
   e:	83 ec 0c             	sub    $0xc,%esp
    printf(1,"This is a app made by zzx.\n");
  11:	68 50 09 00 00       	push   $0x950
  16:	6a 01                	push   $0x1
 ...
 359:	85 d2                	test   %edx,%edx
{
 ...
 387:	f7 f1                	div    %ecx
 389:	0f b6 92 74 09 00 00 	movzbl 0x974(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb 6c 09 00 00       	mov    $0x96c,%ebx
        while(*s != 0){
...
int thread_create(void(*start_routine)(void*), void *arg){
 ...
 814:	83 ec 04             	sub    $0x4,%esp
    static int first = 1;
    if(first){
 817:	a1 ec 0c 00 00       	mov    0xcec,%eax
 81c:	85 c0                	test   %eax,%eax
 81e:	74 2d                	je     84d <thread_create+0x3d>
        first = 0;
 820:	c7 05 ec 0c 00 00 00 	movl   $0x0,0xcec
 827:	00 00 00 
