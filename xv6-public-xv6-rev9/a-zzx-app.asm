 ...
 359:	85 d2                	test   %edx,%edx
{
 ...
 387:	f7 f1                	div    %ecx
 389:	0f b6 92 64 09 00 00 	movzbl 0x964(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb 5c 09 00 00       	mov    $0x95c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 60 0d 00 00       	mov    0xd60,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 60 0d 00 00       	mov    %eax,0xd60
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 60 0d 00 00       	mov    %eax,0xd60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 60 0d 00 00    	mov    0xd60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 47                	jae    6e8 <malloc+0x98>
    ...
    if(p == freep)
 6a1:	39 05 60 0d 00 00    	cmp    %eax,0xd60
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 60 0d 00 00    	mov    0xd60,%edx
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 60 0d 00 00    	mov    %edx,0xd60
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 60 0d 00 00 64 	movl   $0xd64,0xd60
 717:	0d 00 00 
 71a:	c7 05 64 0d 00 00 64 	movl   $0xd64,0xd64
 721:	0d 00 00 
    base.s.size = 0;
 724:	b8 64 0d 00 00       	mov    $0xd64,%eax
 729:	c7 05 68 0d 00 00 00 	movl   $0x0,0xd68
 730:	00 00 00 
...
void remove_thread(int* pid){
 750:	55                   	push   %ebp
 751:	b8 80 0d 00 00       	mov    $0xd80,%eax
...
void remove_thread(int* pid){
 ...
 789:	ff b3 84 0d 00 00    	pushl  0xd84(%ebx)
 78f:	e8 2c fe ff ff       	call   5c0 <free>
            threads[i].pid = 0;
 794:	c7 83 80 0d 00 00 00 	movl   $0x0,0xd80(%ebx)
 79b:	00 00 00 
            threads[i].ustack = 0;
 79e:	c7 83 84 0d 00 00 00 	movl   $0x0,0xd84(%ebx)
 7a5:	00 00 00 
            break;
 7a8:	83 c4 10             	add    $0x10,%esp
            threads[i].used = 0;
 7ab:	c7 83 88 0d 00 00 00 	movl   $0x0,0xd88(%ebx)
 7b2:	00 00 00 
}
...
int findPos(){
 7c0:	55                   	push   %ebp
 7c1:	ba 80 0d 00 00       	mov    $0xd80,%edx
    for (int i = 0; i < NTHREAD; ++i)
...
int thread_create(void(*start_routine)(void*), void *arg){
 ...
 859:	c1 e2 02             	shl    $0x2,%edx
        threads[pos].ustack = stack;
 85c:	89 b2 84 0d 00 00    	mov    %esi,0xd84(%edx)
        threads[pos].pid = pid;
 862:	89 82 80 0d 00 00    	mov    %eax,0xd80(%edx)
        threads[pos].used = 1; 
 868:	c7 82 88 0d 00 00 01 	movl   $0x1,0xd88(%edx)
 86f:	00 00 00 
}
...
int thread_join(void){
 ...
 8b3:	53                   	push   %ebx
 8b4:	bb 80 0d 00 00       	mov    $0xd80,%ebx
 ...
 8c2:	83 c3 0c             	add    $0xc,%ebx
    for(int i = 0; i < NTHREAD; ++i){
 8c5:	81 fb b0 0d 00 00    	cmp    $0xdb0,%ebx
...
void printTCB(void){
 ...
 91c:	ff 34 85 88 0d 00 00 	pushl  0xd88(,%eax,4)
 923:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 924:	83 c3 01             	add    $0x1,%ebx
        printf(1,"TCB %d:%d\n",i,threads[i].used);
 927:	68 84 09 00 00       	push   $0x984
 92c:	6a 01                	push   $0x1
