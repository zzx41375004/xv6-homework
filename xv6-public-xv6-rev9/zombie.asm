 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 58 09 00 00 	movzbl 0x958(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 50 09 00 00       	mov    $0x950,%ebx
        while(*s != 0){
...
{
 760:	55                   	push   %ebp
 761:	b8 60 0d 00 00       	mov    $0xd60,%eax
 ...
 766:	31 d2                	xor    %edx,%edx
{
 ...
 799:	ff b3 64 0d 00 00    	pushl  0xd64(%ebx)
 79f:	e8 2c fe ff ff       	call   5d0 <free>
            threads[i].pid = 0;
 7a4:	c7 83 60 0d 00 00 00 	movl   $0x0,0xd60(%ebx)
 7ab:	00 00 00 
            threads[i].ustack = 0;
 7ae:	c7 83 64 0d 00 00 00 	movl   $0x0,0xd64(%ebx)
 7b5:	00 00 00 
            break;
 7b8:	83 c4 10             	add    $0x10,%esp
            threads[i].used = 0;
 7bb:	c7 83 68 0d 00 00 00 	movl   $0x0,0xd68(%ebx)
 7c2:	00 00 00 
}
...
{
 7d0:	55                   	push   %ebp
 7d1:	ba 60 0d 00 00       	mov    $0xd60,%edx
    for (int i = 0; i < NTHREAD; ++i)
...
{
 800:	55                   	push   %ebp
 801:	b8 60 0d 00 00       	mov    $0xd60,%eax
 ...
 80a:	31 db                	xor    %ebx,%ebx
{
 ...
 869:	c1 e2 02             	shl    $0x2,%edx
        threads[pos].ustack = stack;
 86c:	89 b2 64 0d 00 00    	mov    %esi,0xd64(%edx)
        threads[pos].pid = pid;
 872:	89 82 60 0d 00 00    	mov    %eax,0xd60(%edx)
        threads[pos].used = 1;
 878:	c7 82 68 0d 00 00 01 	movl   $0x1,0xd68(%edx)
 87f:	00 00 00 
}
...
int thread_join(void)
{
 ...
 8c3:	53                   	push   %ebx
 8c4:	bb 60 0d 00 00       	mov    $0xd60,%ebx
 ...
 8d2:	83 c3 0c             	add    $0xc,%ebx
    for (int i = 0; i < NTHREAD; ++i)
 8d5:	81 fb 90 0d 00 00    	cmp    $0xd90,%ebx
 ...
 924:	31 db                	xor    %ebx,%ebx
{
 ...
 92c:	ff 34 85 68 0d 00 00 	pushl  0xd68(,%eax,4)
 933:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 934:	83 c3 01             	add    $0x1,%ebx
        printf(1, "TCB %d:%d\n", i, threads[i].used);
 937:	68 78 09 00 00       	push   $0x978
 93c:	6a 01                	push   $0x1
