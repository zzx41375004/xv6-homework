 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 8c 09 00 00 	movzbl 0x98c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 84 09 00 00       	mov    $0x984,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 80 0d 00 00       	mov    0xd80,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 80 0d 00 00       	mov    %eax,0xd80
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 80 0d 00 00       	mov    %eax,0xd80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 80 0d 00 00    	mov    0xd80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 80 0d 00 00    	cmp    %eax,0xd80
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 80 0d 00 00    	mov    0xd80,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 80 0d 00 00    	mov    %edx,0xd80
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 80 0d 00 00 84 	movl   $0xd84,0xd80
 747:	0d 00 00 
 74a:	c7 05 84 0d 00 00 84 	movl   $0xd84,0xd84
 751:	0d 00 00 
    base.s.size = 0;
 754:	b8 84 0d 00 00       	mov    $0xd84,%eax
 759:	c7 05 88 0d 00 00 00 	movl   $0x0,0xd88
 760:	00 00 00 
...
void remove_thread(int* pid){
 780:	55                   	push   %ebp
 781:	b8 a0 0d 00 00       	mov    $0xda0,%eax
...
void remove_thread(int* pid){
 ...
 7b9:	ff b3 a4 0d 00 00    	pushl  0xda4(%ebx)
 7bf:	e8 2c fe ff ff       	call   5f0 <free>
            threads[i].pid = 0;
 7c4:	c7 83 a0 0d 00 00 00 	movl   $0x0,0xda0(%ebx)
 7cb:	00 00 00 
            threads[i].ustack = 0;
 7ce:	c7 83 a4 0d 00 00 00 	movl   $0x0,0xda4(%ebx)
 7d5:	00 00 00 
            break;
 7d8:	83 c4 10             	add    $0x10,%esp
            threads[i].used = 0;
 7db:	c7 83 a8 0d 00 00 00 	movl   $0x0,0xda8(%ebx)
 7e2:	00 00 00 
}
...
int findPos(){
 7f0:	55                   	push   %ebp
 7f1:	ba a0 0d 00 00       	mov    $0xda0,%edx
    for (int i = 0; i < NTHREAD; ++i)
...
int thread_create(void(*start_routine)(void*), void *arg){
 820:	55                   	push   %ebp
 821:	b8 a0 0d 00 00       	mov    $0xda0,%eax
...
int thread_create(void(*start_routine)(void*), void *arg){
 ...
 889:	c1 e2 02             	shl    $0x2,%edx
        threads[pos].ustack = stack;
 88c:	89 b2 a4 0d 00 00    	mov    %esi,0xda4(%edx)
        threads[pos].pid = pid;
 892:	89 82 a0 0d 00 00    	mov    %eax,0xda0(%edx)
        threads[pos].used = 1; 
 898:	c7 82 a8 0d 00 00 01 	movl   $0x1,0xda8(%edx)
 89f:	00 00 00 
}
...
int thread_join(void){
 ...
 8e3:	53                   	push   %ebx
 8e4:	bb a0 0d 00 00       	mov    $0xda0,%ebx
 ...
 8f2:	83 c3 0c             	add    $0xc,%ebx
    for(int i = 0; i < NTHREAD; ++i){
 8f5:	81 fb d0 0d 00 00    	cmp    $0xdd0,%ebx
...
void printTCB(void){
 ...
 94c:	ff 34 85 a8 0d 00 00 	pushl  0xda8(,%eax,4)
 953:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 954:	83 c3 01             	add    $0x1,%ebx
        printf(1,"TCB %d:%d\n",i,threads[i].used);
 957:	68 ac 09 00 00       	push   $0x9ac
 95c:	6a 01                	push   $0x1
