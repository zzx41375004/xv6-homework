 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 3c7:	f7 f1                	div    %ecx
 3c9:	0f b6 92 ac 09 00 00 	movzbl 0x9ac(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb a4 09 00 00       	mov    $0x9a4,%ebx
        while(*s != 0){
...
int thread_create(void(*start_routine)(void*), void *arg){
 ...
 854:	83 ec 04             	sub    $0x4,%esp
    static int first = 1;
    if(first){
 857:	a1 2c 0d 00 00       	mov    0xd2c,%eax
