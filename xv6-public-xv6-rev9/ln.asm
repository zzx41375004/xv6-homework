 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 3c7:	f7 f1                	div    %ecx
 3c9:	0f b6 92 b0 09 00 00 	movzbl 0x9b0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb a7 09 00 00       	mov    $0x9a7,%ebx
        while(*s != 0){
 ...
 601:	a1 a0 0d 00 00       	mov    0xda0,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 a0 0d 00 00       	mov    %eax,0xda0
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 a0 0d 00 00       	mov    %eax,0xda0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
    ...
    if(p == freep)
 6e1:	39 05 a0 0d 00 00    	cmp    %eax,0xda0
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 a0 0d 00 00    	mov    %edx,0xda0
}
 ...
 757:	0d 00 00 
 75a:	c7 05 a4 0d 00 00 a4 	movl   $0xda4,0xda4
 761:	0d 00 00 
    base.s.size = 0;
 764:	b8 a4 0d 00 00       	mov    $0xda4,%eax
 769:	c7 05 a8 0d 00 00 00 	movl   $0x0,0xda8
 770:	00 00 00 
...
{
 790:	55                   	push   %ebp
 791:	b8 c0 0d 00 00       	mov    $0xdc0,%eax
 ...
 796:	31 d2                	xor    %edx,%edx
{
 ...
 7c9:	ff b3 c4 0d 00 00    	pushl  0xdc4(%ebx)
 7cf:	e8 2c fe ff ff       	call   600 <free>
            threads[i].pid = 0;
 7d4:	c7 83 c0 0d 00 00 00 	movl   $0x0,0xdc0(%ebx)
 7db:	00 00 00 
            threads[i].ustack = 0;
 7de:	c7 83 c4 0d 00 00 00 	movl   $0x0,0xdc4(%ebx)
 7e5:	00 00 00 
            break;
 7e8:	83 c4 10             	add    $0x10,%esp
            threads[i].used = 0;
 7eb:	c7 83 c8 0d 00 00 00 	movl   $0x0,0xdc8(%ebx)
 7f2:	00 00 00 
}
...
{
 800:	55                   	push   %ebp
 801:	ba c0 0d 00 00       	mov    $0xdc0,%edx
    for (int i = 0; i < NTHREAD; ++i)
...
{
 830:	55                   	push   %ebp
 831:	b8 c0 0d 00 00       	mov    $0xdc0,%eax
 ...
 83a:	31 db                	xor    %ebx,%ebx
{
 ...
 889:	e8 dc fa ff ff       	call   36a <clone>
    if (pid == -1)
 ...
 899:	c1 e2 02             	shl    $0x2,%edx
        threads[pos].ustack = stack;
 89c:	89 b2 c4 0d 00 00    	mov    %esi,0xdc4(%edx)
        threads[pos].pid = pid;
 8a2:	89 82 c0 0d 00 00    	mov    %eax,0xdc0(%edx)
        threads[pos].used = 1;
 8a8:	c7 82 c8 0d 00 00 01 	movl   $0x1,0xdc8(%edx)
 8af:	00 00 00 
}
...
int thread_join(void)
{
 ...
 8f3:	53                   	push   %ebx
 8f4:	bb c0 0d 00 00       	mov    $0xdc0,%ebx
 ...
 902:	83 c3 0c             	add    $0xc,%ebx
    for (int i = 0; i < NTHREAD; ++i)
 905:	81 fb f0 0d 00 00    	cmp    $0xdf0,%ebx
 ...
 954:	31 db                	xor    %ebx,%ebx
{
 ...
 95c:	ff 34 85 c8 0d 00 00 	pushl  0xdc8(,%eax,4)
 963:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 964:	83 c3 01             	add    $0x1,%ebx
        printf(1, "TCB %d:%d\n", i, threads[i].used);
 967:	68 d0 09 00 00       	push   $0x9d0
 96c:	6a 01                	push   $0x1
