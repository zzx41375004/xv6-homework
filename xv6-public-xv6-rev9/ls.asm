 ...
 659:	85 d2                	test   %edx,%edx
{
 ...
 687:	f7 f1                	div    %ecx
 689:	0f b6 92 94 0c 00 00 	movzbl 0xc94(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 8a4:	e9 8f fe ff ff       	jmp    738 <printf+0x48>
          s = "(null)";
 8a9:	bb 8a 0c 00 00       	mov    $0xc8a,%ebx
        while(*s != 0){
 ...
 8c1:	a1 10 11 00 00       	mov    0x1110,%eax
{
 ...
 8fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8ff:	a3 10 11 00 00       	mov    %eax,0x1110
}
 904:	5b                   	pop    %ebx
 905:	5e                   	pop    %esi
 906:	5f                   	pop    %edi
 ...
 916:	72 ce                	jb     8e6 <free+0x26>
{
 ...
 937:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 93a:	a3 10 11 00 00       	mov    %eax,0x1110
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 959:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 95c:	8b 15 10 11 00 00    	mov    0x1110,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 99f:	73 47                	jae    9e8 <malloc+0x98>
    ...
    if(p == freep)
 9a1:	39 05 10 11 00 00    	cmp    %eax,0x1110
 ...
 9c6:	e8 f5 fe ff ff       	call   8c0 <free>
  return freep;
 9cb:	8b 15 10 11 00 00    	mov    0x1110,%edx
 ...
 9f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9f7:	89 15 10 11 00 00    	mov    %edx,0x1110
}
 ...
 a17:	11 00 00 
 a1a:	c7 05 14 11 00 00 14 	movl   $0x1114,0x1114
 a21:	11 00 00 
    base.s.size = 0;
 a24:	b8 14 11 00 00       	mov    $0x1114,%eax
 a29:	c7 05 18 11 00 00 00 	movl   $0x0,0x1118
 a30:	00 00 00 
...
void remove_thread(int* pid){
 a50:	55                   	push   %ebp
 a51:	b8 20 11 00 00       	mov    $0x1120,%eax
...
void remove_thread(int* pid){
 ...
 a89:	ff b3 24 11 00 00    	pushl  0x1124(%ebx)
 a8f:	e8 2c fe ff ff       	call   8c0 <free>
            threads[i].pid = 0;
 a94:	c7 83 20 11 00 00 00 	movl   $0x0,0x1120(%ebx)
 a9b:	00 00 00 
            threads[i].ustack = 0;
 a9e:	c7 83 24 11 00 00 00 	movl   $0x0,0x1124(%ebx)
 aa5:	00 00 00 
            break;
 aa8:	83 c4 10             	add    $0x10,%esp
            threads[i].used = 0;
 aab:	c7 83 28 11 00 00 00 	movl   $0x0,0x1128(%ebx)
 ab2:	00 00 00 
}
...
int findPos(){
 ac0:	55                   	push   %ebp
 ac1:	ba 20 11 00 00       	mov    $0x1120,%edx
    for (int i = 0; i < NTHREAD; ++i)
...
int thread_create(void(*start_routine)(void*), void *arg){
 af0:	55                   	push   %ebp
 af1:	b8 20 11 00 00       	mov    $0x1120,%eax
...
int thread_create(void(*start_routine)(void*), void *arg){
 ...
 b59:	c1 e2 02             	shl    $0x2,%edx
        threads[pos].ustack = stack;
 b5c:	89 b2 24 11 00 00    	mov    %esi,0x1124(%edx)
        threads[pos].pid = pid;
 b62:	89 82 20 11 00 00    	mov    %eax,0x1120(%edx)
        threads[pos].used = 1; 
 b68:	c7 82 28 11 00 00 01 	movl   $0x1,0x1128(%edx)
 b6f:	00 00 00 
}
...
int thread_join(void){
 ...
 bb3:	53                   	push   %ebx
 bb4:	bb 20 11 00 00       	mov    $0x1120,%ebx
 ...
 bc2:	83 c3 0c             	add    $0xc,%ebx
    for(int i = 0; i < NTHREAD; ++i){
 bc5:	81 fb 50 11 00 00    	cmp    $0x1150,%ebx
...
void printTCB(void){
 ...
 c1c:	ff 34 85 28 11 00 00 	pushl  0x1128(,%eax,4)
 c23:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 c24:	83 c3 01             	add    $0x1,%ebx
        printf(1,"TCB %d:%d\n",i,threads[i].used);
 c27:	68 b4 0c 00 00       	push   $0xcb4
 c2c:	6a 01                	push   $0x1
