...
main(void)
{
  ...
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 3c 0e 00 00       	push   $0xe3c
  ab:	68 2e 0a 00 00       	push   $0xa2e
  b0:	e8 c5 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 31 0a 00 00       	push   $0xa31
  bc:	6a 01                	push   $0x1
 ...
 419:	85 d2                	test   %edx,%edx
{
 ...
 447:	f7 f1                	div    %ecx
 449:	0f b6 92 58 0a 00 00 	movzbl 0xa58(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 50 0a 00 00       	mov    $0xa50,%ebx
        while(*s != 0){
