 ...
 419:	85 d2                	test   %edx,%edx
{
 ...
 447:	f7 f1                	div    %ecx
 449:	0f b6 92 68 0a 00 00 	movzbl 0xa68(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 60 0a 00 00       	mov    $0xa60,%ebx
        while(*s != 0){
...
void add_thread(int* pid, void* ustack){
 810:	ba 20 0e 00 00       	mov    $0xe20,%edx
...
void add_thread(int* pid, void* ustack){
 ...
 83e:	8d 90 20 0e 00 00    	lea    0xe20(%eax),%edx
            threads[i].ustack = ustack;
            threads[i].used = 1;
 844:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            threads[i].pid = *pid;
 84b:	89 88 20 0e 00 00    	mov    %ecx,0xe20(%eax)
            threads[i].ustack = ustack;
...
void remove_thread(int* pid){
 860:	55                   	push   %ebp
 861:	b8 20 0e 00 00       	mov    $0xe20,%eax
    for (int i = 0; i < NTHREAD; ++i)
...
void remove_thread(int* pid){
 ...
 899:	ff b3 24 0e 00 00    	pushl  0xe24(%ebx)
 89f:	e8 dc fd ff ff       	call   680 <free>
            threads[i].pid = 0;
 8a4:	c7 83 20 0e 00 00 00 	movl   $0x0,0xe20(%ebx)
 8ab:	00 00 00 
            threads[i].ustack = 0;
 8ae:	c7 83 24 0e 00 00 00 	movl   $0x0,0xe24(%ebx)
 8b5:	00 00 00 
            break;
 8b8:	83 c4 10             	add    $0x10,%esp
            threads[i].used = 0;
 8bb:	c7 83 28 0e 00 00 00 	movl   $0x0,0xe28(%ebx)
 8c2:	00 00 00 
}
...
int thread_create(void(*start_routine)(void*), void *arg){
 ...
 8e7:	00 00 00 
 8ea:	b8 20 0e 00 00       	mov    $0xe20,%eax
        for (int i = 0; i < NTHREAD; ++i)
        {
            threads[i].pid = 0;
 ...
 8ff:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
        for (int i = 0; i < NTHREAD; ++i)
 906:	3d 50 0e 00 00       	cmp    $0xe50,%eax
 ...
 92b:	b9 20 0e 00 00       	mov    $0xe20,%ecx
 ...
 953:	c1 e2 02             	shl    $0x2,%edx
            threads[i].ustack = ustack;
 956:	89 9a 24 0e 00 00    	mov    %ebx,0xe24(%edx)
            threads[i].pid = *pid;
 95c:	89 82 20 0e 00 00    	mov    %eax,0xe20(%edx)
            threads[i].used = 1;
 962:	c7 82 28 0e 00 00 01 	movl   $0x1,0xe28(%edx)
 969:	00 00 00 
}
...
int thread_join(void){
 ...
 983:	53                   	push   %ebx
 984:	bb 20 0e 00 00       	mov    $0xe20,%ebx
 ...
 992:	83 c3 0c             	add    $0xc,%ebx
    for(int i = 0; i < NTHREAD; ++i){
 995:	81 fb 50 0e 00 00    	cmp    $0xe50,%ebx
...
void printTCB(void){
 ...
 9ec:	ff 34 85 28 0e 00 00 	pushl  0xe28(,%eax,4)
 9f3:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 9f4:	83 c3 01             	add    $0x1,%ebx
        printf(1,"TCB %d:%d\n",i,threads[i].used);
 9f7:	68 79 0a 00 00       	push   $0xa79
 9fc:	6a 01                	push   $0x1
