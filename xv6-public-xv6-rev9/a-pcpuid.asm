 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 7c 09 00 00 	movzbl 0x97c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 72 09 00 00       	mov    $0x972,%ebx
        while(*s != 0){
...
int thread_create(void(*start_routine)(void*), void *arg){
 ...
 824:	83 ec 04             	sub    $0x4,%esp
    static int first = 1;
    if(first){
 827:	a1 f4 0c 00 00       	mov    0xcf4,%eax
 82c:	85 c0                	test   %eax,%eax
 82e:	74 2d                	je     85d <thread_create+0x3d>
        first = 0;
 830:	c7 05 f4 0c 00 00 00 	movl   $0x0,0xcf4
 837:	00 00 00 
